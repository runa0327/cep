...
//        }
    ...
    private String createRootDirectory(String zipFileName, String ccProcedureLedgerId, String ccDrawingUpdateRecordId, String userId) throws SQLException {
        ...
        String insertSql = "INSERT INTO CC_DOC_DIR (ID, VER, TS, CRT_DT, CRT_USER_ID, LAST_MODI_DT, LAST_MODI_USER_ID, CC_DOC_DIR_PID, NAME, STATUS, CC_PRJ_ID, CC_DRAWING_UPDATE_RECORD_ID, CC_DOC_FOLDER_TYPE_ID, CC_IS_LATEST) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        jdbcTemplate.update(insertSql,
                docDirId, 1, LocalDateTime.now(), LocalDateTime.now(), userId,
                LocalDateTime.now(), userId, null, zipFileName, "AP", ccPrjId, ccDrawingUpdateRecordId, "CAD", true);//相关的文件和文件夹都属于CAD管理
    ...
    private String createNewDirectory(String dirName, String parentDirId, String ccProcedureLedgerId, String ccDrawingUpdateRecordId, String userId) throws SQLException {
        ...
        jdbcTemplate.update(insertSql,
                ...
                LocalDateTime.now(), userId, parentDirId, dirName, "AP", ccPrjId, ccDrawingUpdateRecordId, "CAD", true);
