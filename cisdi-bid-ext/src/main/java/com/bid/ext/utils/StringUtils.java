...
public class StringUtils extends org.apache.commons.lang3.StringUtils{
     ...
     * @param pattern 匹配规则（为空默认去除首尾空格）
     * @throws Exception
     */
    public static void replaceBlankBeanList(List<? extends Object> beanList, String pattern) throws Exception {
                ...
                if (bean != null) {
                    ...
                    for (int i = 0; i < fields.length; i++) {
                        ...
                        if (f.getType().getName().equals("java.lang.String")) {
                            ...
                            String value = String.valueOf(getFieldValue(bean, key));

                            if (value == null) {
                                continue;
                            }
                            // 将value设置到字段
                            setFieldValue(bean, key, isEmpty(pattern) ? value.trim() : value.replaceAll(pattern, ""));
                        }
                    }
                }
            }
