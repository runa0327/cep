...
/**
 * {"EN": "采购合同关联明细", "ZH_CN": "采购合同关联明细", "ZH_TW": "采购合同关联明细"}。
 */
public class CcPoToDtl {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcPoToDtl> modelHelper = new ModelHelper<>("CC_PO_TO_DTL", new CcPoToDtl());
    ...
    public static final String ENT_CODE = "CC_PO_TO_DTL";
     ...
     */
    public CcPoToDtl setId(String id) {
     ...
     */
    public CcPoToDtl setVer(Integer ver) {
     ...
     */
    public CcPoToDtl setTs(LocalDateTime ts) {
     ...
     */
    public CcPoToDtl setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPoToDtl setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPoToDtl setCrtUserId(String crtUserId) {
     ...
     */
    public CcPoToDtl setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPoToDtl setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPoToDtl setStatus(String status) {
     ...
     */
    public CcPoToDtl setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPoToDtl setCode(String code) {
     ...
     */
    public CcPoToDtl setName(String name) {
     ...
     */
    public CcPoToDtl setRemark(String remark) {
     ...
     */
    public CcPoToDtl setFastCode(String fastCode) {
     ...
     */
    public CcPoToDtl setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPoToDtl setCcPoId(String ccPoId) {
     ...
     */
    public CcPoToDtl setCcPoChangePickId(String ccPoChangePickId) {
     ...
     */
    public CcPoToDtl setEntityRecordId(String entityRecordId) {
     ...
     */
    public CcPoToDtl setTrxAmt(BigDecimal trxAmt) {
     ...
     * @return
     */
    public static CcPoToDtl newData() {
        CcPoToDtl obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPoToDtl insertData() {
        CcPoToDtl obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPoToDtl selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPoToDtl obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPoToDtl selectById(String id) {
     ...
     */
    public static List<CcPoToDtl> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPoToDtl> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPoToDtl> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPoToDtl> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPoToDtl> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPoToDtl> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPoToDtl selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPoToDtl> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPoToDtl.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPoToDtl selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPoToDtl fromModel, CcPoToDtl toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPoToDtl fromModel, CcPoToDtl toModel) {
