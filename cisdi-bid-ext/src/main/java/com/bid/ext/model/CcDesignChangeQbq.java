 ...
 * 设计变更。
 */
public class CcDesignChangeQbq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDesignChangeQbq> modelHelper = new ModelHelper<>("CC_DESIGN_CHANGE_QBQ", new CcDesignChangeQbq());
    ...
    public static final String ENT_CODE = "CC_DESIGN_CHANGE_QBQ";
    ...
    public static class Cols {
         ...
         * 变更事项名称。
         */
        public static final String CC_NAME_OF_CHANGE_ITEM = "CC_NAME_OF_CHANGE_ITEM";
        /**
         * 备注。
         */
         ...
         * 设计变更附件。
         */
        public static final String CC_DESIGN_CHANGE_ATTACHMENT = "CC_DESIGN_CHANGE_ATTACHMENT";
        /**
         * 设计变更签署状态。
         */
        public static final String CC_DESIGN_CHANGE_SIGN_STATUS_ID = "CC_DESIGN_CHANGE_SIGN_STATUS_ID";
        /**
         * 工程变更指令。
         */
        public static final String CC_CHANGE_ORDER_FILE = "CC_CHANGE_ORDER_FILE";
    }
     ...
     * 设置：项目。
     */
    public CcDesignChangeQbq setCcPrjId(String ccPrjId) {
     ...
     * 设置：ID。
     */
    public CcDesignChangeQbq setId(String id) {
     ...
     * 设置：版本。
     */
    public CcDesignChangeQbq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public CcDesignChangeQbq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public CcDesignChangeQbq setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public CcDesignChangeQbq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public CcDesignChangeQbq setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public CcDesignChangeQbq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public CcDesignChangeQbq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public CcDesignChangeQbq setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public CcDesignChangeQbq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public CcDesignChangeQbq setCode(String code) {
     ...
     * 设置：快捷码。
     */
    public CcDesignChangeQbq setFastCode(String fastCode) {
     ...
     * 设置：图标。
     */
    public CcDesignChangeQbq setIconFileGroupId(String iconFileGroupId) {
     ...
     * 设置：名称。
     */
    public CcDesignChangeQbq setName(String name) {
     ...
     * 设置：业务日期。
     */
    public CcDesignChangeQbq setTrxDate(LocalDate trxDate) {
     ...
     * 设置：合同编号。
     */
    public CcDesignChangeQbq setCcBidNo(String ccBidNo) {
     ...
     * 设置：部位。
     */
    public CcDesignChangeQbq setPart(String part) {
     ...
     * 设置：施工图套图号。
     */
    public CcDesignChangeQbq setCcConstructionDrawingId(String ccConstructionDrawingId) {
     ...
     * 设置：主要原因。
     */
    public CcDesignChangeQbq setMainReason(String mainReason) {
     ...
     * 设置：变更原因。
     */
    public CcDesignChangeQbq setChangeReason(String changeReason) {
     ...
     * 设置：附件。
     */
    public CcDesignChangeQbq setCcAttachments(String ccAttachments) {
     ...
     * 设置：监理单位意见。
     */
    public CcDesignChangeQbq setSupervisoryComment(String supervisoryComment) {
     ...
     * 设置：设计单位意见。
     */
    public CcDesignChangeQbq setDesignComment(String designComment) {
     ...
     * 设置：建设单位意见。
     */
    public CcDesignChangeQbq setConstructionComment(String constructionComment) {
     ...
     * 设置：是否需要变更。
     */
    public CcDesignChangeQbq setIsChange(Boolean isChange) {
        if (this.isChange == null && isChange == null) {
            // 均为null，不做处理。
        } else if (this.isChange != null && isChange != null) {
            // 均非null，判定不等，再做处理：
            if (this.isChange.compareTo(isChange) != 0) {
                this.isChange = isChange;
                if (!this.toUpdateCols.contains("IS_CHANGE")) {
                    this.toUpdateCols.add("IS_CHANGE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：工程资料。
     */
    public CcDesignChangeQbq setCcEngineeringData(String ccEngineeringData) {
     ...
     * 设置：变更状态。
     */
    public CcDesignChangeQbq setCcChangeSignDemonstrateStatusId(String ccChangeSignDemonstrateStatusId) {
     ...
     * 设置：附件。
     */
    public CcDesignChangeQbq setCcAttachment(String ccAttachment) {
     ...
     * 变更事项名称。
     */
    private String ccNameOfChangeItem;

    /**
     * 获取：变更事项名称。
     */
    public String getCcNameOfChangeItem() {
        return this.ccNameOfChangeItem;
    }

    /**
     * 设置：变更事项名称。
     */
    public CcDesignChangeQbq setCcNameOfChangeItem(String ccNameOfChangeItem) {
        if (this.ccNameOfChangeItem == null && ccNameOfChangeItem == null) {
            // 均为null，不做处理。
        } else if (this.ccNameOfChangeItem != null && ccNameOfChangeItem != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccNameOfChangeItem.compareTo(ccNameOfChangeItem) != 0) {
                this.ccNameOfChangeItem = ccNameOfChangeItem;
                if (!this.toUpdateCols.contains("CC_NAME_OF_CHANGE_ITEM")) {
                    this.toUpdateCols.add("CC_NAME_OF_CHANGE_ITEM");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：备注。
     */
    public CcDesignChangeQbq setRemark(String remark) {
     ...
     * 设计变更附件。
     */
    private String ccDesignChangeAttachment;

    /**
     * 获取：设计变更附件。
     */
    public String getCcDesignChangeAttachment() {
        return this.ccDesignChangeAttachment;
    }

    /**
     * 设置：设计变更附件。
     */
    public CcDesignChangeQbq setCcDesignChangeAttachment(String ccDesignChangeAttachment) {
        if (this.ccDesignChangeAttachment == null && ccDesignChangeAttachment == null) {
            // 均为null，不做处理。
        } else if (this.ccDesignChangeAttachment != null && ccDesignChangeAttachment != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccDesignChangeAttachment.compareTo(ccDesignChangeAttachment) != 0) {
                this.ccDesignChangeAttachment = ccDesignChangeAttachment;
                if (!this.toUpdateCols.contains("CC_DESIGN_CHANGE_ATTACHMENT")) {
                    this.toUpdateCols.add("CC_DESIGN_CHANGE_ATTACHMENT");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设计变更签署状态。
     */
    private String ccDesignChangeSignStatusId;

    /**
     * 获取：设计变更签署状态。
     */
    public String getCcDesignChangeSignStatusId() {
        return this.ccDesignChangeSignStatusId;
    }

    /**
     * 设置：设计变更签署状态。
     */
    public CcDesignChangeQbq setCcDesignChangeSignStatusId(String ccDesignChangeSignStatusId) {
        if (this.ccDesignChangeSignStatusId == null && ccDesignChangeSignStatusId == null) {
            // 均为null，不做处理。
        } else if (this.ccDesignChangeSignStatusId != null && ccDesignChangeSignStatusId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccDesignChangeSignStatusId.compareTo(ccDesignChangeSignStatusId) != 0) {
                this.ccDesignChangeSignStatusId = ccDesignChangeSignStatusId;
                if (!this.toUpdateCols.contains("CC_DESIGN_CHANGE_SIGN_STATUS_ID")) {
                    this.toUpdateCols.add("CC_DESIGN_CHANGE_SIGN_STATUS_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 获取：工程变更指令。
     */
    public String getCcChangeOrderFile() {
        return this.ccChangeOrderFile;
    }

    /**
     * 设置：工程变更指令。
     */
    public CcDesignChangeQbq setCcChangeOrderFile(String ccChangeOrderFile) {
        if (this.ccChangeOrderFile == null && ccChangeOrderFile == null) {
            // 均为null，不做处理。
        } else if (this.ccChangeOrderFile != null && ccChangeOrderFile != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccChangeOrderFile.compareTo(ccChangeOrderFile) != 0) {
                this.ccChangeOrderFile = ccChangeOrderFile;
                if (!this.toUpdateCols.contains("CC_CHANGE_ORDER_FILE")) {
                    this.toUpdateCols.add("CC_CHANGE_ORDER_FILE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * @return
     */
    public static CcDesignChangeQbq newData() {
        CcDesignChangeQbq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDesignChangeQbq insertData() {
        CcDesignChangeQbq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDesignChangeQbq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDesignChangeQbq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDesignChangeQbq selectById(String id) {
     ...
     */
    public static List<CcDesignChangeQbq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDesignChangeQbq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDesignChangeQbq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDesignChangeQbq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDesignChangeQbq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDesignChangeQbq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDesignChangeQbq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDesignChangeQbq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDesignChangeQbq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDesignChangeQbq selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDesignChangeQbq fromModel, CcDesignChangeQbq toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDesignChangeQbq fromModel, CcDesignChangeQbq toModel) {
