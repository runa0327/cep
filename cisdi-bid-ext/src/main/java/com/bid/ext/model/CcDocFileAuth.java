...
/**
 * {"EN": "图纸授权", "ZH_CN": "资料文件授权", "ZH_TW": "图纸授权"}。
 */
public class CcDocFileAuth {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDocFileAuth> modelHelper = new ModelHelper<>("CC_DOC_FILE_AUTH", new CcDocFileAuth());
    ...
    public static final String ENT_CODE = "CC_DOC_FILE_AUTH";
     ...
     */
    public CcDocFileAuth setId(String id) {
     ...
     */
    public CcDocFileAuth setVer(Integer ver) {
     ...
     */
    public CcDocFileAuth setTs(LocalDateTime ts) {
     ...
     */
    public CcDocFileAuth setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDocFileAuth setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcDocFileAuth setCrtUserId(String crtUserId) {
     ...
     */
    public CcDocFileAuth setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDocFileAuth setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDocFileAuth setStatus(String status) {
     ...
     */
    public CcDocFileAuth setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDocFileAuth setCode(String code) {
     ...
     */
    public CcDocFileAuth setName(String name) {
     ...
     */
    public CcDocFileAuth setRemark(String remark) {
     ...
     */
    public CcDocFileAuth setFastCode(String fastCode) {
     ...
     */
    public CcDocFileAuth setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDocFileAuth setCcDocFileId(String ccDocFileId) {
     ...
     */
    public CcDocFileAuth setAdUserId(String adUserId) {
     ...
     */
    public CcDocFileAuth setIsView(Boolean isView) {
     ...
     * @return
     */
    public static CcDocFileAuth newData() {
        CcDocFileAuth obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDocFileAuth insertData() {
        CcDocFileAuth obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDocFileAuth selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDocFileAuth obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDocFileAuth selectById(String id) {
     ...
     */
    public static List<CcDocFileAuth> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileAuth> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileAuth> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileAuth> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileAuth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileAuth> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDocFileAuth selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileAuth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDocFileAuth.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDocFileAuth selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDocFileAuth fromModel, CcDocFileAuth toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDocFileAuth fromModel, CcDocFileAuth toModel) {
