...
/**
 * {"EN": "协同任务进展", "ZH_CN": "协同任务进展", "ZH_TW": "协同任务进展"}。
 */
public class CcCoTaskProg {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcCoTaskProg> modelHelper = new ModelHelper<>("CC_CO_TASK_PROG", new CcCoTaskProg());
    ...
    public static final String ENT_CODE = "CC_CO_TASK_PROG";
     ...
     */
    public CcCoTaskProg setCcPrjId(String ccPrjId) {
     ...
     */
    public CcCoTaskProg setId(String id) {
     ...
     */
    public CcCoTaskProg setVer(Integer ver) {
     ...
     */
    public CcCoTaskProg setTs(LocalDateTime ts) {
     ...
     */
    public CcCoTaskProg setIsPreset(Boolean isPreset) {
     ...
     */
    public CcCoTaskProg setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcCoTaskProg setCrtUserId(String crtUserId) {
     ...
     */
    public CcCoTaskProg setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcCoTaskProg setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcCoTaskProg setStatus(String status) {
     ...
     */
    public CcCoTaskProg setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcCoTaskProg setCode(String code) {
     ...
     */
    public CcCoTaskProg setName(String name) {
     ...
     */
    public CcCoTaskProg setFastCode(String fastCode) {
     ...
     */
    public CcCoTaskProg setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcCoTaskProg setAdUserId(String adUserId) {
    ...
    /**
     * 获取：{"EN": "是否责任人", "ZH_CN": "是否责任人", "ZH_TW": "是否责任人"}。
     */
    ...
    /**
     * 设置：{"EN": "是否责任人", "ZH_CN": "是否责任人", "ZH_TW": "是否责任人"}。
     */
    public CcCoTaskProg setIsChief(Boolean isChief) {
        if (this.isChief == null && isChief == null) {
            // 均为null，不做处理。
        } else if (this.isChief != null && isChief != null) {
            // 均非null，判定不等，再做处理：
            if (this.isChief.compareTo(isChief) != 0) {
                this.isChief = isChief;
                if (!this.toUpdateCols.contains("IS_CHIEF")) {
                    this.toUpdateCols.add("IS_CHIEF");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
    ...
    /**
     * 获取：{"EN": "是否督办人", "ZH_CN": "是否督办人", "ZH_TW": "是否督办人"}。
     */
    ...
    /**
     * 设置：{"EN": "是否督办人", "ZH_CN": "是否督办人", "ZH_TW": "是否督办人"}。
     */
    public CcCoTaskProg setIsSupervise(Boolean isSupervise) {
        if (this.isSupervise == null && isSupervise == null) {
            // 均为null，不做处理。
        } else if (this.isSupervise != null && isSupervise != null) {
            // 均非null，判定不等，再做处理：
            if (this.isSupervise.compareTo(isSupervise) != 0) {
                this.isSupervise = isSupervise;
                if (!this.toUpdateCols.contains("IS_SUPERVISE")) {
                    this.toUpdateCols.add("IS_SUPERVISE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * {"EN": "协同任务", "ZH_CN": "协同任务", "ZH_TW": "协同任务"}。
     */
    private String ccCoTaskId;

    /**
     * 获取：{"EN": "协同任务", "ZH_CN": "协同任务", "ZH_TW": "协同任务"}。
     */
    public String getCcCoTaskId() {
        return this.ccCoTaskId;
    }

    /**
     * 设置：{"EN": "协同任务", "ZH_CN": "协同任务", "ZH_TW": "协同任务"}。
     */
    public CcCoTaskProg setCcCoTaskId(String ccCoTaskId) {
        if (this.ccCoTaskId == null && ccCoTaskId == null) {
            // 均为null，不做处理。
        } else if (this.ccCoTaskId != null && ccCoTaskId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccCoTaskId.compareTo(ccCoTaskId) != 0) {
                this.ccCoTaskId = ccCoTaskId;
                if (!this.toUpdateCols.contains("CC_CO_TASK_ID")) {
                    this.toUpdateCols.add("CC_CO_TASK_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcCoTaskProg setProgTime(LocalDateTime progTime) {
     ...
     */
    public CcCoTaskProg setRemark(String remark) {
     ...
     */
    public CcCoTaskProg setCcAttachments(String ccAttachments) {
     ...
     * @return
     */
    public static CcCoTaskProg newData() {
        CcCoTaskProg obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcCoTaskProg insertData() {
        CcCoTaskProg obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcCoTaskProg selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcCoTaskProg obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcCoTaskProg selectById(String id) {
     ...
     */
    public static List<CcCoTaskProg> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcCoTaskProg> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCoTaskProg> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCoTaskProg> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcCoTaskProg> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCoTaskProg> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcCoTaskProg selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcCoTaskProg> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcCoTaskProg.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcCoTaskProg selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcCoTaskProg fromModel, CcCoTaskProg toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcCoTaskProg fromModel, CcCoTaskProg toModel) {
