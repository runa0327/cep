...
/**
 * {"EN": "考勤结果", "ZH_CN": "考勤结果", "ZH_TW": "考勤结果"}。
 */
public class CcAtdResult {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcAtdResult> modelHelper = new ModelHelper<>("CC_ATD_RESULT", new CcAtdResult());
    ...
    public static final String ENT_CODE = "CC_ATD_RESULT";
    ...
    public static class Cols {
        ...
        /**
         * {"EN": "考勤日期", "ZH_CN": "考勤日期", "ZH_TW": "考勤日期"}。
         */
        public static final String ATD_DATE = "ATD_DATE";
        /**
     ...
     */
    public CcAtdResult setId(String id) {
     ...
     */
    public CcAtdResult setVer(Integer ver) {
     ...
     */
    public CcAtdResult setTs(LocalDateTime ts) {
     ...
     */
    public CcAtdResult setIsPreset(Boolean isPreset) {
     ...
     */
    public CcAtdResult setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcAtdResult setCrtUserId(String crtUserId) {
     ...
     */
    public CcAtdResult setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcAtdResult setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcAtdResult setStatus(String status) {
     ...
     */
    public CcAtdResult setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcAtdResult setCode(String code) {
     ...
     */
    public CcAtdResult setName(String name) {
     ...
     */
    public CcAtdResult setFastCode(String fastCode) {
     ...
     */
    public CcAtdResult setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcAtdResult setAdUserId(String adUserId) {
     ...
     */
    public CcAtdResult setCcPartyCompanyId(String ccPartyCompanyId) {
    ...
    /**
     * 获取：{"EN": "考勤日期", "ZH_CN": "考勤日期", "ZH_TW": "考勤日期"}。
     */
    public LocalDate getAtdDate() {
        return this.atdDate;
    }

    /**
     * 设置：{"EN": "考勤日期", "ZH_CN": "考勤日期", "ZH_TW": "考勤日期"}。
     */
    public CcAtdResult setAtdDate(LocalDate atdDate) {
        if (this.atdDate == null && atdDate == null) {
            // 均为null，不做处理。
        } else if (this.atdDate != null && atdDate != null) {
            // 均非null，判定不等，再做处理：
            if (this.atdDate.compareTo(atdDate) != 0) {
                this.atdDate = atdDate;
                if (!this.toUpdateCols.contains("ATD_DATE")) {
                    this.toUpdateCols.add("ATD_DATE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcAtdResult setIsNormal(Boolean isNormal) {
     ...
     */
    public CcAtdResult setRemark(String remark) {
     ...
     * @return
     */
    public static CcAtdResult newData() {
        CcAtdResult obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcAtdResult insertData() {
        CcAtdResult obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcAtdResult selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcAtdResult obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcAtdResult selectById(String id) {
     ...
     */
    public static List<CcAtdResult> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcAtdResult> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcAtdResult> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcAtdResult> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcAtdResult> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcAtdResult> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcAtdResult selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcAtdResult> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcAtdResult.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcAtdResult selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcAtdResult fromModel, CcAtdResult toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcAtdResult fromModel, CcAtdResult toModel) {
