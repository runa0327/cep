...
/**
 * {"EN": "实体-月份", "ZH_CN": "实体-月份", "ZH_TW": "实体-月份"}。
 */
public class CcMonth {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcMonth> modelHelper = new ModelHelper<>("CC_MONTH", new CcMonth());
    ...
    public static final String ENT_CODE = "CC_MONTH";
     ...
     */
    public CcMonth setId(String id) {
     ...
     */
    public CcMonth setVer(Integer ver) {
     ...
     */
    public CcMonth setTs(LocalDateTime ts) {
     ...
     */
    public CcMonth setIsPreset(Boolean isPreset) {
     ...
     */
    public CcMonth setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcMonth setCrtUserId(String crtUserId) {
     ...
     */
    public CcMonth setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcMonth setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcMonth setStatus(String status) {
     ...
     */
    public CcMonth setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcMonth setCode(String code) {
     ...
     */
    public CcMonth setName(String name) {
     ...
     */
    public CcMonth setRemark(String remark) {
     ...
     */
    public CcMonth setFastCode(String fastCode) {
     ...
     */
    public CcMonth setIconFileGroupId(String iconFileGroupId) {
     ...
     * @return
     */
    public static CcMonth newData() {
        CcMonth obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcMonth insertData() {
        CcMonth obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcMonth selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcMonth obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcMonth selectById(String id) {
     ...
     */
    public static List<CcMonth> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcMonth> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcMonth> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcMonth> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcMonth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcMonth> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcMonth selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcMonth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcMonth.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcMonth selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcMonth fromModel, CcMonth toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcMonth fromModel, CcMonth toModel) {
