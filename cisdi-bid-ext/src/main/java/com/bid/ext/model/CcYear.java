...
/**
 * {"EN": "实体-年份", "ZH_CN": "实体-年份", "ZH_TW": "实体-年份"}。
 */
public class CcYear {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcYear> modelHelper = new ModelHelper<>("CC_YEAR", new CcYear());
    ...
    public static final String ENT_CODE = "CC_YEAR";
     ...
     */
    public CcYear setVer(Integer ver) {
     ...
     */
    public CcYear setTs(LocalDateTime ts) {
     ...
     */
    public CcYear setIsPreset(Boolean isPreset) {
     ...
     */
    public CcYear setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcYear setCrtUserId(String crtUserId) {
     ...
     */
    public CcYear setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcYear setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcYear setStatus(String status) {
     ...
     */
    public CcYear setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcYear setCode(String code) {
     ...
     */
    public CcYear setName(String name) {
     ...
     */
    public CcYear setRemark(String remark) {
     ...
     */
    public CcYear setFastCode(String fastCode) {
     ...
     */
    public CcYear setIconFileGroupId(String iconFileGroupId) {
     ...
     * @return
     */
    public static CcYear newData() {
        CcYear obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcYear insertData() {
        CcYear obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcYear selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcYear obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcYear selectById(String id) {
     ...
     */
    public static List<CcYear> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcYear> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcYear> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcYear> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcYear> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcYear> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcYear selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcYear> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcYear.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcYear selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcYear fromModel, CcYear toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcYear fromModel, CcYear toModel) {
