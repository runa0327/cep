 ...
 */
public class CcConstructWork {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcConstructWork> modelHelper = new ModelHelper<>("CC_CONSTRUCT_WORK", new CcConstructWork());
    ...
    public static final String ENT_CODE = "CC_CONSTRUCT_WORK";
     ...
     */
    public CcConstructWork setCcPrjId(String ccPrjId) {
     ...
     */
    public CcConstructWork setId(String id) {
     ...
     */
    public CcConstructWork setVer(Integer ver) {
     ...
     */
    public CcConstructWork setTs(LocalDateTime ts) {
     ...
     */
    public CcConstructWork setIsPreset(Boolean isPreset) {
     ...
     */
    public CcConstructWork setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcConstructWork setCrtUserId(String crtUserId) {
     ...
     */
    public CcConstructWork setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcConstructWork setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcConstructWork setStatus(String status) {
     ...
     */
    public CcConstructWork setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcConstructWork setCode(String code) {
     ...
     */
    public CcConstructWork setName(String name) {
     ...
     */
    public CcConstructWork setRemark(String remark) {
     ...
     */
    public CcConstructWork setFastCode(String fastCode) {
     ...
     */
    public CcConstructWork setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcConstructWork setCcCompanyId(String ccCompanyId) {
     ...
     */
    public CcConstructWork setActWbsPct(BigDecimal actWbsPct) {
     ...
     * @return
     */
    public static CcConstructWork newData() {
        CcConstructWork obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcConstructWork insertData() {
        CcConstructWork obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcConstructWork selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcConstructWork obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcConstructWork selectById(String id) {
     ...
     */
    public static List<CcConstructWork> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWork> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWork> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWork> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWork> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWork> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcConstructWork selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWork> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcConstructWork.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcConstructWork selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcConstructWork fromModel, CcConstructWork toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcConstructWork fromModel, CcConstructWork toModel) {
