 ...
 */
public class CcStructDrawingVersion {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcStructDrawingVersion> modelHelper = new ModelHelper<>("CC_STRUCT_DRAWING_VERSION", new CcStructDrawingVersion());
    ...
    public static final String ENT_CODE = "CC_STRUCT_DRAWING_VERSION";
     ...
     */
    public CcStructDrawingVersion setId(String id) {
     ...
     */
    public CcStructDrawingVersion setVer(Integer ver) {
     ...
     */
    public CcStructDrawingVersion setTs(LocalDateTime ts) {
     ...
     */
    public CcStructDrawingVersion setIsPreset(Boolean isPreset) {
     ...
     */
    public CcStructDrawingVersion setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcStructDrawingVersion setCrtUserId(String crtUserId) {
     ...
     */
    public CcStructDrawingVersion setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcStructDrawingVersion setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcStructDrawingVersion setStatus(String status) {
     ...
     */
    public CcStructDrawingVersion setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcStructDrawingVersion setCode(String code) {
     ...
     */
    public CcStructDrawingVersion setName(String name) {
     ...
     */
    public CcStructDrawingVersion setRemark(String remark) {
     ...
     */
    public CcStructDrawingVersion setFastCode(String fastCode) {
     ...
     */
    public CcStructDrawingVersion setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcStructDrawingVersion setCcPrjId(String ccPrjId) {
     ...
     */
    public CcStructDrawingVersion setCcPrjStructNodeId(String ccPrjStructNodeId) {
     ...
     */
    public CcStructDrawingVersion setCcDrawingManagementId(String ccDrawingManagementId) {
     ...
     */
    public CcStructDrawingVersion setCcDrawingVersionId(String ccDrawingVersionId) {
     ...
     * @return
     */
    public static CcStructDrawingVersion newData() {
        CcStructDrawingVersion obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcStructDrawingVersion insertData() {
        CcStructDrawingVersion obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcStructDrawingVersion selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcStructDrawingVersion obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcStructDrawingVersion selectById(String id) {
     ...
     */
    public static List<CcStructDrawingVersion> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcStructDrawingVersion> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcStructDrawingVersion> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcStructDrawingVersion> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcStructDrawingVersion> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcStructDrawingVersion> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcStructDrawingVersion selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcStructDrawingVersion> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcStructDrawingVersion.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcStructDrawingVersion selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcStructDrawingVersion fromModel, CcStructDrawingVersion toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcStructDrawingVersion fromModel, CcStructDrawingVersion toModel) {
