...
public class AdEnt {
    ...
    public static class Cols {
        ...
        /**
         * {"EN": "PARENT_ENT_ID", "ZH_CN": "父实体", "ZH_TW": "繁：父实体"}。
         */
        public static final String PARENT_ENT_ID = "PARENT_ENT_ID";
        /**
         * {"EN": "ENT_TYPE", "ZH_CN": "实体类型", "ZH_TW": "繁：实体类型"}。
         */
        public static final String ENT_TYPE = "ENT_TYPE";
        /**
         * {"EN": "AD_SUB_QUERY_ID", "ZH_CN": "子查询", "ZH_TW": "繁：子查询"}。
         */
        public static final String AD_SUB_QUERY_ID = "AD_SUB_QUERY_ID";
        /**
         * {"EN": "DSP_ATT_ID_WHEN_REFED", "ZH_CN": "实体被引用时显示的属性", "ZH_TW": "繁：实体被引用时显示的属性"}。
         */
        public static final String DSP_ATT_ID_WHEN_REFED = "DSP_ATT_ID_WHEN_REFED";
        /**
         * {"EN": "序号属性", "ZH_CN": "序号属性", "ZH_TW": "序号属性"}。
         */
        public static final String SEQ_NO_ATT_ID = "SEQ_NO_ATT_ID";
        /**
         * {"EN": "JOIN_ON_CLAUSE", "ZH_CN": "表连接语句", "ZH_TW": "繁：表连接语句"}。
         */
        public static final String JOIN_ON_CLAUSE = "JOIN_ON_CLAUSE";
        /**
         * {"EN": "ORDER_BY_CLAUSE", "ZH_CN": "排序语句", "ZH_TW": "繁：排序语句"}。
         */
        public static final String ORDER_BY_CLAUSE = "ORDER_BY_CLAUSE";
        /**
         * {"EN": "WHERE_CLAUSE", "ZH_CN": "过滤语句", "ZH_TW": "繁：过滤语句"}。
         */
        public static final String WHERE_CLAUSE = "WHERE_CLAUSE";
        /**
         * {"EN": "GROUP_BY_CLAUSE", "ZH_CN": "分组语句", "ZH_TW": "繁：分组语句"}。
         */
        public static final String GROUP_BY_CLAUSE = "GROUP_BY_CLAUSE";
        /**
         * {"EN": "HAVING_CLAUSE", "ZH_CN": "HAVING语句", "ZH_TW": "繁：HAVING语句"}。
         */
        public static final String HAVING_CLAUSE = "HAVING_CLAUSE";
        /**
         * {"EN": "PAGE_SIZE", "ZH_CN": "页面大小", "ZH_TW": "繁：页面大小"}。
         */
        public static final String PAGE_SIZE = "PAGE_SIZE";
        /**
         * {"EN": "NO_STD_INSERT", "ZH_CN": "忽略标准新建", "ZH_TW": "繁：忽略标准新建"}。
         */
        public static final String NO_STD_INSERT = "NO_STD_INSERT";
        /**
         * {"EN": "NO_STD_UPDATE", "ZH_CN": "忽略标准更新", "ZH_TW": "繁：忽略标准更新"}。
         */
        public static final String NO_STD_UPDATE = "NO_STD_UPDATE";
        /**
         * {"EN": "NO_STD_DELETE", "ZH_CN": "忽略标准删除", "ZH_TW": "繁：忽略标准删除"}。
         */
        public static final String NO_STD_DELETE = "NO_STD_DELETE";
        /**
         * {"EN": "STD_VER_CHK", "ZH_CN": "标准版本检查", "ZH_TW": "繁：标准版本检查"}。
         */
     ...
     */
    public AdEnt setFastCode(String fastCode) {
     ...
     */
    public AdEnt setIconFileGroupId(String iconFileGroupId) {
    ...
    /**
     * 获取：{"EN": "PARENT_ENT_ID", "ZH_CN": "父实体", "ZH_TW": "繁：父实体"}。
     */
    ...
    /**
     * 设置：{"EN": "PARENT_ENT_ID", "ZH_CN": "父实体", "ZH_TW": "繁：父实体"}。
     */
    ...
    /**
     * 获取：{"EN": "ENT_TYPE", "ZH_CN": "实体类型", "ZH_TW": "繁：实体类型"}。
     */
    ...
    /**
     * 设置：{"EN": "ENT_TYPE", "ZH_CN": "实体类型", "ZH_TW": "繁：实体类型"}。
     */
    ...
    /**
     * 获取：{"EN": "AD_SUB_QUERY_ID", "ZH_CN": "子查询", "ZH_TW": "繁：子查询"}。
     */
    ...
    /**
     * 设置：{"EN": "AD_SUB_QUERY_ID", "ZH_CN": "子查询", "ZH_TW": "繁：子查询"}。
     */
    ...
    /**
     * 获取：{"EN": "DSP_ATT_ID_WHEN_REFED", "ZH_CN": "实体被引用时显示的属性", "ZH_TW": "繁：实体被引用时显示的属性"}。
     */
    ...
    /**
     * 设置：{"EN": "DSP_ATT_ID_WHEN_REFED", "ZH_CN": "实体被引用时显示的属性", "ZH_TW": "繁：实体被引用时显示的属性"}。
     */
     ...
     * {"EN": "序号属性", "ZH_CN": "序号属性", "ZH_TW": "序号属性"}。
     */
    private String seqNoAttId;

    /**
     * 获取：{"EN": "序号属性", "ZH_CN": "序号属性", "ZH_TW": "序号属性"}。
     */
    public String getSeqNoAttId() {
        return this.seqNoAttId;
    }

    /**
     * 设置：{"EN": "序号属性", "ZH_CN": "序号属性", "ZH_TW": "序号属性"}。
     */
    public AdEnt setSeqNoAttId(String seqNoAttId) {
        if (this.seqNoAttId == null && seqNoAttId == null) {
            // 均为null，不做处理。
        } else if (this.seqNoAttId != null && seqNoAttId != null) {
            // 均非null，判定不等，再做处理：
            if (this.seqNoAttId.compareTo(seqNoAttId) != 0) {
                this.seqNoAttId = seqNoAttId;
                if (!this.toUpdateCols.contains("SEQ_NO_ATT_ID")) {
                    this.toUpdateCols.add("SEQ_NO_ATT_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
    ...
    /**
     * 获取：{"EN": "JOIN_ON_CLAUSE", "ZH_CN": "表连接语句", "ZH_TW": "繁：表连接语句"}。
     */
    ...
    /**
     * 设置：{"EN": "JOIN_ON_CLAUSE", "ZH_CN": "表连接语句", "ZH_TW": "繁：表连接语句"}。
     */
    ...
    /**
     * 获取：{"EN": "ORDER_BY_CLAUSE", "ZH_CN": "排序语句", "ZH_TW": "繁：排序语句"}。
     */
    ...
    /**
     * 设置：{"EN": "ORDER_BY_CLAUSE", "ZH_CN": "排序语句", "ZH_TW": "繁：排序语句"}。
     */
    ...
    /**
     * 获取：{"EN": "WHERE_CLAUSE", "ZH_CN": "过滤语句", "ZH_TW": "繁：过滤语句"}。
     */
    ...
    /**
     * 设置：{"EN": "WHERE_CLAUSE", "ZH_CN": "过滤语句", "ZH_TW": "繁：过滤语句"}。
     */
    ...
    /**
     * 获取：{"EN": "GROUP_BY_CLAUSE", "ZH_CN": "分组语句", "ZH_TW": "繁：分组语句"}。
     */
    ...
    /**
     * 设置：{"EN": "GROUP_BY_CLAUSE", "ZH_CN": "分组语句", "ZH_TW": "繁：分组语句"}。
     */
    ...
    /**
     * 获取：{"EN": "HAVING_CLAUSE", "ZH_CN": "HAVING语句", "ZH_TW": "繁：HAVING语句"}。
     */
    ...
    /**
     * 设置：{"EN": "HAVING_CLAUSE", "ZH_CN": "HAVING语句", "ZH_TW": "繁：HAVING语句"}。
     */
    ...
    /**
     * 获取：{"EN": "PAGE_SIZE", "ZH_CN": "页面大小", "ZH_TW": "繁：页面大小"}。
     */
    ...
    /**
     * 设置：{"EN": "PAGE_SIZE", "ZH_CN": "页面大小", "ZH_TW": "繁：页面大小"}。
     */
    ...
    /**
     * 获取：{"EN": "NO_STD_INSERT", "ZH_CN": "忽略标准新建", "ZH_TW": "繁：忽略标准新建"}。
     */
    ...
    /**
     * 设置：{"EN": "NO_STD_INSERT", "ZH_CN": "忽略标准新建", "ZH_TW": "繁：忽略标准新建"}。
     */
    ...
    /**
     * 获取：{"EN": "NO_STD_UPDATE", "ZH_CN": "忽略标准更新", "ZH_TW": "繁：忽略标准更新"}。
     */
    ...
    /**
     * 设置：{"EN": "NO_STD_UPDATE", "ZH_CN": "忽略标准更新", "ZH_TW": "繁：忽略标准更新"}。
     */
    ...
    /**
     * 获取：{"EN": "NO_STD_DELETE", "ZH_CN": "忽略标准删除", "ZH_TW": "繁：忽略标准删除"}。
     */
    ...
    /**
     * 设置：{"EN": "NO_STD_DELETE", "ZH_CN": "忽略标准删除", "ZH_TW": "繁：忽略标准删除"}。
     */
    ...
    /**
     * 获取：{"EN": "STD_VER_CHK", "ZH_CN": "标准版本检查", "ZH_TW": "繁：标准版本检查"}。
     */
    ...
    /**
     * 设置：{"EN": "STD_VER_CHK", "ZH_CN": "标准版本检查", "ZH_TW": "繁：标准版本检查"}。
     */
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static AdEnt selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<AdEnt> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<AdEnt> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static AdEnt selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<AdEnt> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用AdEnt.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static AdEnt selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(AdEnt fromModel, AdEnt toModel) {
