 ...
 * 人员信息-历史。
 */
public class RuUserInfo {

    /**
     * 模型助手。
     */
    private static final ModelHelper<RuUserInfo> modelHelper = new ModelHelper<>("RU_USER_INFO", new RuUserInfo());
    ...
    public static final String ENT_CODE = "RU_USER_INFO";
     ...
     * 设置：ID。
     */
    public RuUserInfo setId(String id) {
     ...
     * 设置：版本。
     */
    public RuUserInfo setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public RuUserInfo setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public RuUserInfo setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public RuUserInfo setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public RuUserInfo setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public RuUserInfo setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public RuUserInfo setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public RuUserInfo setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public RuUserInfo setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public RuUserInfo setCode(String code) {
     ...
     * 设置：名称。
     */
    public RuUserInfo setName(String name) {
     ...
     * 设置：备注。
     */
    public RuUserInfo setRemark(String remark) {
     ...
     * 设置：快捷码。
     */
    public RuUserInfo setFastCode(String fastCode) {
     ...
     * 设置：图标。
     */
    public RuUserInfo setIconFileGroupId(String iconFileGroupId) {
     ...
     * 设置：项目。
     */
    public RuUserInfo setCcPrjId(String ccPrjId) {
     ...
     * 设置：人员编号。
     */
    public RuUserInfo setRuUserIdentifier(String ruUserIdentifier) {
     ...
     * 设置：人员年龄。
     */
    public RuUserInfo setRuUserAge(Integer ruUserAge) {
     ...
     * 设置：人员姓名。
     */
    public RuUserInfo setRuUserName(String ruUserName) {
     ...
     * 设置：人员手机号。
     */
    public RuUserInfo setRuUserPhoneNumber(String ruUserPhoneNumber) {
     ...
     * 设置：人员工种。
     */
    public RuUserInfo setRuUserWorkTypeId(String ruUserWorkTypeId) {
     ...
     * @return
     */
    public static RuUserInfo newData() {
        RuUserInfo obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static RuUserInfo insertData() {
        RuUserInfo obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static RuUserInfo selectById(String id, List<String> includeCols, List<String> excludeCols) {
        RuUserInfo obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static RuUserInfo selectById(String id) {
     ...
     */
    public static List<RuUserInfo> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<RuUserInfo> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<RuUserInfo> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<RuUserInfo> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<RuUserInfo> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<RuUserInfo> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static RuUserInfo selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<RuUserInfo> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用RuUserInfo.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static RuUserInfo selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(RuUserInfo fromModel, RuUserInfo toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(RuUserInfo fromModel, RuUserInfo toModel) {
