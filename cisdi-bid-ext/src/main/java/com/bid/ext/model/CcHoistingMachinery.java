...
/**
 * {"EN": "特种设备-起重机械", "ZH_CN": "特种设备-起重机械", "ZH_TW": "特种设备-起重机械"}。
 */
public class CcHoistingMachinery {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcHoistingMachinery> modelHelper = new ModelHelper<>("CC_HOISTING_MACHINERY", new CcHoistingMachinery());
    ...
    public static final String ENT_CODE = "CC_HOISTING_MACHINERY";
    ...
    public static class Cols {
         ...
         */
        public static final String CC_SPECIFICATION_AND_MODEL = "CC_SPECIFICATION_AND_MODEL";
        /**
         ...
         */
        public static final String CC_WORK_LEVEL = "CC_WORK_LEVEL";
        /**
         * {"EN": "主钩额定起重量(吨)", "ZH_CN": "主钩额定起重量(吨)", "ZH_TW": "主钩额定起重量(吨)"}。
         */
        public static final String CC_MAIN_HOOK_RATED_LIFTING_CAPACITY = "CC_MAIN_HOOK_RATED_LIFTING_CAPACITY";
        /**
         * {"EN": "副钩额定起重量(吨)", "ZH_CN": "副钩额定起重量(吨)", "ZH_TW": "副钩额定起重量(吨)"}。
         */
        public static final String CC_AUXILIARY_HOOK_RATED_LIFTING_CAPACITY = "CC_AUXILIARY_HOOK_RATED_LIFTING_CAPACITY";
        /**
     ...
     */
    public CcHoistingMachinery setId(String id) {
     ...
     */
    public CcHoistingMachinery setVer(Integer ver) {
     ...
     */
    public CcHoistingMachinery setTs(LocalDateTime ts) {
     ...
     */
    public CcHoistingMachinery setIsPreset(Boolean isPreset) {
     ...
     */
    public CcHoistingMachinery setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcHoistingMachinery setCrtUserId(String crtUserId) {
     ...
     */
    public CcHoistingMachinery setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcHoistingMachinery setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcHoistingMachinery setStatus(String status) {
     ...
     */
    public CcHoistingMachinery setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcHoistingMachinery setCode(String code) {
     ...
     */
    public CcHoistingMachinery setName(String name) {
     ...
     */
    public CcHoistingMachinery setRemark(String remark) {
     ...
     */
    public CcHoistingMachinery setFastCode(String fastCode) {
     ...
     */
    public CcHoistingMachinery setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcHoistingMachinery setCcSpecialEquipConHeadId(String ccSpecialEquipConHeadId) {
     ...
     */
    public CcHoistingMachinery setCcSpecialEquipRegProHeadId(String ccSpecialEquipRegProHeadId) {
     ...
     */
    public CcHoistingMachinery setCcSpecialEquipSupervisorId(String ccSpecialEquipSupervisorId) {
     ...
     */
    public CcHoistingMachinery setSlippageWarningDays(Integer slippageWarningDays) {
    ...
    /**
     * 获取：{"EN": "规格型号", "ZH_CN": "规格型号", "ZH_TW": "规格型号"}。
     */
    public String getCcSpecificationAndModel() {
        return this.ccSpecificationAndModel;
    }

    /**
     * 设置：{"EN": "规格型号", "ZH_CN": "规格型号", "ZH_TW": "规格型号"}。
     */
    public CcHoistingMachinery setCcSpecificationAndModel(String ccSpecificationAndModel) {
        if (this.ccSpecificationAndModel == null && ccSpecificationAndModel == null) {
            // 均为null，不做处理。
        } else if (this.ccSpecificationAndModel != null && ccSpecificationAndModel != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccSpecificationAndModel.compareTo(ccSpecificationAndModel) != 0) {
                this.ccSpecificationAndModel = ccSpecificationAndModel;
                if (!this.toUpdateCols.contains("CC_SPECIFICATION_AND_MODEL")) {
                    this.toUpdateCols.add("CC_SPECIFICATION_AND_MODEL");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcHoistingMachinery setCcFactoryNumber(String ccFactoryNumber) {
    ...
    /**
     * 获取：{"EN": "工作级别", "ZH_CN": "工作级别", "ZH_TW": "工作级别"}。
     */
    public String getCcWorkLevel() {
        return this.ccWorkLevel;
    }

    /**
     * 设置：{"EN": "工作级别", "ZH_CN": "工作级别", "ZH_TW": "工作级别"}。
     */
    public CcHoistingMachinery setCcWorkLevel(String ccWorkLevel) {
        if (this.ccWorkLevel == null && ccWorkLevel == null) {
            // 均为null，不做处理。
        } else if (this.ccWorkLevel != null && ccWorkLevel != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccWorkLevel.compareTo(ccWorkLevel) != 0) {
                this.ccWorkLevel = ccWorkLevel;
                if (!this.toUpdateCols.contains("CC_WORK_LEVEL")) {
                    this.toUpdateCols.add("CC_WORK_LEVEL");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
    ...
    /**
     * 获取：{"EN": "主钩额定起重量(吨)", "ZH_CN": "主钩额定起重量(吨)", "ZH_TW": "主钩额定起重量(吨)"}。
     */
    public BigDecimal getCcMainHookRatedLiftingCapacity() {
        return this.ccMainHookRatedLiftingCapacity;
    }

    /**
     * 设置：{"EN": "主钩额定起重量(吨)", "ZH_CN": "主钩额定起重量(吨)", "ZH_TW": "主钩额定起重量(吨)"}。
     */
    public CcHoistingMachinery setCcMainHookRatedLiftingCapacity(BigDecimal ccMainHookRatedLiftingCapacity) {
        if (this.ccMainHookRatedLiftingCapacity == null && ccMainHookRatedLiftingCapacity == null) {
            // 均为null，不做处理。
        } else if (this.ccMainHookRatedLiftingCapacity != null && ccMainHookRatedLiftingCapacity != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccMainHookRatedLiftingCapacity.compareTo(ccMainHookRatedLiftingCapacity) != 0) {
                this.ccMainHookRatedLiftingCapacity = ccMainHookRatedLiftingCapacity;
                if (!this.toUpdateCols.contains("CC_MAIN_HOOK_RATED_LIFTING_CAPACITY")) {
                    this.toUpdateCols.add("CC_MAIN_HOOK_RATED_LIFTING_CAPACITY");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
    ...
    /**
     * 获取：{"EN": "副钩额定起重量(吨)", "ZH_CN": "副钩额定起重量(吨)", "ZH_TW": "副钩额定起重量(吨)"}。
     */
    public BigDecimal getCcAuxiliaryHookRatedLiftingCapacity() {
        return this.ccAuxiliaryHookRatedLiftingCapacity;
    }

    /**
     * 设置：{"EN": "副钩额定起重量(吨)", "ZH_CN": "副钩额定起重量(吨)", "ZH_TW": "副钩额定起重量(吨)"}。
     */
    public CcHoistingMachinery setCcAuxiliaryHookRatedLiftingCapacity(BigDecimal ccAuxiliaryHookRatedLiftingCapacity) {
        if (this.ccAuxiliaryHookRatedLiftingCapacity == null && ccAuxiliaryHookRatedLiftingCapacity == null) {
            // 均为null，不做处理。
        } else if (this.ccAuxiliaryHookRatedLiftingCapacity != null && ccAuxiliaryHookRatedLiftingCapacity != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccAuxiliaryHookRatedLiftingCapacity.compareTo(ccAuxiliaryHookRatedLiftingCapacity) != 0) {
                this.ccAuxiliaryHookRatedLiftingCapacity = ccAuxiliaryHookRatedLiftingCapacity;
                if (!this.toUpdateCols.contains("CC_AUXILIARY_HOOK_RATED_LIFTING_CAPACITY")) {
                    this.toUpdateCols.add("CC_AUXILIARY_HOOK_RATED_LIFTING_CAPACITY");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcHoistingMachinery setCcInstallationUnit(String ccInstallationUnit) {
     ...
     */
    public CcHoistingMachinery setCcEquipPlanArriveDate(LocalDate ccEquipPlanArriveDate) {
     ...
     */
    public CcHoistingMachinery setCcEquipActArriveDate(LocalDate ccEquipActArriveDate) {
     ...
     */
    public CcHoistingMachinery setCcPlanConstructionNoticeDate(LocalDate ccPlanConstructionNoticeDate) {
     ...
     */
    public CcHoistingMachinery setCcCompleteConstructionNoticeDate(LocalDate ccCompleteConstructionNoticeDate) {
     ...
     */
    public CcHoistingMachinery setCcConstructionNoticeReceipt(String ccConstructionNoticeReceipt) {
     ...
     */
    public CcHoistingMachinery setCcPlanCompleteInstallTime(LocalDate ccPlanCompleteInstallTime) {
     ...
     */
    public CcHoistingMachinery setCcActCompleteInstallDate(LocalDate ccActCompleteInstallDate) {
     ...
     */
    public CcHoistingMachinery setCcPlanSuperviseInspection(LocalDate ccPlanSuperviseInspection) {
     ...
     */
    public CcHoistingMachinery setCcCompleteSuperviseInspection(LocalDate ccCompleteSuperviseInspection) {
     ...
     */
    public CcHoistingMachinery setCcInspectionReport(String ccInspectionReport) {
     ...
     */
    public CcHoistingMachinery setCcPlanSupInsAgeSceneCheckDate(LocalDate ccPlanSupInsAgeSceneCheckDate) {
     ...
     */
    public CcHoistingMachinery setCcCompleteSupInsAgeSceneCheckDate(LocalDate ccCompleteSupInsAgeSceneCheckDate) {
     ...
     */
    public CcHoistingMachinery setCcSceneCheckOpinion(String ccSceneCheckOpinion) {
     ...
     */
    public CcHoistingMachinery setCcGetSupInsQualifiedReportDate(LocalDate ccGetSupInsQualifiedReportDate) {
     ...
     */
    public CcHoistingMachinery setCcSupInsQualifiedReport(String ccSupInsQualifiedReport) {
     ...
     */
    public CcHoistingMachinery setCcPrjUnitPlanHandleUsageRegDate(LocalDate ccPrjUnitPlanHandleUsageRegDate) {
     ...
     */
    public CcHoistingMachinery setCcPlanPutIntoUseDate(LocalDate ccPlanPutIntoUseDate) {
     ...
     */
    public CcHoistingMachinery setCcActPutIntoUseDate(LocalDate ccActPutIntoUseDate) {
     ...
     */
    public CcHoistingMachinery setCcSpecialEquipUseRegistrationCart(String ccSpecialEquipUseRegistrationCart) {
     ...
     */
    public CcHoistingMachinery setCcEquipInstallLocation(String ccEquipInstallLocation) {
     ...
     * @return
     */
    public static CcHoistingMachinery newData() {
        CcHoistingMachinery obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcHoistingMachinery insertData() {
        CcHoistingMachinery obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcHoistingMachinery selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcHoistingMachinery obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcHoistingMachinery selectById(String id) {
     ...
     */
    public static List<CcHoistingMachinery> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcHoistingMachinery> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHoistingMachinery> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHoistingMachinery> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcHoistingMachinery> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHoistingMachinery> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcHoistingMachinery selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcHoistingMachinery> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcHoistingMachinery.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcHoistingMachinery selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcHoistingMachinery fromModel, CcHoistingMachinery toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcHoistingMachinery fromModel, CcHoistingMachinery toModel) {
