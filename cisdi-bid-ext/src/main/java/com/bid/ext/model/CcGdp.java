...
public class CcGdp {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcGdp> modelHelper = new ModelHelper<>("CC_GDP", new CcGdp());
    ...
    public static final String ENT_CODE = "CC_GDP";
    ...
    public static class Cols {
        ...
        /**
         * {"EN": "业务金额（元）", "ZH_CN": "计划金额（元）", "ZH_TW": "业务金额（元）"}。
         */
        public static final String PLAN_AMT = "PLAN_AMT";
    }
     ...
     */
    public CcGdp setCcPrjId(String ccPrjId) {
     ...
     */
    public CcGdp setVer(Integer ver) {
     ...
     */
    public CcGdp setTs(LocalDateTime ts) {
     ...
     */
    public CcGdp setIsPreset(Boolean isPreset) {
     ...
     */
    public CcGdp setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcGdp setCrtUserId(String crtUserId) {
     ...
     */
    public CcGdp setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcGdp setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcGdp setStatus(String status) {
     ...
     */
    public CcGdp setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcGdp setCode(String code) {
     ...
     */
    public CcGdp setName(String name) {
     ...
     */
    public CcGdp setRemark(String remark) {
     ...
     */
    public CcGdp setFastCode(String fastCode) {
     ...
     */
    public CcGdp setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcGdp setTrxDate(LocalDate trxDate) {
     ...
     */
    public CcGdp setTrxAmt(BigDecimal trxAmt) {
     ...
     */
    public CcGdp setCcPrjCbsTempalteNodeId(String ccPrjCbsTempalteNodeId) {
     ...
     */
    public CcGdp setCcAttachments(String ccAttachments) {
     ...
     */
    public CcGdp setPlanDate(LocalDate planDate) {
    ...
    /**
     * 获取：{"EN": "业务金额（元）", "ZH_CN": "计划金额（元）", "ZH_TW": "业务金额（元）"}。
     */
    ...
    /**
     * 设置：{"EN": "业务金额（元）", "ZH_CN": "计划金额（元）", "ZH_TW": "业务金额（元）"}。
     */
    public CcGdp setPlanAmt(BigDecimal planAmt) {
        if (this.planAmt == null && planAmt == null) {
            // 均为null，不做处理。
        } else if (this.planAmt != null && planAmt != null) {
            // 均非null，判定不等，再做处理：
            if (this.planAmt.compareTo(planAmt) != 0) {
                this.planAmt = planAmt;
                if (!this.toUpdateCols.contains("PLAN_AMT")) {
                    this.toUpdateCols.add("PLAN_AMT");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * @return
     */
    public static CcGdp newData() {
        CcGdp obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcGdp insertData() {
        CcGdp obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcGdp selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcGdp obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcGdp selectById(String id) {
     ...
     */
    public static List<CcGdp> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcGdp> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcGdp> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcGdp> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcGdp> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcGdp> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcGdp selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcGdp> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcGdp.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcGdp selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcGdp fromModel, CcGdp toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcGdp fromModel, CcGdp toModel) {
