...
/**
 * {"EN": "成本统览-简版", "ZH_CN": "成本统览-简版", "ZH_TW": "成本统览-简版"}。
 */
public class CcPrjCostOverviewSimple {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcPrjCostOverviewSimple> modelHelper = new ModelHelper<>("CC_PRJ_COST_OVERVIEW_SIMPLE", new CcPrjCostOverviewSimple());
    ...
    public static final String ENT_CODE = "CC_PRJ_COST_OVERVIEW_SIMPLE";
     ...
     */
    public CcPrjCostOverviewSimple setId(String id) {
     ...
     */
    public CcPrjCostOverviewSimple setVer(Integer ver) {
     ...
     */
    public CcPrjCostOverviewSimple setTs(LocalDateTime ts) {
     ...
     */
    public CcPrjCostOverviewSimple setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPrjCostOverviewSimple setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPrjCostOverviewSimple setCrtUserId(String crtUserId) {
     ...
     */
    public CcPrjCostOverviewSimple setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPrjCostOverviewSimple setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPrjCostOverviewSimple setStatus(String status) {
     ...
     */
    public CcPrjCostOverviewSimple setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPrjCostOverviewSimple setCode(String code) {
     ...
     */
    public CcPrjCostOverviewSimple setRemark(String remark) {
     ...
     */
    public CcPrjCostOverviewSimple setFastCode(String fastCode) {
     ...
     */
    public CcPrjCostOverviewSimple setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPrjCostOverviewSimple setSeqNo(BigDecimal seqNo) {
     ...
     */
    public CcPrjCostOverviewSimple setCopyFromPrjStructNodeId(String copyFromPrjStructNodeId) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs0Amt(BigDecimal cbs0Amt) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs1Amt(BigDecimal cbs1Amt) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs2Amt(BigDecimal cbs2Amt) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs3Amt(BigDecimal cbs3Amt) {
     ...
     */
    public CcPrjCostOverviewSimple setBidAmt(BigDecimal bidAmt) {
     ...
     */
    public CcPrjCostOverviewSimple setPurchaseAmt(BigDecimal purchaseAmt) {
     ...
     */
    public CcPrjCostOverviewSimple setCompleteAmt(BigDecimal completeAmt) {
     ...
     */
    public CcPrjCostOverviewSimple setReqPayAmt(BigDecimal reqPayAmt) {
     ...
     */
    public CcPrjCostOverviewSimple setPayAmt(BigDecimal payAmt) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs11Amt(BigDecimal cbs11Amt) {
     ...
     */
    public CcPrjCostOverviewSimple setCbs12Amt(BigDecimal cbs12Amt) {
     ...
     * @return
     */
    public static CcPrjCostOverviewSimple newData() {
        CcPrjCostOverviewSimple obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPrjCostOverviewSimple insertData() {
        CcPrjCostOverviewSimple obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPrjCostOverviewSimple selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPrjCostOverviewSimple obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPrjCostOverviewSimple selectById(String id) {
     ...
     */
    public static List<CcPrjCostOverviewSimple> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjCostOverviewSimple> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjCostOverviewSimple> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjCostOverviewSimple> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjCostOverviewSimple> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjCostOverviewSimple> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPrjCostOverviewSimple selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjCostOverviewSimple> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPrjCostOverviewSimple.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPrjCostOverviewSimple selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPrjCostOverviewSimple fromModel, CcPrjCostOverviewSimple toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPrjCostOverviewSimple fromModel, CcPrjCostOverviewSimple toModel) {
