...
public class CcEarlyWarning {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcEarlyWarning> modelHelper = new ModelHelper<>("CC_EARLY_WARNING", new CcEarlyWarning());
    ...
    public static final String ENT_CODE = "CC_EARLY_WARNING";
     ...
     */
    public CcEarlyWarning setId(String id) {
     ...
     */
    public CcEarlyWarning setVer(Integer ver) {
     ...
     */
    public CcEarlyWarning setTs(LocalDateTime ts) {
     ...
     */
    public CcEarlyWarning setIsPreset(Boolean isPreset) {
     ...
     */
    public CcEarlyWarning setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcEarlyWarning setCrtUserId(String crtUserId) {
     ...
     */
    public CcEarlyWarning setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcEarlyWarning setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcEarlyWarning setStatus(String status) {
     ...
     */
    public CcEarlyWarning setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcEarlyWarning setCode(String code) {
     ...
     */
    public CcEarlyWarning setName(String name) {
     ...
     */
    public CcEarlyWarning setRemark(String remark) {
     ...
     */
    public CcEarlyWarning setFastCode(String fastCode) {
     ...
     */
    public CcEarlyWarning setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcEarlyWarning setAdUserIds(String adUserIds) {
     ...
     * @return
     */
    public static CcEarlyWarning newData() {
        CcEarlyWarning obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcEarlyWarning insertData() {
        CcEarlyWarning obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcEarlyWarning selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcEarlyWarning obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcEarlyWarning selectById(String id) {
     ...
     */
    public static List<CcEarlyWarning> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcEarlyWarning> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcEarlyWarning> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcEarlyWarning> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcEarlyWarning> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcEarlyWarning> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcEarlyWarning selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcEarlyWarning> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcEarlyWarning.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcEarlyWarning selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcEarlyWarning fromModel, CcEarlyWarning toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcEarlyWarning fromModel, CcEarlyWarning toModel) {
