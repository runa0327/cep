...
/**
 * {"EN": "资料文件打包", "ZH_CN": "资料文件打包", "ZH_TW": "资料文件打包"}。
 */
public class CcDocFilePackage {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDocFilePackage> modelHelper = new ModelHelper<>("CC_DOC_FILE_PACKAGE", new CcDocFilePackage());
    ...
    public static final String ENT_CODE = "CC_DOC_FILE_PACKAGE";
     ...
     */
    public CcDocFilePackage setId(String id) {
     ...
     */
    public CcDocFilePackage setVer(Integer ver) {
     ...
     */
    public CcDocFilePackage setTs(LocalDateTime ts) {
     ...
     */
    public CcDocFilePackage setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDocFilePackage setCrtUserId(String crtUserId) {
     ...
     */
    public CcDocFilePackage setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDocFilePackage setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDocFilePackage setStatus(String status) {
     ...
     */
    public CcDocFilePackage setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDocFilePackage setCode(String code) {
     ...
     */
    public CcDocFilePackage setRemark(String remark) {
     ...
     */
    public CcDocFilePackage setFastCode(String fastCode) {
     ...
     */
    public CcDocFilePackage setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDocFilePackage setName(String name) {
     ...
     */
    public CcDocFilePackage setSeqNo(BigDecimal seqNo) {
     ...
     */
    public CcDocFilePackage setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcDocFilePackage setCcAttachment(String ccAttachment) {
     ...
     * @return
     */
    public static CcDocFilePackage newData() {
        CcDocFilePackage obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDocFilePackage insertData() {
        CcDocFilePackage obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDocFilePackage selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDocFilePackage obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDocFilePackage selectById(String id) {
     ...
     */
    public static List<CcDocFilePackage> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFilePackage> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFilePackage> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFilePackage> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFilePackage> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFilePackage> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDocFilePackage selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFilePackage> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDocFilePackage.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDocFilePackage selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDocFilePackage fromModel, CcDocFilePackage toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDocFilePackage fromModel, CcDocFilePackage toModel) {
