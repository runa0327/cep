...
public class CcPost {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcPost> modelHelper = new ModelHelper<>("CC_POST", new CcPost());
    ...
    public static final String ENT_CODE = "CC_POST";
     ...
     */
    public CcPost setVer(Integer ver) {
     ...
     */
    public CcPost setTs(LocalDateTime ts) {
     ...
     */
    public CcPost setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPost setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPost setCrtUserId(String crtUserId) {
     ...
     */
    public CcPost setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPost setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPost setStatus(String status) {
     ...
     */
    public CcPost setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPost setCode(String code) {
     ...
     */
    public CcPost setName(String name) {
     ...
     */
    public CcPost setRemark(String remark) {
     ...
     */
    public CcPost setFastCode(String fastCode) {
     ...
     */
    public CcPost setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPost setIsDefault(Boolean isDefault) {
     ...
     */
    public CcPost setSeqNo(BigDecimal seqNo) {
     ...
     * @return
     */
    public static CcPost newData() {
        CcPost obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPost insertData() {
        CcPost obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPost selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPost obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPost selectById(String id) {
     ...
     */
    public static List<CcPost> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPost> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPost> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPost> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPost> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPost> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPost selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPost> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPost.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPost selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPost fromModel, CcPost toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPost fromModel, CcPost toModel) {
