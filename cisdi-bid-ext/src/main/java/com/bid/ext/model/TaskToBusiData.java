 ...
 * 签字任务关联业务数据。
 */
public class TaskToBusiData {

    /**
     * 模型助手。
     */
    private static final ModelHelper<TaskToBusiData> modelHelper = new ModelHelper<>("TASK_TO_BUSI_DATA", new TaskToBusiData());
    ...
    public static final String ENT_CODE = "TASK_TO_BUSI_DATA";
     ...
     * 设置：ID。
     */
    public TaskToBusiData setId(String id) {
     ...
     * 设置：版本。
     */
    public TaskToBusiData setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public TaskToBusiData setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public TaskToBusiData setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public TaskToBusiData setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public TaskToBusiData setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public TaskToBusiData setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public TaskToBusiData setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public TaskToBusiData setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public TaskToBusiData setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public TaskToBusiData setCode(String code) {
     ...
     * 设置：名称。
     */
    public TaskToBusiData setName(String name) {
     ...
     * 设置：备注。
     */
    public TaskToBusiData setRemark(String remark) {
     ...
     * 设置：快捷码。
     */
    public TaskToBusiData setFastCode(String fastCode) {
     ...
     * 设置：图标。
     */
    public TaskToBusiData setIconFileGroupId(String iconFileGroupId) {
     ...
     * 设置：任务代码。
     */
    public TaskToBusiData setTaskCode(String taskCode) {
        if (this.taskCode == null && taskCode == null) {
            // 均为null，不做处理。
        } else if (this.taskCode != null && taskCode != null) {
            // 均非null，判定不等，再做处理：
            if (this.taskCode.compareTo(taskCode) != 0) {
     ...
     * 设置：实体代码。
     */
    public TaskToBusiData setEntCode(String entCode) {
     ...
     * 设置：实体记录ID。
     */
    public TaskToBusiData setEntityRecordId(String entityRecordId) {
     ...
     * @return
     */
    public static TaskToBusiData newData() {
        TaskToBusiData obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static TaskToBusiData insertData() {
        TaskToBusiData obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static TaskToBusiData selectById(String id, List<String> includeCols, List<String> excludeCols) {
        TaskToBusiData obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static TaskToBusiData selectById(String id) {
     ...
     */
    public static List<TaskToBusiData> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<TaskToBusiData> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<TaskToBusiData> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<TaskToBusiData> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<TaskToBusiData> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<TaskToBusiData> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static TaskToBusiData selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<TaskToBusiData> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用TaskToBusiData.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static TaskToBusiData selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(TaskToBusiData fromModel, TaskToBusiData toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(TaskToBusiData fromModel, TaskToBusiData toModel) {
