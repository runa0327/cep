 ...
 */
public class CcDrawingVersion {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDrawingVersion> modelHelper = new ModelHelper<>("CC_DRAWING_VERSION", new CcDrawingVersion());
    ...
    public static final String ENT_CODE = "CC_DRAWING_VERSION";
     ...
     */
    public CcDrawingVersion setId(String id) {
     ...
     */
    public CcDrawingVersion setVer(Integer ver) {
     ...
     */
    public CcDrawingVersion setTs(LocalDateTime ts) {
     ...
     */
    public CcDrawingVersion setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDrawingVersion setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcDrawingVersion setCrtUserId(String crtUserId) {
     ...
     */
    public CcDrawingVersion setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDrawingVersion setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDrawingVersion setStatus(String status) {
     ...
     */
    public CcDrawingVersion setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDrawingVersion setCode(String code) {
     ...
     */
    public CcDrawingVersion setName(String name) {
     ...
     */
    public CcDrawingVersion setRemark(String remark) {
     ...
     */
    public CcDrawingVersion setFastCode(String fastCode) {
     ...
     */
    public CcDrawingVersion setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDrawingVersion setSeqNo(BigDecimal seqNo) {
     ...
     * @return
     */
    public static CcDrawingVersion newData() {
        CcDrawingVersion obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDrawingVersion insertData() {
        CcDrawingVersion obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDrawingVersion selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDrawingVersion obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDrawingVersion selectById(String id) {
     ...
     */
    public static List<CcDrawingVersion> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingVersion> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingVersion> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingVersion> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingVersion> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingVersion> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingVersion selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingVersion> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDrawingVersion.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingVersion selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDrawingVersion fromModel, CcDrawingVersion toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDrawingVersion fromModel, CcDrawingVersion toModel) {
