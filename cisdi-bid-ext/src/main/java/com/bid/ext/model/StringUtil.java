...
public class StringUtil {
    ...
    public static String tableNameToClassName(String tableName) {
        ...
        for (String part : parts) {
            classNameBuilder.append(part.substring(0, 1).toUpperCase()).append(part.substring(1).toLowerCase());
        }
     ...
     * @return 数字
     */
    public static int getIntBySubLastStr(String str, String code) {
        String value = str.substring(str.lastIndexOf(code)+1);
