...
/**
 * {"EN": "项目关联流程实例", "ZH_CN": "项目关联流程实例", "ZH_TW": "项目关联流程实例"}。
 */
public class CcPrjToProcInst {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcPrjToProcInst> modelHelper = new ModelHelper<>("CC_PRJ_TO_PROC_INST", new CcPrjToProcInst());
    ...
    public static final String ENT_CODE = "CC_PRJ_TO_PROC_INST";
     ...
     */
    public CcPrjToProcInst setId(String id) {
     ...
     */
    public CcPrjToProcInst setVer(Integer ver) {
     ...
     */
    public CcPrjToProcInst setTs(LocalDateTime ts) {
     ...
     */
    public CcPrjToProcInst setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPrjToProcInst setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPrjToProcInst setCrtUserId(String crtUserId) {
     ...
     */
    public CcPrjToProcInst setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPrjToProcInst setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPrjToProcInst setStatus(String status) {
     ...
     */
    public CcPrjToProcInst setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPrjToProcInst setCode(String code) {
     ...
     */
    public CcPrjToProcInst setName(String name) {
     ...
     */
    public CcPrjToProcInst setRemark(String remark) {
     ...
     */
    public CcPrjToProcInst setFastCode(String fastCode) {
     ...
     */
    public CcPrjToProcInst setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPrjToProcInst setCcPrjId(String ccPrjId) {
     ...
     */
    public CcPrjToProcInst setWfProcessInstanceId(String wfProcessInstanceId) {
     ...
     * @return
     */
    public static CcPrjToProcInst newData() {
        CcPrjToProcInst obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPrjToProcInst insertData() {
        CcPrjToProcInst obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPrjToProcInst selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPrjToProcInst obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPrjToProcInst selectById(String id) {
     ...
     */
    public static List<CcPrjToProcInst> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjToProcInst> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjToProcInst> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjToProcInst> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjToProcInst> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPrjToProcInst> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPrjToProcInst selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPrjToProcInst> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPrjToProcInst.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPrjToProcInst selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPrjToProcInst fromModel, CcPrjToProcInst toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPrjToProcInst fromModel, CcPrjToProcInst toModel) {
