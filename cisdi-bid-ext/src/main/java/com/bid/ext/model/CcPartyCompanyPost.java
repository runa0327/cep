 ...
 */
public class CcPartyCompanyPost {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcPartyCompanyPost> modelHelper = new ModelHelper<>("CC_PARTY_COMPANY_POST", new CcPartyCompanyPost());
    ...
    public static final String ENT_CODE = "CC_PARTY_COMPANY_POST";
     ...
     */
    public CcPartyCompanyPost setId(String id) {
     ...
     */
    public CcPartyCompanyPost setVer(Integer ver) {
     ...
     */
    public CcPartyCompanyPost setTs(LocalDateTime ts) {
     ...
     */
    public CcPartyCompanyPost setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPartyCompanyPost setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPartyCompanyPost setCrtUserId(String crtUserId) {
     ...
     */
    public CcPartyCompanyPost setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPartyCompanyPost setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPartyCompanyPost setStatus(String status) {
     ...
     */
    public CcPartyCompanyPost setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPartyCompanyPost setCode(String code) {
     ...
     */
    public CcPartyCompanyPost setName(String name) {
     ...
     */
    public CcPartyCompanyPost setRemark(String remark) {
     ...
     */
    public CcPartyCompanyPost setFastCode(String fastCode) {
     ...
     */
    public CcPartyCompanyPost setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPartyCompanyPost setCcPrjId(String ccPrjId) {
     ...
     */
    public CcPartyCompanyPost setCcPrjPartyId(String ccPrjPartyId) {
     ...
     */
    public CcPartyCompanyPost setCcPartyCompanyId(String ccPartyCompanyId) {
    ...
    /**
     * 获取：{"EN": "参建方", "ZH_CN": "参建方", "ZH_TW": "参建方"}。
     */
    public String getCcPartyId() {
        return this.ccPartyId;
    }

    /**
     * 设置：{"EN": "参建方", "ZH_CN": "参建方", "ZH_TW": "参建方"}。
     */
    public CcPartyCompanyPost setCcPartyId(String ccPartyId) {
        if (this.ccPartyId == null && ccPartyId == null) {
            // 均为null，不做处理。
        } else if (this.ccPartyId != null && ccPartyId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccPartyId.compareTo(ccPartyId) != 0) {
     ...
     */
    public CcPartyCompanyPost setCcCompanyId(String ccCompanyId) {
     ...
     */
    public CcPartyCompanyPost setCcPostId(String ccPostId) {
     ...
     */
    public CcPartyCompanyPost setSeqNo(BigDecimal seqNo) {
     ...
     * @return
     */
    public static CcPartyCompanyPost newData() {
        CcPartyCompanyPost obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPartyCompanyPost insertData() {
        CcPartyCompanyPost obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPartyCompanyPost selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPartyCompanyPost obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPartyCompanyPost selectById(String id) {
     ...
     */
    public static List<CcPartyCompanyPost> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompanyPost> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompanyPost> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompanyPost> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompanyPost> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompanyPost> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPartyCompanyPost selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompanyPost> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPartyCompanyPost.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPartyCompanyPost selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPartyCompanyPost fromModel, CcPartyCompanyPost toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPartyCompanyPost fromModel, CcPartyCompanyPost toModel) {
