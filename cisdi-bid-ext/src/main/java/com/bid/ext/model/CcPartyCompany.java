 ...
 */
public class CcPartyCompany {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcPartyCompany> modelHelper = new ModelHelper<>("CC_PARTY_COMPANY", new CcPartyCompany());
    ...
    public static final String ENT_CODE = "CC_PARTY_COMPANY";
     ...
     */
    public CcPartyCompany setId(String id) {
     ...
     */
    public CcPartyCompany setVer(Integer ver) {
     ...
     */
    public CcPartyCompany setTs(LocalDateTime ts) {
     ...
     */
    public CcPartyCompany setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPartyCompany setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPartyCompany setCrtUserId(String crtUserId) {
     ...
     */
    public CcPartyCompany setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPartyCompany setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPartyCompany setStatus(String status) {
     ...
     */
    public CcPartyCompany setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPartyCompany setCode(String code) {
     ...
     */
    public CcPartyCompany setName(String name) {
     ...
     */
    public CcPartyCompany setRemark(String remark) {
     ...
     */
    public CcPartyCompany setFastCode(String fastCode) {
     ...
     */
    public CcPartyCompany setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPartyCompany setCcPrjId(String ccPrjId) {
     ...
     */
    public CcPartyCompany setCcPartyId(String ccPartyId) {
     ...
     * @return
     */
    public static CcPartyCompany newData() {
        CcPartyCompany obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPartyCompany insertData() {
        CcPartyCompany obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPartyCompany selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPartyCompany obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPartyCompany selectById(String id) {
     ...
     */
    public static List<CcPartyCompany> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompany> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompany> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompany> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompany> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPartyCompany> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPartyCompany selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPartyCompany> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPartyCompany.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPartyCompany selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPartyCompany fromModel, CcPartyCompany toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPartyCompany fromModel, CcPartyCompany toModel) {
