...
public class CcCompany {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcCompany> modelHelper = new ModelHelper<>("CC_COMPANY", new CcCompany());
    ...
    public static final String ENT_CODE = "CC_COMPANY";
     ...
     */
    public CcCompany setId(String id) {
     ...
     */
    public CcCompany setVer(Integer ver) {
     ...
     */
    public CcCompany setTs(LocalDateTime ts) {
     ...
     */
    public CcCompany setIsPreset(Boolean isPreset) {
     ...
     */
    public CcCompany setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcCompany setCrtUserId(String crtUserId) {
     ...
     */
    public CcCompany setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcCompany setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcCompany setStatus(String status) {
     ...
     */
    public CcCompany setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcCompany setCode(String code) {
     ...
     */
    public CcCompany setFastCode(String fastCode) {
     ...
     */
    public CcCompany setName(String name) {
     ...
     */
    public CcCompany setFullName(String fullName) {
     ...
     */
    public CcCompany setRemark(String remark) {
     ...
     */
    public CcCompany setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcCompany setIsDefault(Boolean isDefault) {
     ...
     */
    public CcCompany setSeqNo(BigDecimal seqNo) {
     ...
     * @return
     */
    public static CcCompany newData() {
        CcCompany obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcCompany insertData() {
        CcCompany obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcCompany selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcCompany obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcCompany selectById(String id) {
     ...
     */
    public static List<CcCompany> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcCompany> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCompany> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCompany> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcCompany> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcCompany> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcCompany selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcCompany> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcCompany.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcCompany selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcCompany fromModel, CcCompany toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcCompany fromModel, CcCompany toModel) {
