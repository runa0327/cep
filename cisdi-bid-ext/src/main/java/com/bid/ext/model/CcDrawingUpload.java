...
/**
 * {"EN": "图纸上传", "ZH_CN": "图纸上传", "ZH_TW": "图纸上传"}。
 */
public class CcDrawingUpload {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDrawingUpload> modelHelper = new ModelHelper<>("CC_DRAWING_UPLOAD", new CcDrawingUpload());
    ...
    public static final String ENT_CODE = "CC_DRAWING_UPLOAD";
     ...
     */
    public CcDrawingUpload setId(String id) {
     ...
     */
    public CcDrawingUpload setVer(Integer ver) {
     ...
     */
    public CcDrawingUpload setTs(LocalDateTime ts) {
     ...
     */
    public CcDrawingUpload setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDrawingUpload setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDrawingUpload setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDrawingUpload setStatus(String status) {
     ...
     */
    public CcDrawingUpload setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDrawingUpload setCode(String code) {
     ...
     */
    public CcDrawingUpload setName(String name) {
     ...
     */
    public CcDrawingUpload setFastCode(String fastCode) {
     ...
     */
    public CcDrawingUpload setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDrawingUpload setCcAttachment(String ccAttachment) {
     ...
     */
    public CcDrawingUpload setCcDrawingVersionId(String ccDrawingVersionId) {
     ...
     * @return
     */
    public static CcDrawingUpload newData() {
        CcDrawingUpload obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDrawingUpload insertData() {
        CcDrawingUpload obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDrawingUpload selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDrawingUpload obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDrawingUpload selectById(String id) {
     ...
     */
    public static List<CcDrawingUpload> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingUpload> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingUpload> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingUpload> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingUpload> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingUpload> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingUpload selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingUpload> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDrawingUpload.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingUpload selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDrawingUpload fromModel, CcDrawingUpload toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDrawingUpload fromModel, CcDrawingUpload toModel) {
