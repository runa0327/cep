...
/**
 * {"EN": "图纸授权", "ZH_CN": "图纸授权", "ZH_TW": "图纸授权"}。
 */
public class CcDrawingAuth {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDrawingAuth> modelHelper = new ModelHelper<>("CC_DRAWING_AUTH", new CcDrawingAuth());
    ...
    public static final String ENT_CODE = "CC_DRAWING_AUTH";
    ...
    public static class Cols {
        ...
        /**
         * {"EN": "是否完成", "ZH_CN": "是否查看", "ZH_TW": "是否完成"}。
         */
        public static final String IS_VIEW = "IS_VIEW";
        /**
         * {"EN": "是否上传/升级", "ZH_CN": "是否上传/升级", "ZH_TW": "是否上传/升级"}。
         */
     ...
     */
    public CcDrawingAuth setId(String id) {
     ...
     */
    public CcDrawingAuth setVer(Integer ver) {
     ...
     */
    public CcDrawingAuth setTs(LocalDateTime ts) {
     ...
     */
    public CcDrawingAuth setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDrawingAuth setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcDrawingAuth setCrtUserId(String crtUserId) {
     ...
     */
    public CcDrawingAuth setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDrawingAuth setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDrawingAuth setStatus(String status) {
     ...
     */
    public CcDrawingAuth setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDrawingAuth setCode(String code) {
     ...
     */
    public CcDrawingAuth setName(String name) {
     ...
     */
    public CcDrawingAuth setRemark(String remark) {
     ...
     */
    public CcDrawingAuth setFastCode(String fastCode) {
     ...
     */
    public CcDrawingAuth setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDrawingAuth setCcPrjStructNodeId(String ccPrjStructNodeId) {
     ...
     */
    public CcDrawingAuth setCcDrawingManagementId(String ccDrawingManagementId) {
     ...
     */
    public CcDrawingAuth setAdUserId(String adUserId) {
    ...
    /**
     * 获取：{"EN": "是否完成", "ZH_CN": "是否查看", "ZH_TW": "是否完成"}。
     */
    ...
    /**
     * 设置：{"EN": "是否完成", "ZH_CN": "是否查看", "ZH_TW": "是否完成"}。
     */
    public CcDrawingAuth setIsView(Boolean isView) {
    ...
    /**
     * 获取：{"EN": "是否上传/升级", "ZH_CN": "是否上传/升级", "ZH_TW": "是否上传/升级"}。
     */
    ...
    /**
     * 设置：{"EN": "是否上传/升级", "ZH_CN": "是否上传/升级", "ZH_TW": "是否上传/升级"}。
     */
    public CcDrawingAuth setIsUpload(Boolean isUpload) {
        if (this.isUpload == null && isUpload == null) {
            // 均为null，不做处理。
        } else if (this.isUpload != null && isUpload != null) {
            // 均非null，判定不等，再做处理：
            if (this.isUpload.compareTo(isUpload) != 0) {
                this.isUpload = isUpload;
                if (!this.toUpdateCols.contains("IS_UPLOAD")) {
                    this.toUpdateCols.add("IS_UPLOAD");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * @return
     */
    public static CcDrawingAuth newData() {
        CcDrawingAuth obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDrawingAuth insertData() {
        CcDrawingAuth obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDrawingAuth selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDrawingAuth obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDrawingAuth selectById(String id) {
     ...
     */
    public static List<CcDrawingAuth> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingAuth> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingAuth> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingAuth> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingAuth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDrawingAuth> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingAuth selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDrawingAuth> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDrawingAuth.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDrawingAuth selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDrawingAuth fromModel, CcDrawingAuth toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDrawingAuth fromModel, CcDrawingAuth toModel) {
