...
public class CcConstructPlan {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcConstructPlan> modelHelper = new ModelHelper<>("CC_CONSTRUCT_PLAN", new CcConstructPlan());
    ...
    public static final String ENT_CODE = "CC_CONSTRUCT_PLAN";
     ...
     * @return
     */
    public static CcConstructPlan newData() {
        CcConstructPlan obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcConstructPlan insertData() {
        CcConstructPlan obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcConstructPlan selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcConstructPlan obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcConstructPlan selectById(String id) {
     ...
     */
    public static List<CcConstructPlan> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructPlan> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructPlan> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructPlan> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructPlan> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructPlan> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcConstructPlan selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructPlan> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcConstructPlan.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcConstructPlan selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcConstructPlan fromModel, CcConstructPlan toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcConstructPlan fromModel, CcConstructPlan toModel) {
