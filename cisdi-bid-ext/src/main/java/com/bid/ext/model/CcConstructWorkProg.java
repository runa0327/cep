...
/**
 * {"EN": "施工工作进展", "ZH_CN": "施工工作进展", "ZH_TW": "施工工作进展"}。
 */
public class CcConstructWorkProg {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcConstructWorkProg> modelHelper = new ModelHelper<>("CC_CONSTRUCT_WORK_PROG", new CcConstructWorkProg());
    ...
    public static final String ENT_CODE = "CC_CONSTRUCT_WORK_PROG";
     ...
     */
    public CcConstructWorkProg setCcPrjId(String ccPrjId) {
     ...
     */
    public CcConstructWorkProg setId(String id) {
     ...
     */
    public CcConstructWorkProg setVer(Integer ver) {
     ...
     */
    public CcConstructWorkProg setTs(LocalDateTime ts) {
     ...
     */
    public CcConstructWorkProg setIsPreset(Boolean isPreset) {
     ...
     */
    public CcConstructWorkProg setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcConstructWorkProg setCrtUserId(String crtUserId) {
     ...
     */
    public CcConstructWorkProg setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcConstructWorkProg setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcConstructWorkProg setStatus(String status) {
     ...
     */
    public CcConstructWorkProg setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcConstructWorkProg setCode(String code) {
     ...
     */
    public CcConstructWorkProg setName(String name) {
     ...
     */
    public CcConstructWorkProg setFastCode(String fastCode) {
     ...
     */
    public CcConstructWorkProg setIconFileGroupId(String iconFileGroupId) {
     ...
     * {"EN": "施工工作", "ZH_CN": "施工工作", "ZH_TW": "施工工作"}。
     */
    private String ccConstructWorkId;

    /**
     * 获取：{"EN": "施工工作", "ZH_CN": "施工工作", "ZH_TW": "施工工作"}。
     */
    public String getCcConstructWorkId() {
        return this.ccConstructWorkId;
    }

    /**
     * 设置：{"EN": "施工工作", "ZH_CN": "施工工作", "ZH_TW": "施工工作"}。
     */
    public CcConstructWorkProg setCcConstructWorkId(String ccConstructWorkId) {
        if (this.ccConstructWorkId == null && ccConstructWorkId == null) {
            // 均为null，不做处理。
        } else if (this.ccConstructWorkId != null && ccConstructWorkId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccConstructWorkId.compareTo(ccConstructWorkId) != 0) {
                this.ccConstructWorkId = ccConstructWorkId;
                if (!this.toUpdateCols.contains("CC_CONSTRUCT_WORK_ID")) {
                    this.toUpdateCols.add("CC_CONSTRUCT_WORK_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcConstructWorkProg setProgTime(LocalDateTime progTime) {
     ...
     */
    public CcConstructWorkProg setRemark(String remark) {
     ...
     */
    public CcConstructWorkProg setCcAttachments(String ccAttachments) {
     ...
     * @return
     */
    public static CcConstructWorkProg newData() {
        CcConstructWorkProg obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcConstructWorkProg insertData() {
        CcConstructWorkProg obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcConstructWorkProg selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcConstructWorkProg obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcConstructWorkProg selectById(String id) {
     ...
     */
    public static List<CcConstructWorkProg> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWorkProg> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWorkProg> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWorkProg> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWorkProg> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcConstructWorkProg> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcConstructWorkProg selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcConstructWorkProg> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcConstructWorkProg.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcConstructWorkProg selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcConstructWorkProg fromModel, CcConstructWorkProg toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcConstructWorkProg fromModel, CcConstructWorkProg toModel) {
