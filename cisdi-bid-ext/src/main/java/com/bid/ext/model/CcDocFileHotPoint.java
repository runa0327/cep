...
/**
 * {"EN": "资料文件热点", "ZH_CN": "资料文件热点", "ZH_TW": "资料文件热点"}。
 */
public class CcDocFileHotPoint implements Serializable {
    private static final long serialVersionUID = 1L;
    /**
     * 模型助手。
     */
    private static final ModelHelper<CcDocFileHotPoint> modelHelper = new ModelHelper<>("CC_DOC_FILE_HOT_POINT", new CcDocFileHotPoint());
    ...
    public static final String ENT_CODE = "CC_DOC_FILE_HOT_POINT";
     ...
     */
    public CcDocFileHotPoint setId(String id) {
     ...
     */
    public CcDocFileHotPoint setVer(Integer ver) {
     ...
     */
    public CcDocFileHotPoint setTs(LocalDateTime ts) {
     ...
     */
    public CcDocFileHotPoint setIsPreset(Boolean isPreset) {
     ...
     */
    public CcDocFileHotPoint setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcDocFileHotPoint setCrtUserId(String crtUserId) {
     ...
     */
    public CcDocFileHotPoint setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcDocFileHotPoint setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcDocFileHotPoint setStatus(String status) {
     ...
     */
    public CcDocFileHotPoint setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcDocFileHotPoint setCode(String code) {
     ...
     */
    public CcDocFileHotPoint setName(String name) {
     ...
     */
    public CcDocFileHotPoint setRemark(String remark) {
     ...
     */
    public CcDocFileHotPoint setFastCode(String fastCode) {
     ...
     */
    public CcDocFileHotPoint setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcDocFileHotPoint setCcDocFileId(String ccDocFileId) {
    ...
    /**
     * 设置：{"EN": "坐标", "ZH_CN": "坐标", "ZH_TW": "坐标"}。
     */
    public CcDocFileHotPoint setPosition(String position) {
        if (this.position == null && position == null) {
            // 均为null，不做处理。
        } else if (this.position != null && position != null) {
            // 均非null，判定不等，再做处理：
            if (this.position.compareTo(position) != 0) {
                this.position = position;
                if (!this.toUpdateCols.contains("POSITION")) {
                    this.toUpdateCols.add("POSITION");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcDocFileHotPoint setCcPrjId(String ccPrjId) {
     ...
     */
    public CcDocFileHotPoint setCcAttachment(String ccAttachment) {
     ...
     * @return
     */
    public static CcDocFileHotPoint newData() {
        CcDocFileHotPoint obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcDocFileHotPoint insertData() {
        CcDocFileHotPoint obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcDocFileHotPoint selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcDocFileHotPoint obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcDocFileHotPoint selectById(String id) {
     ...
     */
    public static List<CcDocFileHotPoint> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileHotPoint> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileHotPoint> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileHotPoint> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileHotPoint> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcDocFileHotPoint> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcDocFileHotPoint selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcDocFileHotPoint> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcDocFileHotPoint.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcDocFileHotPoint selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcDocFileHotPoint fromModel, CcDocFileHotPoint toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcDocFileHotPoint fromModel, CcDocFileHotPoint toModel) {
