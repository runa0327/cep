...
public class CcPay {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcPay> modelHelper = new ModelHelper<>("CC_PAY", new CcPay());
    ...
    public static final String ENT_CODE = "CC_PAY";
     ...
     */
    public CcPay setCcPrjId(String ccPrjId) {
     ...
     */
    public CcPay setVer(Integer ver) {
     ...
     */
    public CcPay setTs(LocalDateTime ts) {
     ...
     */
    public CcPay setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPay setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPay setCrtUserId(String crtUserId) {
     ...
     */
    public CcPay setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPay setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPay setStatus(String status) {
     ...
     */
    public CcPay setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPay setCode(String code) {
     ...
     */
    public CcPay setName(String name) {
     ...
     */
    public CcPay setRemark(String remark) {
     ...
     */
    public CcPay setFastCode(String fastCode) {
     ...
     */
    public CcPay setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPay setCcPrjCbsTempalteNodeId(String ccPrjCbsTempalteNodeId) {
     ...
     */
    public CcPay setCcAttachments(String ccAttachments) {
     ...
     */
    public CcPay setTrxDate(LocalDate trxDate) {
     ...
     */
    public CcPay setTrxAmt(BigDecimal trxAmt) {
     ...
     * @return
     */
    public static CcPay newData() {
        CcPay obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPay insertData() {
        CcPay obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPay selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPay obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPay selectById(String id) {
     ...
     */
    public static List<CcPay> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPay> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPay> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPay> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPay> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPay> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPay selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPay> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcPay.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcPay selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPay fromModel, CcPay toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPay fromModel, CcPay toModel) {
