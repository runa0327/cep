...
public class CcCriticalPrjPlan {
    ...
    public static class Cols {
         ...
         * 单位工程-危大工程。
         */
        public static final String CC_CRITICAL_UNIT_PRJ_ID = "CC_CRITICAL_UNIT_PRJ_ID";
        /**
         * 危大方案报审责任人。
         */
         ...
         * 危大工程-施工单位。
         */
        public static final String CC_PAR_UNIT_ID = "CC_PAR_UNIT_ID";
        /**
         * 监理单位工程师。
         */
     ...
     * 单位工程-危大工程。
     */
    private String ccCriticalUnitPrjId;

    /**
     * 获取：单位工程-危大工程。
     */
    public String getCcCriticalUnitPrjId() {
        return this.ccCriticalUnitPrjId;
    }

    /**
     * 设置：单位工程-危大工程。
     */
    public CcCriticalPrjPlan setCcCriticalUnitPrjId(String ccCriticalUnitPrjId) {
        if (this.ccCriticalUnitPrjId == null && ccCriticalUnitPrjId == null) {
            // 均为null，不做处理。
        } else if (this.ccCriticalUnitPrjId != null && ccCriticalUnitPrjId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccCriticalUnitPrjId.compareTo(ccCriticalUnitPrjId) != 0) {
                this.ccCriticalUnitPrjId = ccCriticalUnitPrjId;
                if (!this.toUpdateCols.contains("CC_CRITICAL_UNIT_PRJ_ID")) {
                    this.toUpdateCols.add("CC_CRITICAL_UNIT_PRJ_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 危大工程-施工单位。
     */
    private String ccParUnitId;

    /**
     * 获取：危大工程-施工单位。
     */
    public String getCcParUnitId() {
        return this.ccParUnitId;
    }

    /**
     * 设置：危大工程-施工单位。
     */
    public CcCriticalPrjPlan setCcParUnitId(String ccParUnitId) {
        if (this.ccParUnitId == null && ccParUnitId == null) {
            // 均为null，不做处理。
        } else if (this.ccParUnitId != null && ccParUnitId != null) {
            // 均非null，判定不等，再做处理：
            if (this.ccParUnitId.compareTo(ccParUnitId) != 0) {
                this.ccParUnitId = ccParUnitId;
                if (!this.toUpdateCols.contains("CC_PAR_UNIT_ID")) {
                    this.toUpdateCols.add("CC_PAR_UNIT_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：监理单位工程师。
     */
    public CcCriticalPrjPlan setCcProcessSuperviseUserIds(String ccProcessSuperviseUserIds) {
     ...
     * 设置：项目结构节点。
     */
    public CcCriticalPrjPlan setCcPrjStructNodeId(String ccPrjStructNodeId) {
