...
/**
 * {"EN": "EN：角色用户", "ZH_CN": "角色用户", "ZH_TW": "繁：角色用户"}。
 */
public class AdRoleUser {

    /**
     * 模型助手。
     */
    private static final ModelHelper<AdRoleUser> modelHelper = new ModelHelper<>("AD_ROLE_USER", new AdRoleUser());
    ...
    public static final String ENT_CODE = "AD_ROLE_USER";
    ...
    public static class Cols {
        ...
        /**
         * {"EN": "AD_ROLE_ID", "ZH_CN": "角色", "ZH_TW": "繁：角色"}。
         */
     ...
     */
    public AdRoleUser setId(String id) {
     ...
     */
    public AdRoleUser setVer(Integer ver) {
     ...
     */
    public AdRoleUser setTs(LocalDateTime ts) {
     ...
     */
    public AdRoleUser setIsPreset(Boolean isPreset) {
     ...
     */
    public AdRoleUser setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public AdRoleUser setCrtUserId(String crtUserId) {
     ...
     */
    public AdRoleUser setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public AdRoleUser setLastModiUserId(String lastModiUserId) {
     ...
     */
    public AdRoleUser setStatus(String status) {
     ...
     */
    public AdRoleUser setLkWfInstId(String lkWfInstId) {
     ...
     */
    public AdRoleUser setCode(String code) {
     ...
     */
    public AdRoleUser setName(String name) {
     ...
     */
    public AdRoleUser setRemark(String remark) {
     ...
     */
    public AdRoleUser setFastCode(String fastCode) {
     ...
     */
    public AdRoleUser setIconFileGroupId(String iconFileGroupId) {
    ...
    /**
     * 获取：{"EN": "AD_ROLE_ID", "ZH_CN": "角色", "ZH_TW": "繁：角色"}。
     */
    ...
    /**
     * 设置：{"EN": "AD_ROLE_ID", "ZH_CN": "角色", "ZH_TW": "繁：角色"}。
     */
    public AdRoleUser setAdRoleId(String adRoleId) {
     ...
     */
    public AdRoleUser setAdUserId(String adUserId) {
     ...
     * @return
     */
    public static AdRoleUser newData() {
        AdRoleUser obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static AdRoleUser insertData() {
        AdRoleUser obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static AdRoleUser selectById(String id, List<String> includeCols, List<String> excludeCols) {
        AdRoleUser obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static AdRoleUser selectById(String id) {
     ...
     */
    public static List<AdRoleUser> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<AdRoleUser> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<AdRoleUser> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<AdRoleUser> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<AdRoleUser> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<AdRoleUser> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static AdRoleUser selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<AdRoleUser> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用AdRoleUser.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static AdRoleUser selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(AdRoleUser fromModel, AdRoleUser toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(AdRoleUser fromModel, AdRoleUser toModel) {
