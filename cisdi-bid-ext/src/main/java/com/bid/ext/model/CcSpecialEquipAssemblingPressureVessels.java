 ...
 */
public class CcSpecialEquipAssemblingPressureVessels {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcSpecialEquipAssemblingPressureVessels> modelHelper = new ModelHelper<>("CC_SPECIAL_EQUIP_ASSEMBLING_PRESSURE_VESSELS", new CcSpecialEquipAssemblingPressureVessels());
    ...
    public static final String ENT_CODE = "CC_SPECIAL_EQUIP_ASSEMBLING_PRESSURE_VESSELS";
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setId(String id) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setVer(Integer ver) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setTs(LocalDateTime ts) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setIsPreset(Boolean isPreset) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCrtUserId(String crtUserId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setStatus(String status) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCode(String code) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setName(String name) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setRemark(String remark) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setFastCode(String fastCode) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPrjId(String ccPrjId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipMedium(String ccSpecialEquipMedium) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipVolume(BigDecimal ccSpecialEquipVolume) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipPressure(BigDecimal ccSpecialEquipPressure) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipSecValCheckDate(LocalDate ccSpecialEquipSecValCheckDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipComlSecValRep(String ccSpecialEquipComlSecValRep) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipPreGageCheckDate(LocalDate ccSpecialEquipPreGageCheckDate) {
    ...
    /**
     * 获取：{"EN": "设备压力计检验报告", "ZH_CN": "设备压力表检验报告", "ZH_TW": "设备压力计检验报告"}。
     */
    ...
    /**
     * 设置：{"EN": "设备压力计检验报告", "ZH_CN": "设备压力表检验报告", "ZH_TW": "设备压力计检验报告"}。
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipComlPreGageRep(String ccSpecialEquipComlPreGageRep) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipInsQualityCert(String ccSpecialEquipInsQualityCert) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipActUseReg(LocalDate ccSpecialEquipActUseReg) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipConHeadId(String ccSpecialEquipConHeadId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipRegProHeadId(String ccSpecialEquipRegProHeadId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipSupervisorId(String ccSpecialEquipSupervisorId) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setSlippageWarningDays(Integer slippageWarningDays) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcFactoryNumber(String ccFactoryNumber) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcInstallationUnit(String ccInstallationUnit) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcEquipPlanArriveDate(LocalDate ccEquipPlanArriveDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcEquipActArriveDate(LocalDate ccEquipActArriveDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPlanConstructionNoticeDate(LocalDate ccPlanConstructionNoticeDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcCompleteConstructionNoticeDate(LocalDate ccCompleteConstructionNoticeDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcConstructionNoticeReceipt(String ccConstructionNoticeReceipt) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPlanCompleteInstallTime(LocalDate ccPlanCompleteInstallTime) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcActCompleteInstallDate(LocalDate ccActCompleteInstallDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPlanSuperviseInspection(LocalDate ccPlanSuperviseInspection) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcCompleteSuperviseInspection(LocalDate ccCompleteSuperviseInspection) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcInspectionReport(String ccInspectionReport) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPlanSupInsAgeSceneCheckDate(LocalDate ccPlanSupInsAgeSceneCheckDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcCompleteSupInsAgeSceneCheckDate(LocalDate ccCompleteSupInsAgeSceneCheckDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSceneCheckOpinion(String ccSceneCheckOpinion) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcGetSupInsQualifiedReportDate(LocalDate ccGetSupInsQualifiedReportDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSupInsQualifiedReport(String ccSupInsQualifiedReport) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPrjUnitPlanHandleUsageRegDate(LocalDate ccPrjUnitPlanHandleUsageRegDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcPlanPutIntoUseDate(LocalDate ccPlanPutIntoUseDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcActPutIntoUseDate(LocalDate ccActPutIntoUseDate) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcSpecialEquipUseRegistrationCart(String ccSpecialEquipUseRegistrationCart) {
     ...
     */
    public CcSpecialEquipAssemblingPressureVessels setCcEquipInstallLocation(String ccEquipInstallLocation) {
     ...
     * @return
     */
    public static CcSpecialEquipAssemblingPressureVessels newData() {
        CcSpecialEquipAssemblingPressureVessels obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcSpecialEquipAssemblingPressureVessels insertData() {
        CcSpecialEquipAssemblingPressureVessels obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcSpecialEquipAssemblingPressureVessels selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcSpecialEquipAssemblingPressureVessels obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcSpecialEquipAssemblingPressureVessels selectById(String id) {
     ...
     */
    public static List<CcSpecialEquipAssemblingPressureVessels> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcSpecialEquipAssemblingPressureVessels> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcSpecialEquipAssemblingPressureVessels> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcSpecialEquipAssemblingPressureVessels> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcSpecialEquipAssemblingPressureVessels> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcSpecialEquipAssemblingPressureVessels> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcSpecialEquipAssemblingPressureVessels selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcSpecialEquipAssemblingPressureVessels> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcSpecialEquipAssemblingPressureVessels.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcSpecialEquipAssemblingPressureVessels selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcSpecialEquipAssemblingPressureVessels fromModel, CcSpecialEquipAssemblingPressureVessels toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcSpecialEquipAssemblingPressureVessels fromModel, CcSpecialEquipAssemblingPressureVessels toModel) {
