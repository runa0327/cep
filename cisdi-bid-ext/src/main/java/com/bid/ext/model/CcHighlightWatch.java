...
/**
 * {"EN": "亮点观摩", "ZH_CN": "亮点观摩", "ZH_TW": "亮点观摩"}。
 */
public class CcHighlightWatch {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CcHighlightWatch> modelHelper = new ModelHelper<>("CC_HIGHLIGHT_WATCH", new CcHighlightWatch());
    ...
    public static final String ENT_CODE = "CC_HIGHLIGHT_WATCH";
    ...
    public static class Cols {
         ...
         */
        public static final String HIGHLIGHT_WATCH_IMG = "HIGHLIGHT_WATCH_IMG";
        /**
     ...
     */
    public CcHighlightWatch setId(String id) {
     ...
     */
    public CcHighlightWatch setVer(Integer ver) {
     ...
     */
    public CcHighlightWatch setTs(LocalDateTime ts) {
     ...
     */
    public CcHighlightWatch setIsPreset(Boolean isPreset) {
     ...
     */
    public CcHighlightWatch setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcHighlightWatch setCrtUserId(String crtUserId) {
     ...
     */
    public CcHighlightWatch setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcHighlightWatch setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcHighlightWatch setStatus(String status) {
     ...
     */
    public CcHighlightWatch setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcHighlightWatch setCode(String code) {
     ...
     */
    public CcHighlightWatch setFastCode(String fastCode) {
     ...
     */
    public CcHighlightWatch setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcHighlightWatch setCcPrjId(String ccPrjId) {
     ...
     */
    public CcHighlightWatch setCcPrjStructNodeId(String ccPrjStructNodeId) {
    ...
    /**
     * 获取：{"EN": "事项日期", "ZH_CN": "事项日期", "ZH_TW": "事项日期"}。
     */
    ...
    /**
     * 设置：{"EN": "事项日期", "ZH_CN": "事项日期", "ZH_TW": "事项日期"}。
     */
    public CcHighlightWatch setHighlightDate(LocalDate highlightDate) {
        if (this.highlightDate == null && highlightDate == null) {
            // 均为null，不做处理。
        } else if (this.highlightDate != null && highlightDate != null) {
            // 均非null，判定不等，再做处理：
            if (this.highlightDate.compareTo(highlightDate) != 0) {
                this.highlightDate = highlightDate;
                if (!this.toUpdateCols.contains("HIGHLIGHT_DATE")) {
                    this.toUpdateCols.add("HIGHLIGHT_DATE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * {"EN": "亮点观摩图片", "ZH_CN": "亮点观摩图片", "ZH_TW": "亮点观摩图片"}。
     */
    private String highlightWatchImg;

    /**
     * 获取：{"EN": "亮点观摩图片", "ZH_CN": "亮点观摩图片", "ZH_TW": "亮点观摩图片"}。
     */
    public String getHighlightWatchImg() {
        return this.highlightWatchImg;
    }

    /**
     * 设置：{"EN": "亮点观摩图片", "ZH_CN": "亮点观摩图片", "ZH_TW": "亮点观摩图片"}。
     */
    public CcHighlightWatch setHighlightWatchImg(String highlightWatchImg) {
        if (this.highlightWatchImg == null && highlightWatchImg == null) {
            // 均为null，不做处理。
        } else if (this.highlightWatchImg != null && highlightWatchImg != null) {
            // 均非null，判定不等，再做处理：
            if (this.highlightWatchImg.compareTo(highlightWatchImg) != 0) {
                this.highlightWatchImg = highlightWatchImg;
                if (!this.toUpdateCols.contains("HIGHLIGHT_WATCH_IMG")) {
                    this.toUpdateCols.add("HIGHLIGHT_WATCH_IMG");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     */
    public CcHighlightWatch setCcAttachments(String ccAttachments) {
     ...
     * @return
     */
    public static CcHighlightWatch newData() {
        CcHighlightWatch obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcHighlightWatch insertData() {
        CcHighlightWatch obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcHighlightWatch selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcHighlightWatch obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcHighlightWatch selectById(String id) {
     ...
     */
    public static List<CcHighlightWatch> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcHighlightWatch> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHighlightWatch> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHighlightWatch> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcHighlightWatch> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcHighlightWatch> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcHighlightWatch selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcHighlightWatch> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用CcHighlightWatch.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static CcHighlightWatch selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcHighlightWatch fromModel, CcHighlightWatch toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcHighlightWatch fromModel, CcHighlightWatch toModel) {
