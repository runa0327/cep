...
public class CcPo2 {
     ...
     * 模型助手。
     */
    private static final ModelHelper<CcPo2> modelHelper = new ModelHelper<>("CC_PO", new CcPo2());
     ...
     */
    public CcPo2 setCcPrjId(String ccPrjId) {
     ...
     */
    public CcPo2 setVer(Integer ver) {
     ...
     */
    public CcPo2 setTs(LocalDateTime ts) {
     ...
     */
    public CcPo2 setIsPreset(Boolean isPreset) {
     ...
     */
    public CcPo2 setCrtDt(LocalDateTime crtDt) {
     ...
     */
    public CcPo2 setCrtUserId(String crtUserId) {
     ...
     */
    public CcPo2 setLastModiDt(LocalDateTime lastModiDt) {
     ...
     */
    public CcPo2 setLastModiUserId(String lastModiUserId) {
     ...
     */
    public CcPo2 setStatus(String status) {
     ...
     */
    public CcPo2 setLkWfInstId(String lkWfInstId) {
     ...
     */
    public CcPo2 setRemark(String remark) {
     ...
     */
    public CcPo2 setFastCode(String fastCode) {
     ...
     */
    public CcPo2 setIconFileGroupId(String iconFileGroupId) {
     ...
     */
    public CcPo2 setSettlementAmt(BigDecimal settlementAmt) {
     ...
     */
    public CcPo2 setCcBidCreateUserId(String ccBidCreateUserId) {
     ...
     */
    public CcPo2 setCcCurrencyTypeId(String ccCurrencyTypeId) {
     ...
     */
    public CcPo2 setCode(String code) {
     ...
     */
    public CcPo2 setCcPrjStructNodeId(String ccPrjStructNodeId) {
     ...
     */
    public CcPo2 setName(String name) {
     ...
     */
    public CcPo2 setProjectUnit(String projectUnit) {
     ...
     */
    public CcPo2 setCcPoTypeId(String ccPoTypeId) {
     ...
     */
    public CcPo2 setPartyA(String partyA) {
     ...
     */
    public CcPo2 setPartyAContactName(String partyAContactName) {
     ...
     */
    public CcPo2 setPartyAContactPhone(String partyAContactPhone) {
     ...
     */
    public CcPo2 setPartyB(String partyB) {
     ...
     */
    public CcPo2 setPartyBContactName(String partyBContactName) {
     ...
     */
    public CcPo2 setPartyBContactPhone(String partyBContactPhone) {
     ...
     */
    public CcPo2 setCcBidParticipateTypeId(String ccBidParticipateTypeId) {
     ...
     */
    public CcPo2 setTrxDate(LocalDate trxDate) {
     ...
     */
    public CcPo2 setTrxAmtInit(BigDecimal trxAmtInit) {
     ...
     */
    public CcPo2 setTrxAmt(BigDecimal trxAmt) {
     ...
     */
    public CcPo2 setCcPrjCbsTempalteNodeId(String ccPrjCbsTempalteNodeId) {
     ...
     */
    public CcPo2 setCcWbsStatusId(String ccWbsStatusId) {
     ...
     */
    public CcPo2 setCcPoStatusId(String ccPoStatusId) {
     ...
     */
    public CcPo2 setPlanFr(LocalDate planFr) {
     ...
     */
    public CcPo2 setPlanTo(LocalDate planTo) {
     ...
     */
    public CcPo2 setIsRegistered(Boolean isRegistered) {
     ...
     */
    public CcPo2 setCcRegisteredStatusId(String ccRegisteredStatusId) {
     ...
     */
    public CcPo2 setCcAttachments(String ccAttachments) {
     ...
     * @return
     */
    public static CcPo2 newData() {
        CcPo2 obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CcPo2 insertData() {
        CcPo2 obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CcPo2 selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CcPo2 obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static CcPo2 selectById(String id) {
     ...
     */
    public static List<CcPo2> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CcPo2> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPo2> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPo2> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPo2> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmpty(list)方法判断有无。
     */
    public static List<CcPo2> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static CcPo2 selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CcPo2> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
     ...
     * @return 获取到的对象。
     */
    public static CcPo2 selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(CcPo2 fromModel, CcPo2 toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(CcPo2 fromModel, CcPo2 toModel) {
