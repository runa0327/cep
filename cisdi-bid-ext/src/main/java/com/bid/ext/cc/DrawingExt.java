        ...
        if (file.isDirectory()) {
            ...
            try (InputStream inputStream = Files.newInputStream(file.toPath());
                ...
                if (fileExists) {
                    ...
                    newFile.setFileInlineUrl(FlPathConfig.FILE_INLINE_URL_FIX + "?fileId=" + fileId);
                    newFile.setFileAttachmentUrl(FlPathConfig.FILE_ATTACHMENT_URL_FIX + "?fileId=" + fileId);
