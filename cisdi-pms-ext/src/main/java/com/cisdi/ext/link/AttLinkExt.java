    ...
    private AttLinkResult attLink(AttLinkParam param) {
        ...
        if ("PROJECT_TYPE_ID".equals(attCode)) {
...

            {
                ...
                typeValueText.value = JdbcMapUtil.getString(row, "CONSTRUCT_DAYS");
                typeValueText.text = JdbcMapUtil.getString(row, "CONSTRUCT_DAYS");
                attLinkResult.attMap.put("CONSTRUCT_DAYS", typeValueText);
            }

            {
                TypeValueText typeValueText = new TypeValueText();
                typeValueText.type = AttDataTypeE.TEXT_LONG;
                typeValueText.value = JdbcMapUtil.getString(row, "BUILD_YEAR_LIMIT");
                typeValueText.text = JdbcMapUtil.getString(row, "BUILD_YEAR_LIMIT");
                attLinkResult.attMap.put("BUILD_YEAR_LIMIT", typeValueText);
            }
