 ...
 * 合同品牌变更申请。
 */
public class ContractBrandChangeApplication {

    /**
     * 模型助手。
     */
    private static final ModelHelper<ContractBrandChangeApplication> modelHelper = new ModelHelper<>("CONTRACT_BRAND_CHANGE_APPLICATION", new ContractBrandChangeApplication());
    ...
    public static final String ENT_CODE = "CONTRACT_BRAND_CHANGE_APPLICATION";
     ...
     * 设置：ID。
     */
    public ContractBrandChangeApplication setId(String id) {
     ...
     * 设置：版本。
     */
    public ContractBrandChangeApplication setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public ContractBrandChangeApplication setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public ContractBrandChangeApplication setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public ContractBrandChangeApplication setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public ContractBrandChangeApplication setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public ContractBrandChangeApplication setCode(String code) {
     ...
     * 设置：名称。
     */
    public ContractBrandChangeApplication setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public ContractBrandChangeApplication setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public ContractBrandChangeApplication setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public ContractBrandChangeApplication setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public ContractBrandChangeApplication setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public ContractBrandChangeApplication setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public ContractBrandChangeApplication setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public ContractBrandChangeApplication setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public ContractBrandChangeApplication setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public ContractBrandChangeApplication setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public ContractBrandChangeApplication setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public ContractBrandChangeApplication setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public ContractBrandChangeApplication setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public ContractBrandChangeApplication setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public ContractBrandChangeApplication setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public ContractBrandChangeApplication setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public ContractBrandChangeApplication setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public ContractBrandChangeApplication setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public ContractBrandChangeApplication setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public ContractBrandChangeApplication setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public ContractBrandChangeApplication setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public ContractBrandChangeApplication setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public ContractBrandChangeApplication setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public ContractBrandChangeApplication setRemark(String remark) {
     ...
     * @return
     */
    public static ContractBrandChangeApplication newData() {
        ContractBrandChangeApplication obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static ContractBrandChangeApplication insertData() {
        ContractBrandChangeApplication obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static ContractBrandChangeApplication selectById(String id, List<String> includeCols, List<String> excludeCols) {
        ContractBrandChangeApplication obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<ContractBrandChangeApplication> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<ContractBrandChangeApplication> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<ContractBrandChangeApplication> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<ContractBrandChangeApplication> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(ContractBrandChangeApplication fromModel, ContractBrandChangeApplication toModel, List<String> includeCols, List<String> excludeCols) {
