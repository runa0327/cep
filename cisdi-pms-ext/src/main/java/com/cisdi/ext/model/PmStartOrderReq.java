 ...
 * 开工令。
 */
public class PmStartOrderReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmStartOrderReq> modelHelper = new ModelHelper<>("PM_START_ORDER_REQ", new PmStartOrderReq());
    ...
    public static final String ENT_CODE = "PM_START_ORDER_REQ";
     ...
     * 设置：ID。
     */
    public PmStartOrderReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmStartOrderReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmStartOrderReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmStartOrderReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmStartOrderReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmStartOrderReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmStartOrderReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmStartOrderReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmStartOrderReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmStartOrderReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmStartOrderReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmStartOrderReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmStartOrderReq setPrjCode(String prjCode) {
     ...
     * 设置：项目类型。
     */
    public PmStartOrderReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建用户。
     */
    public PmStartOrderReq setCrtUserId(String crtUserId) {
     ...
     * 设置：项目概况。
     */
    public PmStartOrderReq setPrjSituation(String prjSituation) {
     ...
     * 设置：创建部门。
     */
    public PmStartOrderReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：创建日期时间。
     */
    public PmStartOrderReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：备注。
     */
    public PmStartOrderReq setRemarkShort(String remarkShort) {
     ...
     * 设置：日期1。
     */
    public PmStartOrderReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：备注1。
     */
    public PmStartOrderReq setRemarkOne(String remarkOne) {
     ...
     * 设置：附件1。
     */
    public PmStartOrderReq setFileIdOne(String fileIdOne) {
     ...
     * @return
     */
    public static PmStartOrderReq newData() {
        PmStartOrderReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmStartOrderReq insertData() {
        PmStartOrderReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmStartOrderReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmStartOrderReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmStartOrderReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmStartOrderReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmStartOrderReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmStartOrderReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmStartOrderReq fromModel, PmStartOrderReq toModel, List<String> includeCols, List<String> excludeCols) {
