...
public class AdDbObjectV {
    ...
    public static class Cols {
         ...
         * 数据库对象名称。
         */
        public static final String DB_OBJ_NAME = "DB_OBJ_NAME";
        /**
         * 数据库对象类型。
         */
        public static final String DB_OBJ_TYPE = "DB_OBJ_TYPE";
    }
     ...
     */
    public static void copyCols(AdDbObjectV fromModel, AdDbObjectV toModel, List<String> includeCols, List<String> excludeCols) {
