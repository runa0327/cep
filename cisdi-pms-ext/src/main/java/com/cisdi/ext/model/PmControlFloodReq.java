 ...
 * 防洪评价。
 */
public class PmControlFloodReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmControlFloodReq> modelHelper = new ModelHelper<>("PM_CONTROL_FLOOD_REQ", new PmControlFloodReq());
    ...
    public static final String ENT_CODE = "PM_CONTROL_FLOOD_REQ";
     ...
     * 设置：ID。
     */
    public PmControlFloodReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmControlFloodReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmControlFloodReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmControlFloodReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmControlFloodReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmControlFloodReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmControlFloodReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmControlFloodReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmControlFloodReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmControlFloodReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmControlFloodReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmControlFloodReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmControlFloodReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmControlFloodReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmControlFloodReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmControlFloodReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmControlFloodReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmControlFloodReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmControlFloodReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmControlFloodReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmControlFloodReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmControlFloodReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmControlFloodReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmControlFloodReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmControlFloodReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmControlFloodReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmControlFloodReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmControlFloodReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmControlFloodReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmControlFloodReq setPrjSituation(String prjSituation) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmControlFloodReq setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmControlFloodReq setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmControlFloodReq setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmControlFloodReq setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmControlFloodReq setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmControlFloodReq setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmControlFloodReq setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：计划完成日期。
     */
    public PmControlFloodReq setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：附件1。
     */
    public PmControlFloodReq setFileIdOne(String fileIdOne) {
     ...
     * 设置：申请时间。
     */
    public PmControlFloodReq setApplyTime(LocalDate applyTime) {
     ...
     * 设置：申请人。
     */
    public PmControlFloodReq setApplicant(String applicant) {
     ...
     * 设置：审批附件1。
     */
    public PmControlFloodReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：附件2。
     */
    public PmControlFloodReq setFileIdTwo(String fileIdTwo) {
     ...
     * 设置：备案日期。
     */
    public PmControlFloodReq setKeepRecordDate(LocalDate keepRecordDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmControlFloodReq setReplyNoWr(String replyNoWr) {
     ...
     * 设置：有效期。
     */
    public PmControlFloodReq setValidTerm(String validTerm) {
     ...
     * 设置：审批附件2。
     */
    public PmControlFloodReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * @return
     */
    public static PmControlFloodReq newData() {
        PmControlFloodReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmControlFloodReq insertData() {
        PmControlFloodReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmControlFloodReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmControlFloodReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmControlFloodReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmControlFloodReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmControlFloodReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmControlFloodReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmControlFloodReq fromModel, PmControlFloodReq toModel, List<String> includeCols, List<String> excludeCols) {
