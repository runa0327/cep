...
public class PmPrjPlanningPermitReq {
     ...
     * 设置：附件1。
     */
    public PmPrjPlanningPermitReq setFileIdOne(String fileIdOne) {
     ...
     * 设置：长备注1。
     */
    public PmPrjPlanningPermitReq setTextRemarkOne(String textRemarkOne) {
     ...
     * 设置：日期1。
     */
    public PmPrjPlanningPermitReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：长备注2。
     */
    public PmPrjPlanningPermitReq setTextRemarkTwo(String textRemarkTwo) {
     ...
     * 设置：是否导入的记录。
     */
    public PmPrjPlanningPermitReq setIsImport(Boolean isImport) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmPrjPlanningPermitReq selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjPlanningPermitReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjPlanningPermitReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmPrjPlanningPermitReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjPlanningPermitReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmPrjPlanningPermitReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmPrjPlanningPermitReq selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmPrjPlanningPermitReq fromModel, PmPrjPlanningPermitReq toModel) {
