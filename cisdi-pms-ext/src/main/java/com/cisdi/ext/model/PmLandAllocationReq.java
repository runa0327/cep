 ...
 * 土地划拨。
 */
public class PmLandAllocationReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmLandAllocationReq> modelHelper = new ModelHelper<>("PM_LAND_ALLOCATION_REQ", new PmLandAllocationReq());
    ...
    public static final String ENT_CODE = "PM_LAND_ALLOCATION_REQ";
     ...
     * 设置：ID。
     */
    public PmLandAllocationReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmLandAllocationReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmLandAllocationReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmLandAllocationReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmLandAllocationReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmLandAllocationReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmLandAllocationReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmLandAllocationReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmLandAllocationReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmLandAllocationReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmLandAllocationReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmLandAllocationReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmLandAllocationReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmLandAllocationReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmLandAllocationReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmLandAllocationReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmLandAllocationReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmLandAllocationReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmLandAllocationReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmLandAllocationReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmLandAllocationReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmLandAllocationReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmLandAllocationReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmLandAllocationReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmLandAllocationReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmLandAllocationReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmLandAllocationReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmLandAllocationReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmLandAllocationReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmLandAllocationReq setPrjSituation(String prjSituation) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmLandAllocationReq setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmLandAllocationReq setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmLandAllocationReq setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmLandAllocationReq setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmLandAllocationReq setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmLandAllocationReq setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmLandAllocationReq setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：计划完成日期。
     */
    public PmLandAllocationReq setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：申请时间。
     */
    public PmLandAllocationReq setApplyTime(LocalDate applyTime) {
     ...
     * 设置：申请人。
     */
    public PmLandAllocationReq setApplicant(String applicant) {
     ...
     * 设置：审批附件1。
     */
    public PmLandAllocationReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：备注。
     */
    public PmLandAllocationReq setRemarkShort(String remarkShort) {
     ...
     * 设置：主体申请日期。
     */
    public PmLandAllocationReq setSubjectApplyDate(LocalDate subjectApplyDate) {
     ...
     * 设置：主体许可计划完成日期。
     */
    public PmLandAllocationReq setSubjectPlanComplDate(LocalDate subjectPlanComplDate) {
     ...
     * 设置：经办人2。
     */
    public PmLandAllocationReq setAgentTwo(String agentTwo) {
     ...
     * 设置：审批附件2。
     */
    public PmLandAllocationReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：备注1。
     */
    public PmLandAllocationReq setRemarkOne(String remarkOne) {
     ...
     * 设置：实际批复日期。
     */
    public PmLandAllocationReq setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmLandAllocationReq setReplyNoWr(String replyNoWr) {
     ...
     * 设置：有效期。
     */
    public PmLandAllocationReq setValidTerm(String validTerm) {
     ...
     * 设置：审批附件3。
     */
    public PmLandAllocationReq setApproveFileIdThree(String approveFileIdThree) {
     ...
     * 设置：是否导入的记录。
     */
    public PmLandAllocationReq setIsImport(Boolean isImport) {
     ...
     * @return
     */
    public static PmLandAllocationReq newData() {
        PmLandAllocationReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmLandAllocationReq insertData() {
        PmLandAllocationReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmLandAllocationReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmLandAllocationReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmLandAllocationReq selectById(String id) {
     ...
     */
    public static List<PmLandAllocationReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmLandAllocationReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmLandAllocationReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmLandAllocationReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmLandAllocationReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmLandAllocationReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmLandAllocationReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmLandAllocationReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmLandAllocationReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmLandAllocationReq selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmLandAllocationReq fromModel, PmLandAllocationReq toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmLandAllocationReq fromModel, PmLandAllocationReq toModel) {
