 ...
 * 工程索赔通知书。
 */
public class ProjectClaimNotice {

    /**
     * 模型助手。
     */
    private static final ModelHelper<ProjectClaimNotice> modelHelper = new ModelHelper<>("PROJECT_CLAIM_NOTICE", new ProjectClaimNotice());
    ...
    public static final String ENT_CODE = "PROJECT_CLAIM_NOTICE";
     ...
     * 设置：ID。
     */
    public ProjectClaimNotice setId(String id) {
     ...
     * 设置：版本。
     */
    public ProjectClaimNotice setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public ProjectClaimNotice setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public ProjectClaimNotice setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public ProjectClaimNotice setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public ProjectClaimNotice setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public ProjectClaimNotice setCode(String code) {
     ...
     * 设置：名称。
     */
    public ProjectClaimNotice setName(String name) {
     ...
     * 设置：备注。
     */
    public ProjectClaimNotice setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public ProjectClaimNotice setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：记录状态。
     */
    public ProjectClaimNotice setStatus(String status) {
     ...
     * 设置：项目。
     */
    public ProjectClaimNotice setPmPrjId(String pmPrjId) {
     ...
     * 设置：创建用户。
     */
    public ProjectClaimNotice setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public ProjectClaimNotice setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目编号。
     */
    public ProjectClaimNotice setPrjCode(String prjCode) {
     ...
     * 设置：项目管理模式。
     */
    public ProjectClaimNotice setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建日期时间。
     */
    public ProjectClaimNotice setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：立项批复文号。
     */
    public ProjectClaimNotice setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：投资来源。
     */
    public ProjectClaimNotice setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public ProjectClaimNotice setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目类型。
     */
    public ProjectClaimNotice setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public ProjectClaimNotice setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public ProjectClaimNotice setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：工程其他费用（万）。
     */
    public ProjectClaimNotice setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：预备费（万）。
     */
    public ProjectClaimNotice setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public ProjectClaimNotice setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：项目概况。
     */
    public ProjectClaimNotice setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public ProjectClaimNotice setAttFileGroupId(String attFileGroupId) {
     ...
     * @return
     */
    public static ProjectClaimNotice newData() {
        ProjectClaimNotice obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static ProjectClaimNotice insertData() {
        ProjectClaimNotice obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static ProjectClaimNotice selectById(String id, List<String> includeCols, List<String> excludeCols) {
        ProjectClaimNotice obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<ProjectClaimNotice> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<ProjectClaimNotice> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<ProjectClaimNotice> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<ProjectClaimNotice> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(ProjectClaimNotice fromModel, ProjectClaimNotice toModel, List<String> includeCols, List<String> excludeCols) {
