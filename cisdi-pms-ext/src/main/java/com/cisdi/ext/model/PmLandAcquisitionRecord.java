 ...
 * 征地拆迁记录。
 */
public class PmLandAcquisitionRecord {
    ...
    public static final String ENT_CODE = "PM_LAND_ACQUISITION_RECORD";
     ...
     */
    public static void copyCols(PmLandAcquisitionRecord fromModel, PmLandAcquisitionRecord toModel, List<String> includeCols, List<String> excludeCols) {
