 ...
 * 项目施工单位信息报送。
 */
public class PmConstructionSubm {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmConstructionSubm> modelHelper = new ModelHelper<>("PM_CONSTRUCTION_SUBM", new PmConstructionSubm());
    ...
    public static final String ENT_CODE = "PM_CONSTRUCTION_SUBM";
     ...
     * 设置：ID。
     */
    public PmConstructionSubm setId(String id) {
     ...
     * 设置：版本。
     */
    public PmConstructionSubm setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmConstructionSubm setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmConstructionSubm setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PmConstructionSubm setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PmConstructionSubm setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmConstructionSubm setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmConstructionSubm setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PmConstructionSubm setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PmConstructionSubm setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public PmConstructionSubm setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmConstructionSubm setName(String name) {
     ...
     * 设置：项目。
     */
    public PmConstructionSubm setPmPrjId(String pmPrjId) {
     ...
     * 设置：责任人。
     */
    public PmConstructionSubm setResponsibleId(String responsibleId) {
     ...
     * 设置：项目管理模式。
     */
    public PmConstructionSubm setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：项目类型。
     */
    public PmConstructionSubm setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总包单位名称。
     */
    public PmConstructionSubm setTotalUnitName(String totalUnitName) {
     ...
     * 设置：月份。
     */
    public PmConstructionSubm setMonth(String month) {
     ...
     * 设置：附件1。
     */
    public PmConstructionSubm setFileIdOne(String fileIdOne) {
     ...
     * 设置：附件2。
     */
    public PmConstructionSubm setFileIdTwo(String fileIdTwo) {
     ...
     * 设置：附件3。
     */
    public PmConstructionSubm setFileIdThree(String fileIdThree) {
     ...
     * 设置：附件4。
     */
    public PmConstructionSubm setFileIdFour(String fileIdFour) {
     ...
     * 设置：备注。
     */
    public PmConstructionSubm setRemark(String remark) {
     ...
     * @return
     */
    public static PmConstructionSubm newData() {
        PmConstructionSubm obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmConstructionSubm insertData() {
        PmConstructionSubm obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmConstructionSubm selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmConstructionSubm obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmConstructionSubm> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmConstructionSubm> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmConstructionSubm> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmConstructionSubm> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmConstructionSubm fromModel, PmConstructionSubm toModel, List<String> includeCols, List<String> excludeCols) {
