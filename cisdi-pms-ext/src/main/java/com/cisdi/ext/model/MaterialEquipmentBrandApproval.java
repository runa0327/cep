 ...
 * 工程材料设备及品牌报审。
 */
public class MaterialEquipmentBrandApproval {

    /**
     * 模型助手。
     */
    private static final ModelHelper<MaterialEquipmentBrandApproval> modelHelper = new ModelHelper<>("MATERIAL_EQUIPMENT_BRAND_APPROVAL", new MaterialEquipmentBrandApproval());
    ...
    public static final String ENT_CODE = "MATERIAL_EQUIPMENT_BRAND_APPROVAL";
     ...
     * 设置：ID。
     */
    public MaterialEquipmentBrandApproval setId(String id) {
     ...
     * 设置：版本。
     */
    public MaterialEquipmentBrandApproval setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public MaterialEquipmentBrandApproval setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public MaterialEquipmentBrandApproval setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public MaterialEquipmentBrandApproval setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public MaterialEquipmentBrandApproval setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public MaterialEquipmentBrandApproval setCode(String code) {
     ...
     * 设置：名称。
     */
    public MaterialEquipmentBrandApproval setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public MaterialEquipmentBrandApproval setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public MaterialEquipmentBrandApproval setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public MaterialEquipmentBrandApproval setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public MaterialEquipmentBrandApproval setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public MaterialEquipmentBrandApproval setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public MaterialEquipmentBrandApproval setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public MaterialEquipmentBrandApproval setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public MaterialEquipmentBrandApproval setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public MaterialEquipmentBrandApproval setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public MaterialEquipmentBrandApproval setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public MaterialEquipmentBrandApproval setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public MaterialEquipmentBrandApproval setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public MaterialEquipmentBrandApproval setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public MaterialEquipmentBrandApproval setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public MaterialEquipmentBrandApproval setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public MaterialEquipmentBrandApproval setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public MaterialEquipmentBrandApproval setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public MaterialEquipmentBrandApproval setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public MaterialEquipmentBrandApproval setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public MaterialEquipmentBrandApproval setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public MaterialEquipmentBrandApproval setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public MaterialEquipmentBrandApproval setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public MaterialEquipmentBrandApproval setRemark(String remark) {
     ...
     * @return
     */
    public static MaterialEquipmentBrandApproval newData() {
        MaterialEquipmentBrandApproval obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static MaterialEquipmentBrandApproval insertData() {
        MaterialEquipmentBrandApproval obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static MaterialEquipmentBrandApproval selectById(String id, List<String> includeCols, List<String> excludeCols) {
        MaterialEquipmentBrandApproval obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<MaterialEquipmentBrandApproval> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<MaterialEquipmentBrandApproval> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<MaterialEquipmentBrandApproval> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<MaterialEquipmentBrandApproval> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(MaterialEquipmentBrandApproval fromModel, MaterialEquipmentBrandApproval toModel, List<String> includeCols, List<String> excludeCols) {
