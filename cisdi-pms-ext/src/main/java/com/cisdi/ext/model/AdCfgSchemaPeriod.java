 ...
 * 配置方案期间。
 */
public class AdCfgSchemaPeriod {
    ...
    public static final String ENT_CODE = "AD_CFG_SCHEMA_PERIOD";
     ...
     */
    public static void copyCols(AdCfgSchemaPeriod fromModel, AdCfgSchemaPeriod toModel, List<String> includeCols, List<String> excludeCols) {
