 ...
 * 环评-LJ。
 */
public class PmEnvironmentEvalLj {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmEnvironmentEvalLj> modelHelper = new ModelHelper<>("PM_ENVIRONMENT_EVAL_LJ", new PmEnvironmentEvalLj());

    // 实体常量：
    // <editor-fold>

    public static final String ENT_CODE = "PM_ENVIRONMENT_EVAL_LJ";
     ...
     * 设置：ID。
     */
    public PmEnvironmentEvalLj setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * 设置：版本。
     */
    public PmEnvironmentEvalLj setVer(Integer ver) {
        this.ver = ver;
        return this;
    }
     ...
     * 设置：时间戳。
     */
    public PmEnvironmentEvalLj setTs(LocalDateTime ts) {
        this.ts = ts;
        return this;
    }
     ...
     * 设置：是否预设。
     */
    public PmEnvironmentEvalLj setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmEnvironmentEvalLj setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmEnvironmentEvalLj setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmEnvironmentEvalLj setCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * 设置：名称。
     */
    public PmEnvironmentEvalLj setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * 设置：项目。
     */
    public PmEnvironmentEvalLj setPmPrjId(String pmPrjId) {
     ...
     * 设置：锁定流程实例。
     */
    public PmEnvironmentEvalLj setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目编号。
     */
    public PmEnvironmentEvalLj setPrjCode(String prjCode) {
     ...
     * 设置：记录状态。
     */
    public PmEnvironmentEvalLj setStatus(String status) {
        this.status = status;
        return this;
    }
     ...
     * 设置：创建用户。
     */
    public PmEnvironmentEvalLj setCrtUserId(String crtUserId) {
     ...
     * 设置：业主单位。
     */
    public PmEnvironmentEvalLj setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目管理模式。
     */
    public PmEnvironmentEvalLj setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建部门。
     */
    public PmEnvironmentEvalLj setCrtDeptId(String crtDeptId) {
     ...
     * 设置：创建日期时间。
     */
    public PmEnvironmentEvalLj setCrtDt(LocalDateTime crtDt) {
        this.crtDt = crtDt;
        return this;
    }
     ...
     * 设置：建设地点。
     */
    public PmEnvironmentEvalLj setBaseLocationId(String baseLocationId) {
     ...
     * 设置：占地面积（平方）。
     */
    public PmEnvironmentEvalLj setFloorArea(Double floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmEnvironmentEvalLj setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmEnvironmentEvalLj setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmEnvironmentEvalLj setConScaleQty(Double conScaleQty) {
     ...
     * 设置：建设规模数量2。
     */
    public PmEnvironmentEvalLj setConScaleQty2(Double conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmEnvironmentEvalLj setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmEnvironmentEvalLj setBuildYears(Double buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmEnvironmentEvalLj setPrjSituation(String prjSituation) {
     ...
     * 设置：招采标流程标题。
     */
    public PmEnvironmentEvalLj setBiddingNameId(String biddingNameId) {
     ...
     * 设置：审核状态。
     */
    public PmEnvironmentEvalLj setApprovalStatus(String approvalStatus) {
     ...
     * 设置：委托单位(文本)。
     */
    public PmEnvironmentEvalLj setEntrustingUnitText(String entrustingUnitText) {
     ...
     * 设置：采购经办人。
     */
    public PmEnvironmentEvalLj setProcureUserId(String procureUserId) {
     ...
     * 设置：编制单位(文本)。
     */
    public PmEnvironmentEvalLj setAuthorUnitText(String authorUnitText) {
     ...
     * 设置：对方负责人。
     */
    public PmEnvironmentEvalLj setOtherResponsor(String otherResponsor) {
     ...
     * 设置：进场日期。
     */
    public PmEnvironmentEvalLj setInDate(LocalDate inDate) {
        this.inDate = inDate;
        return this;
    }
     ...
     * 设置：服务周期。
     */
    public PmEnvironmentEvalLj setServiceDays(Integer serviceDays) {
     ...
     * 设置：对方联系方式。
     */
    public PmEnvironmentEvalLj setOtherContactPhone(String otherContactPhone) {
     ...
     * 设置：计划完成日期。
     */
    public PmEnvironmentEvalLj setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：申请时间。
     */
    public PmEnvironmentEvalLj setApplyTime(LocalDate applyTime) {
     ...
     * 设置：申请人。
     */
    public PmEnvironmentEvalLj setApplicant(String applicant) {
     ...
     * 设置：环评申请材料。
     */
    public PmEnvironmentEvalLj setEiaReqFile(String eiaReqFile) {
     ...
     * 设置：备注。
     */
    public PmEnvironmentEvalLj setRemark(String remark) {
        this.remark = remark;
        return this;
    }
     ...
     * 设置：评审计划完成日期。
     */
    public PmEnvironmentEvalLj setReviewPlanDate(LocalDate reviewPlanDate) {
     ...
     * 设置：评审实际完成日期。
     */
    public PmEnvironmentEvalLj setReviewActualDate(LocalDate reviewActualDate) {
     ...
     * 设置：评审单位负责人。
     */
    public PmEnvironmentEvalLj setReviewUnitChief(String reviewUnitChief) {
     ...
     * 设置：评审组织单位。
     */
    public PmEnvironmentEvalLj setReviewOrganizationUnit(String reviewOrganizationUnit) {
     ...
     * 设置：评审单位联系方式。
     */
    public PmEnvironmentEvalLj setReviewUnitPhone(String reviewUnitPhone) {
     ...
     * 设置：评审稿文件。
     */
    public PmEnvironmentEvalLj setReviewReportFile(String reviewReportFile) {
     ...
     * 设置：专家意见文件。
     */
    public PmEnvironmentEvalLj setExpertFile(String expertFile) {
     ...
     * 设置：修编稿文件。
     */
    public PmEnvironmentEvalLj setRevisionFile(String revisionFile) {
     ...
     * 设置：评审及修编说明。
     */
    public PmEnvironmentEvalLj setReviewAndRevisionRemark(String reviewAndRevisionRemark) {
     ...
     * 设置：环评批复时间。
     */
    public PmEnvironmentEvalLj setEiaReplyDate(LocalDate eiaReplyDate) {
     ...
     * 设置：批复文号。
     */
    public PmEnvironmentEvalLj setReplyNo(String replyNo) {
     ...
     * 设置：有效期。
     */
    public PmEnvironmentEvalLj setValidTerm(String validTerm) {
     ...
     * 设置：环评批复文件。
     */
    public PmEnvironmentEvalLj setConservationReplyFile(String conservationReplyFile) {
     ...
     * @return
     */
    public static PmEnvironmentEvalLj newData() {
     ...
     * @return
     */
    public static PmEnvironmentEvalLj insertData() {
     ...
     */
    public static PmEnvironmentEvalLj selectById(String id, List<String> includeCols, List<String> excludeCols) {
     ...
     */
    public static List<PmEnvironmentEvalLj> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmEnvironmentEvalLj> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
     ...
     */
    public static void copyCols(PmEnvironmentEvalLj fromModel, PmEnvironmentEvalLj toModel, List<String> includeCols, List<String> excludeCols) {
