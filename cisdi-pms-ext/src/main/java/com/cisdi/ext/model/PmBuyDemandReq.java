...
public class PmBuyDemandReq {
    ...
    public static class Cols {
         ...
         * 财务岗用户。
         */
        public static final String AD_USER_FIVE_ID = "AD_USER_FIVE_ID";
        /**
         * 备注。
         */
     ...
     * 设置：项目(多值)。
     */
    public PmBuyDemandReq setPmPrjIds(String pmPrjIds) {
     ...
     * 设置：采购事项一级类别。
     */
    public PmBuyDemandReq setBuyMatterTypeId(String buyMatterTypeId) {
     ...
     * 财务岗用户。
     */
    private String adUserFiveId;

    /**
     * 获取：财务岗用户。
     */
    public String getAdUserFiveId() {
        return this.adUserFiveId;
    }

    /**
     * 设置：财务岗用户。
     */
    public PmBuyDemandReq setAdUserFiveId(String adUserFiveId) {
        if (this.adUserFiveId == null && adUserFiveId == null) {
            // 均为null，不做处理。
        } else if (this.adUserFiveId != null && adUserFiveId != null) {
            // 均非null，判定不等，再做处理：
            if (this.adUserFiveId.compareTo(adUserFiveId) != 0) {
                this.adUserFiveId = adUserFiveId;
                if (!this.toUpdateCols.contains("AD_USER_FIVE_ID")) {
                    this.toUpdateCols.add("AD_USER_FIVE_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：长备注4。
     */
    public PmBuyDemandReq setTextRemarkFour(String textRemarkFour) {
     ...
     * 设置：审批意见5。
     */
    public PmBuyDemandReq setApprovalCommentFive(String approvalCommentFive) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmBuyDemandReq selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuyDemandReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuyDemandReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmBuyDemandReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmBuyDemandReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmBuyDemandReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmBuyDemandReq selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmBuyDemandReq fromModel, PmBuyDemandReq toModel) {
