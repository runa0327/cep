...
public class SlRptCalcRec {
    ...
    public static final String ENT_CODE = "SL_RPT_CALC_REC";
    ...
    public static class Cols {
         ...
         * 报表。
         */
        public static final String SL_RPT_ID = "SL_RPT_ID";
        /**
         * 计算成功。
         */
     ...
     */
    public static void copyCols(SlRptCalcRec fromModel, SlRptCalcRec toModel, List<String> includeCols, List<String> excludeCols) {
