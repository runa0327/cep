...
public class BidProcessManage {
     ...
     * 设置：编号。
     */
    public BidProcessManage setIdentifier(String identifier) {
     ...
     * 设置：项目(多值)。
     */
    public BidProcessManage setPmPrjIds(String pmPrjIds) {
     ...
     * 设置：采购事项。
     */
    public BidProcessManage setBuyMatterId(String buyMatterId) {
     ...
     * 设置：采购项目类别。
     */
    public BidProcessManage setBuyPrjTypeId(String buyPrjTypeId) {
     ...
     * 设置：采购方式。
     */
    public BidProcessManage setBuyTypeId(String buyTypeId) {
     ...
     * 设置：金额5(存元)。
     */
    public BidProcessManage setAmtFive(BigDecimal amtFive) {
     ...
     * 设置：用户。
     */
    public BidProcessManage setAdUserId(String adUserId) {
     ...
     * 设置：用户1。
     */
    public BidProcessManage setAdUserOneId(String adUserOneId) {
     ...
     * 设置：日期2。
     */
    public BidProcessManage setDateTwo(LocalDate dateTwo) {
     ...
     * 设置：长备注1。
     */
    public BidProcessManage setTextRemarkOne(String textRemarkOne) {
     ...
     * 设置：金额6(存元)。
     */
    public BidProcessManage setAmtSix(BigDecimal amtSix) {
     ...
     * 设置：金额7(存元)。
     */
    public BidProcessManage setAmtSeven(BigDecimal amtSeven) {
     ...
     * 设置：金额8(存元)。
     */
    public BidProcessManage setAmtEighth(BigDecimal amtEighth) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static BidProcessManage selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<BidProcessManage> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<BidProcessManage> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static BidProcessManage selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<BidProcessManage> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用BidProcessManage.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static BidProcessManage selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(BidProcessManage fromModel, BidProcessManage toModel) {
