...
public class PmInvestEst {
     ...
     * 模型助手。
     */
    private static final ModelHelper<PmInvestEst> modelHelper = new ModelHelper<>("PM_INVEST_EST", new PmInvestEst());
    ...
    public static final String ENT_CODE = "PM_INVEST_EST";
     ...
     * 设置：ID。
     */
    public PmInvestEst setId(String id) {
     ...
     * 设置：版本。
     */
    public PmInvestEst setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmInvestEst setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmInvestEst setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PmInvestEst setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PmInvestEst setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmInvestEst setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmInvestEst setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PmInvestEst setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PmInvestEst setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public PmInvestEst setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmInvestEst setName(String name) {
     ...
     * 设置：备注。
     */
    public PmInvestEst setRemark(String remark) {
     ...
     * 设置：是否模板。
     */
    public PmInvestEst setIsTemplate(Boolean isTemplate) {
     ...
     * 设置：模板适用项目类型。
     */
    public PmInvestEst setTemplateForProjectTypeId(String templateForProjectTypeId) {
     ...
     * 设置：项目。
     */
    public PmInvestEst setPmPrjId(String pmPrjId) {
     ...
     * 设置：投资测算类型。
     */
    public PmInvestEst setInvestEstTypeId(String investEstTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public PmInvestEst setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：批复文号。
     */
    public PmInvestEst setReplyNo(String replyNo) {
     ...
     * 设置：实际批复日期。
     */
    public PmInvestEst setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文件。
     */
    public PmInvestEst setReplyFile(String replyFile) {
     ...
     * 设置：CPMS的UUID。
     */
    public PmInvestEst setCpmsUuid(String cpmsUuid) {
     ...
     * 设置：CPMS的ID。
     */
    public PmInvestEst setCpmsId(String cpmsId) {
     ...
     * @return
     */
    public static PmInvestEst newData() {
        PmInvestEst obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmInvestEst insertData() {
        PmInvestEst obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmInvestEst selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmInvestEst obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmInvestEst> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmInvestEst> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmInvestEst> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmInvestEst> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmInvestEst fromModel, PmInvestEst toModel, List<String> includeCols, List<String> excludeCols) {
