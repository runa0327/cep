 ...
 * 人防规划报建。
 */
public class PmDefensePlanReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmDefensePlanReq> modelHelper = new ModelHelper<>("PM_DEFENSE_PLAN_REQ", new PmDefensePlanReq());
    ...
    public static final String ENT_CODE = "PM_DEFENSE_PLAN_REQ";
     ...
     * 设置：ID。
     */
    public PmDefensePlanReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmDefensePlanReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmDefensePlanReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmDefensePlanReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmDefensePlanReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmDefensePlanReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmDefensePlanReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmDefensePlanReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmDefensePlanReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmDefensePlanReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmDefensePlanReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmDefensePlanReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmDefensePlanReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmDefensePlanReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmDefensePlanReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmDefensePlanReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmDefensePlanReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmDefensePlanReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmDefensePlanReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmDefensePlanReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmDefensePlanReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmDefensePlanReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmDefensePlanReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmDefensePlanReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmDefensePlanReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmDefensePlanReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmDefensePlanReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmDefensePlanReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmDefensePlanReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmDefensePlanReq setPrjSituation(String prjSituation) {
     ...
     * 设置：日期1。
     */
    public PmDefensePlanReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：经办人。
     */
    public PmDefensePlanReq setAgent(String agent) {
     ...
     * 设置：审批附件1。
     */
    public PmDefensePlanReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：日期2。
     */
    public PmDefensePlanReq setDateTwo(LocalDate dateTwo) {
     ...
     * 设置：经办人2。
     */
    public PmDefensePlanReq setAgentTwo(String agentTwo) {
     ...
     * 设置：审批附件2。
     */
    public PmDefensePlanReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：日期3。
     */
    public PmDefensePlanReq setDateThree(LocalDate dateThree) {
     ...
     * 设置：经办人3。
     */
    public PmDefensePlanReq setAgentThree(String agentThree) {
     ...
     * 设置：审批附件3。
     */
    public PmDefensePlanReq setApproveFileIdThree(String approveFileIdThree) {
     ...
     * @return
     */
    public static PmDefensePlanReq newData() {
        PmDefensePlanReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmDefensePlanReq insertData() {
        PmDefensePlanReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmDefensePlanReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmDefensePlanReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmDefensePlanReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmDefensePlanReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmDefensePlanReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmDefensePlanReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmDefensePlanReq fromModel, PmDefensePlanReq toModel, List<String> includeCols, List<String> excludeCols) {
