...
public class PmPrjV {
     ...
     * 设置：总投资（万）。
     */
    public PmPrjV setPrjTotalInvest(Double prjTotalInvest) {
     ...
     * 设置：预计当前进度百分比。
     */
    public PmPrjV setPlanCurrentProPercent(Double planCurrentProPercent) {
     ...
     * 设置：实际当前进度百分比。
     */
    public PmPrjV setActualCurrentProPercent(Double actualCurrentProPercent) {
