 ...
 * 林地调整办理手续。
 */
public class PmWoodlandProcedures {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmWoodlandProcedures> modelHelper = new ModelHelper<>("PM_WOODLAND_PROCEDURES", new PmWoodlandProcedures());
    ...
    public static final String ENT_CODE = "PM_WOODLAND_PROCEDURES";
     ...
     * 设置：ID。
     */
    public PmWoodlandProcedures setId(String id) {
     ...
     * 设置：版本。
     */
    public PmWoodlandProcedures setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmWoodlandProcedures setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmWoodlandProcedures setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmWoodlandProcedures setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmWoodlandProcedures setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmWoodlandProcedures setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmWoodlandProcedures setName(String name) {
     ...
     * 设置：备注。
     */
    public PmWoodlandProcedures setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmWoodlandProcedures setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmWoodlandProcedures setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmWoodlandProcedures setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmWoodlandProcedures setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmWoodlandProcedures setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmWoodlandProcedures setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmWoodlandProcedures setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmWoodlandProcedures setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmWoodlandProcedures setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmWoodlandProcedures setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmWoodlandProcedures setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmWoodlandProcedures setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmWoodlandProcedures setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmWoodlandProcedures setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmWoodlandProcedures setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmWoodlandProcedures setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmWoodlandProcedures setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmWoodlandProcedures setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmWoodlandProcedures setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmWoodlandProcedures setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmWoodlandProcedures setPrjSituation(String prjSituation) {
     ...
     * 设置：是否1。
     */
    public PmWoodlandProcedures setYesNoOne(String yesNoOne) {
     ...
     * 设置：有没有。
     */
    public PmWoodlandProcedures setYesNoTwo(String yesNoTwo) {
     ...
     * 设置：附件。
     */
    public PmWoodlandProcedures setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmWoodlandProcedures setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmWoodlandProcedures setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmWoodlandProcedures setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmWoodlandProcedures setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmWoodlandProcedures setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmWoodlandProcedures setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmWoodlandProcedures setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：完成日期。
     */
    public PmWoodlandProcedures setComplDate(LocalDate complDate) {
     ...
     * 设置：主体材料。
     */
    public PmWoodlandProcedures setSubjectFile(String subjectFile) {
     ...
     * 设置：计划完成日期。
     */
    public PmWoodlandProcedures setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：评审实际完成日期。
     */
    public PmWoodlandProcedures setReviewActualDate(LocalDate reviewActualDate) {
     ...
     * 设置：评审单位负责人。
     */
    public PmWoodlandProcedures setReviewUnitChief(String reviewUnitChief) {
     ...
     * 设置：评审组织单位。
     */
    public PmWoodlandProcedures setReviewOrganizationUnit(String reviewOrganizationUnit) {
     ...
     * 设置：评审单位联系方式。
     */
    public PmWoodlandProcedures setReviewUnitPhone(String reviewUnitPhone) {
     ...
     * 设置：审批附件1。
     */
    public PmWoodlandProcedures setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：审批附件2。
     */
    public PmWoodlandProcedures setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：申请时间。
     */
    public PmWoodlandProcedures setApplyTime(LocalDate applyTime) {
     ...
     * 设置：评审计划完成日期。
     */
    public PmWoodlandProcedures setReviewPlanDate(LocalDate reviewPlanDate) {
     ...
     * 设置：申请人。
     */
    public PmWoodlandProcedures setApplicant(String applicant) {
     ...
     * 设置：审批附件3。
     */
    public PmWoodlandProcedures setApproveFileIdThree(String approveFileIdThree) {
     ...
     * 设置：审批日期1。
     */
    public PmWoodlandProcedures setApprovalDateOne(LocalDate approvalDateOne) {
     ...
     * 设置：保函编号。
     */
    public PmWoodlandProcedures setGuaranteeCode(String guaranteeCode) {
     ...
     * 设置：有效期。
     */
    public PmWoodlandProcedures setValidTerm(String validTerm) {
     ...
     * 设置：审批附件4。
     */
    public PmWoodlandProcedures setApproveFileIdFour(String approveFileIdFour) {
     ...
     * @return
     */
    public static PmWoodlandProcedures newData() {
        PmWoodlandProcedures obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmWoodlandProcedures insertData() {
        PmWoodlandProcedures obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmWoodlandProcedures selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmWoodlandProcedures obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmWoodlandProcedures> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmWoodlandProcedures> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmWoodlandProcedures> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmWoodlandProcedures> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmWoodlandProcedures fromModel, PmWoodlandProcedures toModel, List<String> includeCols, List<String> excludeCols) {
