...
public class PmPrjInvest1 {
     ...
     * 模型助手。
     */
    private static final ModelHelper<PmPrjInvest1> modelHelper = new ModelHelper<>("PM_PRJ_INVEST1", new PmPrjInvest1());
    ...
    public static final String ENT_CODE = "PM_PRJ_INVEST1";
    ...
    public static class Cols {
         ...
         * 可研申请材料。
         */
        public static final String PM_PRJ_FILE = "PM_PRJ_FILE";
        /**
         * 可研申请备注。
         */
     ...
     * 设置：ID。
     */
    public PmPrjInvest1 setId(String id) {
     ...
     * 设置：版本。
     */
    public PmPrjInvest1 setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmPrjInvest1 setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmPrjInvest1 setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmPrjInvest1 setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmPrjInvest1 setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmPrjInvest1 setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmPrjInvest1 setName(String name) {
     ...
     * 设置：备注。
     */
    public PmPrjInvest1 setRemark(String remark) {
     ...
     * 设置：项目。
     */
    public PmPrjInvest1 setPmPrjId(String pmPrjId) {
     ...
     * 设置：锁定流程实例。
     */
    public PmPrjInvest1 setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目编号。
     */
    public PmPrjInvest1 setPrjCode(String prjCode) {
     ...
     * 设置：记录状态。
     */
    public PmPrjInvest1 setStatus(String status) {
     ...
     * 设置：业主单位。
     */
    public PmPrjInvest1 setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目管理模式。
     */
    public PmPrjInvest1 setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建用户。
     */
    public PmPrjInvest1 setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmPrjInvest1 setCrtDeptId(String crtDeptId) {
     ...
     * 设置：建设地点。
     */
    public PmPrjInvest1 setBaseLocationId(String baseLocationId) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmPrjInvest1 setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：创建日期时间。
     */
    public PmPrjInvest1 setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：项目类型。
     */
    public PmPrjInvest1 setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmPrjInvest1 setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmPrjInvest1 setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmPrjInvest1 setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量3。
     */
    public PmPrjInvest1 setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模单位。
     */
    public PmPrjInvest1 setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：项目概况。
     */
    public PmPrjInvest1 setPrjSituation(String prjSituation) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmPrjInvest1 setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmPrjInvest1 setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmPrjInvest1 setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmPrjInvest1 setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmPrjInvest1 setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmPrjInvest1 setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmPrjInvest1 setContactMobileOne(String contactMobileOne) {
     ...
     * 可研申请材料。
     */
    private String pmPrjFile;

    /**
     * 获取：可研申请材料。
     */
    public String getPmPrjFile() {
        return this.pmPrjFile;
    }

    /**
     * 设置：可研申请材料。
     */
    public PmPrjInvest1 setPmPrjFile(String pmPrjFile) {
        if (this.pmPrjFile == null && pmPrjFile == null) {
            // 均为null，不做处理。
        } else if (this.pmPrjFile != null && pmPrjFile != null) {
            // 均非null，判定不等，再做处理：
            if (this.pmPrjFile.compareTo(pmPrjFile) != 0) {
                this.pmPrjFile = pmPrjFile;
                if (!this.toUpdateCols.contains("PM_PRJ_FILE")) {
                    this.toUpdateCols.add("PM_PRJ_FILE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：可研申请备注。
     */
    public PmPrjInvest1 setPmPrjRemark(String pmPrjRemark) {
     ...
     * 设置：评审单位负责人。
     */
    public PmPrjInvest1 setReviewUnitChief(String reviewUnitChief) {
     ...
     * 设置：评审组织单位。
     */
    public PmPrjInvest1 setReviewOrganizationUnit(String reviewOrganizationUnit) {
     ...
     * 设置：评审单位联系方式。
     */
    public PmPrjInvest1 setReviewUnitPhone(String reviewUnitPhone) {
     ...
     * 设置：专家意见文件。
     */
    public PmPrjInvest1 setExpertFile(String expertFile) {
     ...
     * 设置：评审稿文件。
     */
    public PmPrjInvest1 setReviewReportFile(String reviewReportFile) {
     ...
     * 设置：专家评审实际完成日期。
     */
    public PmPrjInvest1 setExpertComplActualDate(LocalDate expertComplActualDate) {
     ...
     * 设置：修编稿文件。
     */
    public PmPrjInvest1 setRevisionFile(String revisionFile) {
     ...
     * 设置：评审报告文件。
     */
    public PmPrjInvest1 setReviewDraftFile(String reviewDraftFile) {
     ...
     * 设置：评审及修编说明。
     */
    public PmPrjInvest1 setReviewAndRevisionRemark(String reviewAndRevisionRemark) {
     ...
     * 设置：成本部意见。
     */
    public PmPrjInvest1 setCostComment(String costComment) {
        if (this.costComment == null && costComment == null) {
            // 均为null，不做处理。
        } else if (this.costComment != null && costComment != null) {
            // 均非null，判定不等，再做处理：
            if (this.costComment.compareTo(costComment) != 0) {
                this.costComment = costComment;
                if (!this.toUpdateCols.contains("COST_COMMENT")) {
                    this.toUpdateCols.add("COST_COMMENT");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：设计部意见。
     */
    public PmPrjInvest1 setDesignComment(String designComment) {
     ...
     * 设置：前期部意见。
     */
    public PmPrjInvest1 setEarlyComment(String earlyComment) {
     ...
     * 设置：总投资（万）。
     */
    public PmPrjInvest1 setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmPrjInvest1 setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：建安费（万）。
     */
    public PmPrjInvest1 setConstructAmt(BigDecimal constructAmt) {
     ...
     * 设置：设备费（万）。
     */
    public PmPrjInvest1 setEquipAmt(BigDecimal equipAmt) {
     ...
     * 设置：科研设备费(万)。
     */
    public PmPrjInvest1 setEquipmentCost(BigDecimal equipmentCost) {
     ...
     * 设置：工程其他费用(万)。
     */
    public PmPrjInvest1 setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：土地拆迁费（万）。
     */
    public PmPrjInvest1 setLandAmt(BigDecimal landAmt) {
     ...
     * 设置：预备费(万)。
     */
    public PmPrjInvest1 setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public PmPrjInvest1 setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：实际批复日期。
     */
    public PmPrjInvest1 setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmPrjInvest1 setReplyNoWr(String replyNoWr) {
     ...
     * 设置：批复文件。
     */
    public PmPrjInvest1 setReplyFile(String replyFile) {
     ...
     * 设置：专家评审计划完成日期。
     */
    public PmPrjInvest1 setExpertComplPlanDate(LocalDate expertComplPlanDate) {
     ...
     * 设置：计划批复日期。
     */
    public PmPrjInvest1 setReplyPlanDate(LocalDate replyPlanDate) {
     ...
     * 设置：是否导入。
     */
    public PmPrjInvest1 setIsOmport(String isOmport) {
     ...
     * @return
     */
    public static PmPrjInvest1 newData() {
        PmPrjInvest1 obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmPrjInvest1 insertData() {
        PmPrjInvest1 obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmPrjInvest1 selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmPrjInvest1 obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmPrjInvest1 selectById(String id) {
     ...
     */
    public static List<PmPrjInvest1> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest1> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest1> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest1> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest1> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest1> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmPrjInvest1 selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest1> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmPrjInvest1.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmPrjInvest1 selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmPrjInvest1 fromModel, PmPrjInvest1 toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmPrjInvest1 fromModel, PmPrjInvest1 toModel) {
