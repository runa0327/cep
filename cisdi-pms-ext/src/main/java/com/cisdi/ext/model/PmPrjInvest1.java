...
public class PmPrjInvest1 {
     ...
     * 设置：占地面积（平方）。
     */
    public PmPrjInvest1 setFloorArea(Double floorArea) {
     ...
     * 设置：建设规模数量。
     */
    public PmPrjInvest1 setConScaleQty(Double conScaleQty) {
     ...
     * 设置：建设规模数量2。
     */
    public PmPrjInvest1 setConScaleQty2(Double conScaleQty2) {
     ...
     * 设置：招采标流程标题。
     */
    public PmPrjInvest1 setBiddingNameId(String biddingNameId) {
     ...
     * 设置：审核状态。
     */
    public PmPrjInvest1 setApprovalStatus(String approvalStatus) {
     ...
     * 设置：委托单位(文本)。
     */
    public PmPrjInvest1 setEntrustingUnitText(String entrustingUnitText) {
     ...
     * 设置：编制单位(文本)。
     */
    public PmPrjInvest1 setAuthorUnitText(String authorUnitText) {
     ...
     * 设置：对方负责人。
     */
    public PmPrjInvest1 setOtherResponsor(String otherResponsor) {
     ...
     * 设置：进场日期。
     */
    public PmPrjInvest1 setInDate(LocalDate inDate) {
        this.inDate = inDate;
        return this;
    }
     ...
     * 设置：服务周期。
     */
    public PmPrjInvest1 setServiceDays(Integer serviceDays) {
     ...
     * 设置：对方联系方式。
     */
    public PmPrjInvest1 setOtherContactPhone(String otherContactPhone) {
     ...
     * 设置：批复文号。
     */
    public PmPrjInvest1 setReplyNo(String replyNo) {
     ...
     * 设置：总投资（万）。
     */
    public PmPrjInvest1 setPrjTotalInvest(Double prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmPrjInvest1 setProjectAmt(Double projectAmt) {
     ...
     * 设置：建安费（万）。
     */
    public PmPrjInvest1 setConstructAmt(Double constructAmt) {
     ...
     * 设置：设备费（万）。
     */
    public PmPrjInvest1 setEquipAmt(Double equipAmt) {
     ...
     * 设置：工程其他费用（万）。
     */
    public PmPrjInvest1 setProjectOtherAmt(Double projectOtherAmt) {
     ...
     * 设置：土地拆迁费（万）。
     */
    public PmPrjInvest1 setLandAmt(Double landAmt) {
     ...
     * 设置：预备费（万）。
     */
    public PmPrjInvest1 setPrepareAmt(Double prepareAmt) {
     ...
     * 设置：建设期利息。
     */
    public PmPrjInvest1 setConstructPeriodInterest(Double constructPeriodInterest) {
