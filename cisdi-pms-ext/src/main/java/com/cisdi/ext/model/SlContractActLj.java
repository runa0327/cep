 ...
 * 合同签订_LJ。
 */
public class SlContractActLj {

    /**
     * 模型助手。
     */
    private static final ModelHelper<SlContractActLj> modelHelper = new ModelHelper<>("SL_CONTRACT_ACT_LJ", new SlContractActLj());

    // 实体常量：
    // <editor-fold>

    public static final String ENT_CODE = "SL_CONTRACT_ACT_LJ";
     ...
     * 设置：ID。
     */
    public SlContractActLj setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * 设置：版本。
     */
    public SlContractActLj setVer(Integer ver) {
        this.ver = ver;
        return this;
    }
     ...
     * 设置：时间戳。
     */
    public SlContractActLj setTs(LocalDateTime ts) {
        this.ts = ts;
        return this;
    }
     ...
     * 设置：是否预设。
     */
    public SlContractActLj setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public SlContractActLj setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public SlContractActLj setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public SlContractActLj setCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * 设置：名称。
     */
    public SlContractActLj setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * 设置：项目。
     */
    public SlContractActLj setPmPrjId(String pmPrjId) {
     ...
     * 设置：锁定流程实例。
     */
    public SlContractActLj setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目编号。
     */
    public SlContractActLj setPrjCode(String prjCode) {
     ...
     * 设置：记录状态。
     */
    public SlContractActLj setStatus(String status) {
        this.status = status;
        return this;
    }
     ...
     * 设置：立项批复文号。
     */
    public SlContractActLj setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：创建用户。
     */
    public SlContractActLj setCrtUserId(String crtUserId) {
     ...
     * 设置：项目概况。
     */
    public SlContractActLj setPrjSituation(String prjSituation) {
     ...
     * 设置：创建部门。
     */
    public SlContractActLj setCrtDeptId(String crtDeptId) {
     ...
     * 设置：创建日期时间。
     */
    public SlContractActLj setCrtDt(LocalDateTime crtDt) {
        this.crtDt = crtDt;
        return this;
    }
     ...
     * 设置：投资来源。
     */
    public SlContractActLj setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public SlContractActLj setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目类型。
     */
    public SlContractActLj setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public SlContractActLj setPrjTotalInvest(Double prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public SlContractActLj setProjectAmt(Double projectAmt) {
     ...
     * 设置：工程其他费用（万）。
     */
    public SlContractActLj setProjectOtherAmt(Double projectOtherAmt) {
     ...
     * 设置：预备费（万）。
     */
    public SlContractActLj setPrepareAmt(Double prepareAmt) {
     ...
     * 设置：建设期利息。
     */
    public SlContractActLj setConstructPeriodInterest(Double constructPeriodInterest) {
     ...
     * 设置：合同名称。
     */
    public SlContractActLj setContractName(String contractName) {
     ...
     * 设置：合同编号。
     */
    public SlContractActLj setContractCode(String contractCode) {
     ...
     * 设置：合同类型。
     */
    public SlContractActLj setContractCategoryId(String contractCategoryId) {
     ...
     * 设置：招采标流程标题。
     */
    public SlContractActLj setBiddingNameId(String biddingNameId) {
     ...
     * 设置：招标类别。
     */
    public SlContractActLj setPmsReleaseWayId(String pmsReleaseWayId) {
     ...
     * 设置：招标控制价发起。
     */
    public SlContractActLj setBidCtlPriceLaunch(Double bidCtlPriceLaunch) {
     ...
     * 设置：采购方式。
     */
    public SlContractActLj setPurchaseType(String purchaseType) {
     ...
     * 设置：中标单位文本。
     */
    public SlContractActLj setWinBidUnitTxt(String winBidUnitTxt) {
     ...
     * 设置：中标待签约额。
     */
    public SlContractActLj setWinningBidsAmount(String winningBidsAmount) {
     ...
     * 设置：预计总天数。
     */
    public SlContractActLj setPlanTotalDays(Integer planTotalDays) {
     ...
     * 设置：合同金额。
     */
    public SlContractActLj setContractPrice(String contractPrice) {
     ...
     * 设置：是否涉及保函。
     */
    public SlContractActLj setIsReferGuarantee(Boolean isReferGuarantee) {
     ...
     * 设置：保函类型。
     */
    public SlContractActLj setGuaranteeLetterTypeId(String guaranteeLetterTypeId) {
     ...
     * 设置：相对方联系人。
     */
    public SlContractActLj setOppoSiteLinkMan(String oppoSiteLinkMan) {
     ...
     * 设置：主体核实日期。
     */
    public SlContractActLj setSubjectVerifyDate(LocalDate subjectVerifyDate) {
     ...
     * 设置：相对方联系方式。
     */
    public SlContractActLj setOppoSiteContact(String oppoSiteContact) {
     ...
     * 设置：主体有效期。
     */
    public SlContractActLj setSubjectTerm(String subjectTerm) {
     ...
     * 设置：是否模板。
     */
    public SlContractActLj setIsTemplate(Boolean isTemplate) {
     ...
     * 设置：主体材料。
     */
    public SlContractActLj setSubjectFile(String subjectFile) {
     ...
     * 设置：附件。
     */
    public SlContractActLj setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public SlContractActLj setRemark(String remark) {
        this.remark = remark;
        return this;
    }
     ...
     * 设置：批复文件。
     */
    public SlContractActLj setReplyFile(String replyFile) {
     ...
     * 设置：审核意见。
     */
    public SlContractActLj setApprovalMessage(String approvalMessage) {
     ...
     * 设置：专家意见文件。
     */
    public SlContractActLj setExpertFile(String expertFile) {
     ...
     * 设置：前期部意见。
     */
    public SlContractActLj setEarlyComment(String earlyComment) {
     ...
     * 设置：修编稿文件。
     */
    public SlContractActLj setRevisionFile(String revisionFile) {
     ...
     * 设置：设计部意见。
     */
    public SlContractActLj setDesignComment(String designComment) {
     ...
     * 设置：评审报告文件。
     */
    public SlContractActLj setReviewDraftFile(String reviewDraftFile) {
     ...
     * 设置：用户意见。
     */
    public SlContractActLj setUserComment(String userComment) {
     ...
     * @return
     */
    public static SlContractActLj newData() {
     ...
     * @return
     */
    public static SlContractActLj insertData() {
     ...
     */
    public static SlContractActLj selectById(String id, List<String> includeCols, List<String> excludeCols) {
     ...
     */
    public static List<SlContractActLj> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<SlContractActLj> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
     ...
     */
    public static void copyCols(SlContractActLj fromModel, SlContractActLj toModel, List<String> includeCols, List<String> excludeCols) {
