 ...
 * 施工组织设计及施工方案。
 */
public class PmBuildOrganPlanReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmBuildOrganPlanReq> modelHelper = new ModelHelper<>("PM_BUILD_ORGAN_PLAN_REQ", new PmBuildOrganPlanReq());
    ...
    public static final String ENT_CODE = "PM_BUILD_ORGAN_PLAN_REQ";
    ...
    public static class Cols {
         ...
         * 施工组织类型。
         */
        public static final String BUILD_ORGAN_ID = "BUILD_ORGAN_ID";
        /**
         * 记录状态。
         */
     ...
     * 设置：ID。
     */
    public PmBuildOrganPlanReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmBuildOrganPlanReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmBuildOrganPlanReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmBuildOrganPlanReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmBuildOrganPlanReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmBuildOrganPlanReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmBuildOrganPlanReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmBuildOrganPlanReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmBuildOrganPlanReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmBuildOrganPlanReq setLkWfInstId(String lkWfInstId) {
     ...
     * 施工组织类型。
     */
    private String buildOrganId;

    /**
     * 获取：施工组织类型。
     */
    public String getBuildOrganId() {
        return this.buildOrganId;
    }

    /**
     * 设置：施工组织类型。
     */
    public PmBuildOrganPlanReq setBuildOrganId(String buildOrganId) {
        if (this.buildOrganId == null && buildOrganId == null) {
            // 均为null，不做处理。
        } else if (this.buildOrganId != null && buildOrganId != null) {
            // 均非null，判定不等，再做处理：
            if (this.buildOrganId.compareTo(buildOrganId) != 0) {
                this.buildOrganId = buildOrganId;
                if (!this.toUpdateCols.contains("BUILD_ORGAN_ID")) {
                    this.toUpdateCols.add("BUILD_ORGAN_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：记录状态。
     */
    public PmBuildOrganPlanReq setStatus(String status) {
     ...
     * 设置：完整名称。
     */
    public PmBuildOrganPlanReq setFullName(String fullName) {
     ...
     * 设置：项目。
     */
    public PmBuildOrganPlanReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：创建用户。
     */
    public PmBuildOrganPlanReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmBuildOrganPlanReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目编号。
     */
    public PmBuildOrganPlanReq setPrjCode(String prjCode) {
     ...
     * 设置：项目管理模式。
     */
    public PmBuildOrganPlanReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建日期时间。
     */
    public PmBuildOrganPlanReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：立项批复文号。
     */
    public PmBuildOrganPlanReq setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：投资来源。
     */
    public PmBuildOrganPlanReq setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public PmBuildOrganPlanReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目类型。
     */
    public PmBuildOrganPlanReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public PmBuildOrganPlanReq setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmBuildOrganPlanReq setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：工程其他费用(万)。
     */
    public PmBuildOrganPlanReq setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：预备费(万)。
     */
    public PmBuildOrganPlanReq setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public PmBuildOrganPlanReq setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：项目概况。
     */
    public PmBuildOrganPlanReq setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public PmBuildOrganPlanReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：是否导入的记录。
     */
    public PmBuildOrganPlanReq setIsImport(Boolean isImport) {
     ...
     * @return
     */
    public static PmBuildOrganPlanReq newData() {
        PmBuildOrganPlanReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmBuildOrganPlanReq insertData() {
        PmBuildOrganPlanReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmBuildOrganPlanReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmBuildOrganPlanReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmBuildOrganPlanReq selectById(String id) {
     ...
     */
    public static List<PmBuildOrganPlanReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmBuildOrganPlanReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuildOrganPlanReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuildOrganPlanReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmBuildOrganPlanReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuildOrganPlanReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmBuildOrganPlanReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmBuildOrganPlanReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmBuildOrganPlanReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmBuildOrganPlanReq selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmBuildOrganPlanReq fromModel, PmBuildOrganPlanReq toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmBuildOrganPlanReq fromModel, PmBuildOrganPlanReq toModel) {
