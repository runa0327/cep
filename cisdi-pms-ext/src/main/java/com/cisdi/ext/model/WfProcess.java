...
public class WfProcess {
    ...
    public static final String ENT_CODE = "WF_PROCESS";
    ...
    public static class Cols {
         ...
         * 可启动的实体视图列表。
         */
        public static final String STARTABLE_SEV_IDS = "STARTABLE_SEV_IDS";
        /**
         * 可启动逻辑。
         */
        public static final String STARTABLE_LOGIC = "STARTABLE_LOGIC";
        /**
         * 序号。
         */
         ...
         * 流程类型。
         */
        public static final String WF_PROCESS_TYPE_ID = "WF_PROCESS_TYPE_ID";
        /**
         * 启用回调。
         */
     ...
     * 获取：可启动的实体视图列表。
     */
    public String getStartableSevIds() {
        return this.startableSevIds;
    }
     ...
     * 获取：可启动逻辑。
     */
    public String getStartableLogic() {
        return this.startableLogic;
    }
     ...
     * 获取：流程类型。
     */
    public String getWfProcessTypeId() {
        return this.wfProcessTypeId;
    }
