 ...
 * 交通安全评价。
 */
public class PmTrafficSafetyReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmTrafficSafetyReq> modelHelper = new ModelHelper<>("PM_TRAFFIC_SAFETY_REQ", new PmTrafficSafetyReq());
    ...
    public static final String ENT_CODE = "PM_TRAFFIC_SAFETY_REQ";
     ...
     * 设置：ID。
     */
    public PmTrafficSafetyReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmTrafficSafetyReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmTrafficSafetyReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmTrafficSafetyReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmTrafficSafetyReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmTrafficSafetyReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmTrafficSafetyReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmTrafficSafetyReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmTrafficSafetyReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmTrafficSafetyReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmTrafficSafetyReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmTrafficSafetyReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmTrafficSafetyReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmTrafficSafetyReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmTrafficSafetyReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmTrafficSafetyReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmTrafficSafetyReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmTrafficSafetyReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmTrafficSafetyReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmTrafficSafetyReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmTrafficSafetyReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmTrafficSafetyReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmTrafficSafetyReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmTrafficSafetyReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmTrafficSafetyReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmTrafficSafetyReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmTrafficSafetyReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmTrafficSafetyReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmTrafficSafetyReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmTrafficSafetyReq setPrjSituation(String prjSituation) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmTrafficSafetyReq setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmTrafficSafetyReq setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmTrafficSafetyReq setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmTrafficSafetyReq setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmTrafficSafetyReq setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmTrafficSafetyReq setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmTrafficSafetyReq setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：评审计划完成日期。
     */
    public PmTrafficSafetyReq setReviewPlanDate(LocalDate reviewPlanDate) {
     ...
     * 设置：附件1。
     */
    public PmTrafficSafetyReq setFileIdOne(String fileIdOne) {
     ...
     * 设置：评审实际完成日期。
     */
    public PmTrafficSafetyReq setReviewActualDate(LocalDate reviewActualDate) {
     ...
     * 设置：评审单位负责人。
     */
    public PmTrafficSafetyReq setReviewUnitChief(String reviewUnitChief) {
     ...
     * 设置：评审单位。
     */
    public PmTrafficSafetyReq setReviewUnit(String reviewUnit) {
     ...
     * 设置：评审单位联系方式。
     */
    public PmTrafficSafetyReq setReviewUnitPhone(String reviewUnitPhone) {
     ...
     * 设置：附件2。
     */
    public PmTrafficSafetyReq setFileIdTwo(String fileIdTwo) {
     ...
     * 设置：备案日期。
     */
    public PmTrafficSafetyReq setKeepRecordDate(LocalDate keepRecordDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmTrafficSafetyReq setReplyNoWr(String replyNoWr) {
     ...
     * 设置：有效期。
     */
    public PmTrafficSafetyReq setValidTerm(String validTerm) {
     ...
     * 设置：审批附件2。
     */
    public PmTrafficSafetyReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * @return
     */
    public static PmTrafficSafetyReq newData() {
        PmTrafficSafetyReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmTrafficSafetyReq insertData() {
        PmTrafficSafetyReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmTrafficSafetyReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmTrafficSafetyReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmTrafficSafetyReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmTrafficSafetyReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmTrafficSafetyReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmTrafficSafetyReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmTrafficSafetyReq fromModel, PmTrafficSafetyReq toModel, List<String> includeCols, List<String> excludeCols) {
