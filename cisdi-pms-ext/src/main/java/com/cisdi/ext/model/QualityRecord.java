...
public class QualityRecord {
     ...
     * 模型助手。
     */
    private static final ModelHelper<QualityRecord> modelHelper = new ModelHelper<>("QUALITY_RECORD", new QualityRecord());
    ...
    public static final String ENT_CODE = "QUALITY_RECORD";
     ...
     * 设置：ID。
     */
    public QualityRecord setId(String id) {
     ...
     * 设置：版本。
     */
    public QualityRecord setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public QualityRecord setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public QualityRecord setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public QualityRecord setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public QualityRecord setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public QualityRecord setCode(String code) {
     ...
     * 设置：名称。
     */
    public QualityRecord setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public QualityRecord setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public QualityRecord setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public QualityRecord setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public QualityRecord setPrjCode(String prjCode) {
     ...
     * 设置：备注1。
     */
    public QualityRecord setRemarkOne(String remarkOne) {
     ...
     * 设置：创建用户。
     */
    public QualityRecord setCrtUserId(String crtUserId) {
     ...
     * 设置：业主单位。
     */
    public QualityRecord setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建部门。
     */
    public QualityRecord setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public QualityRecord setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建日期时间。
     */
    public QualityRecord setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：建设地点。
     */
    public QualityRecord setBaseLocationId(String baseLocationId) {
     ...
     * 设置：占地面积(平方米)。
     */
    public QualityRecord setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public QualityRecord setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public QualityRecord setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public QualityRecord setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public QualityRecord setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public QualityRecord setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public QualityRecord setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public QualityRecord setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public QualityRecord setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public QualityRecord setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public QualityRecord setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public QualityRecord setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public QualityRecord setRemark(String remark) {
     ...
     * @return
     */
    public static QualityRecord newData() {
        QualityRecord obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static QualityRecord insertData() {
        QualityRecord obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static QualityRecord selectById(String id, List<String> includeCols, List<String> excludeCols) {
        QualityRecord obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<QualityRecord> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<QualityRecord> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<QualityRecord> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<QualityRecord> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(QualityRecord fromModel, QualityRecord toModel, List<String> includeCols, List<String> excludeCols) {
