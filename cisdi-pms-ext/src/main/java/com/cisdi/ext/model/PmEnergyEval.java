...
public class PmEnergyEval {
    ...
    public static final String ENT_CODE = "PM_ENERGY_EVAL";
     ...
     */
    public static void copyCols(PmEnergyEval fromModel, PmEnergyEval toModel, List<String> includeCols, List<String> excludeCols) {
