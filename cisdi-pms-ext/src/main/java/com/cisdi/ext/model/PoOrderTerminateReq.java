...
public class PoOrderTerminateReq {
    ...
    public static class Cols {
         ...
         * 采购事项一级类别。
         */
        public static final String BUY_MATTER_TYPE_ID = "BUY_MATTER_TYPE_ID";
        /**
         * 采购事项。
         */
     ...
     * 设置：业主单位1。
     */
    public PoOrderTerminateReq setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：项目(多值)。
     */
    public PoOrderTerminateReq setPmPrjIds(String pmPrjIds) {
     ...
     * 采购合同签订申请。
     */
    private String poOrderReqId;

    /**
     * 获取：采购合同签订申请。
     */
    public String getPoOrderReqId() {
        return this.poOrderReqId;
    }

    /**
     * 设置：采购合同签订申请。
     */
    public PoOrderTerminateReq setPoOrderReqId(String poOrderReqId) {
        if (this.poOrderReqId == null && poOrderReqId == null) {
            // 均为null，不做处理。
        } else if (this.poOrderReqId != null && poOrderReqId != null) {
            // 均非null，判定不等，再做处理：
            if (this.poOrderReqId.compareTo(poOrderReqId) != 0) {
                this.poOrderReqId = poOrderReqId;
                if (!this.toUpdateCols.contains("PO_ORDER_REQ_ID")) {
                    this.toUpdateCols.add("PO_ORDER_REQ_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：合同名称。
     */
    public PoOrderTerminateReq setContractName(String contractName) {
     ...
     * 采购事项一级类别。
     */
    private String buyMatterTypeId;

    /**
     * 获取：采购事项一级类别。
     */
    public String getBuyMatterTypeId() {
        return this.buyMatterTypeId;
    }

    /**
     * 设置：采购事项一级类别。
     */
    public PoOrderTerminateReq setBuyMatterTypeId(String buyMatterTypeId) {
        if (this.buyMatterTypeId == null && buyMatterTypeId == null) {
            // 均为null，不做处理。
        } else if (this.buyMatterTypeId != null && buyMatterTypeId != null) {
            // 均非null，判定不等，再做处理：
            if (this.buyMatterTypeId.compareTo(buyMatterTypeId) != 0) {
                this.buyMatterTypeId = buyMatterTypeId;
                if (!this.toUpdateCols.contains("BUY_MATTER_TYPE_ID")) {
                    this.toUpdateCols.add("BUY_MATTER_TYPE_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：采购事项。
     */
    public PoOrderTerminateReq setBuyMatterId(String buyMatterId) {
     ...
     * 设置：金额1。
     */
    public PoOrderTerminateReq setAmtOne(BigDecimal amtOne) {
     ...
     * 设置：金额2。
     */
    public PoOrderTerminateReq setAmtTwo(BigDecimal amtTwo) {
     ...
     * 设置：金额3。
     */
    public PoOrderTerminateReq setAmtThree(BigDecimal amtThree) {
     ...
     * 设置：金额4。
     */
    public PoOrderTerminateReq setAmtFour(BigDecimal amtFour) {
     ...
     * 设置：用户。
     */
    public PoOrderTerminateReq setAdUserId(String adUserId) {
     ...
     * 设置：联系人电话1。
     */
    public PoOrderTerminateReq setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：采购合同变更申请。
     */
    public PoOrderTerminateReq setPoOrderChangeReqId(String poOrderChangeReqId) {
     ...
     * 设置：备注2。
     */
    public PoOrderTerminateReq setRemarkTwo(String remarkTwo) {
     ...
     * 设置：附件8。
     */
    public PoOrderTerminateReq setFileIdEighth(String fileIdEighth) {
     ...
     * 设置：附件9。
     */
    public PoOrderTerminateReq setFileIdNinth(String fileIdNinth) {
     ...
     * 设置：附件7。
     */
    public PoOrderTerminateReq setFileIdSeven(String fileIdSeven) {
     ...
     * 设置：附件6。
     */
    public PoOrderTerminateReq setFileIdSix(String fileIdSix) {
     ...
     * 设置：审批意见2。
     */
    public PoOrderTerminateReq setApprovalCommentTwo(String approvalCommentTwo) {
     ...
     * 设置：附件2。
     */
    public PoOrderTerminateReq setFileIdTwo(String fileIdTwo) {
     ...
     * 设置：审批意见3。
     */
    public PoOrderTerminateReq setApprovalCommentThree(String approvalCommentThree) {
     ...
     * 设置：附件3。
     */
    public PoOrderTerminateReq setFileIdThree(String fileIdThree) {
     ...
     * 设置：是否1。
     */
    public PoOrderTerminateReq setYesNoOne(String yesNoOne) {
     ...
     * 设置：备注1。
     */
    public PoOrderTerminateReq setRemarkOne(String remarkOne) {
     ...
     * 设置：附件4。
     */
    public PoOrderTerminateReq setFileIdFour(String fileIdFour) {
     ...
     * 设置：签订日期。
     */
    public PoOrderTerminateReq setSignDate(LocalDate signDate) {
     ...
     * 设置：日期5。
     */
    public PoOrderTerminateReq setDateFive(LocalDate dateFive) {
     ...
     * 设置：附件5。
     */
    public PoOrderTerminateReq setFileIdFive(String fileIdFive) {
     ...
     * 设置：项目来源类型。
     */
    public PoOrderTerminateReq setProjectSourceTypeId(String projectSourceTypeId) {
     ...
     * 设置：项目名称。
     */
    public PoOrderTerminateReq setProjectNameWr(String projectNameWr) {
     ...
     * 设置：批复文号。
     */
    public PoOrderTerminateReq setReplyNo(String replyNo) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PoOrderTerminateReq selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PoOrderTerminateReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PoOrderTerminateReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PoOrderTerminateReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PoOrderTerminateReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PoOrderTerminateReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PoOrderTerminateReq selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PoOrderTerminateReq fromModel, PoOrderTerminateReq toModel) {
