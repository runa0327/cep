 ...
 * 农转用手续办理。
 */
public class PmFarmingProcedures {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmFarmingProcedures> modelHelper = new ModelHelper<>("PM_FARMING_PROCEDURES", new PmFarmingProcedures());
    ...
    public static final String ENT_CODE = "PM_FARMING_PROCEDURES";
     ...
     * 设置：ID。
     */
    public PmFarmingProcedures setId(String id) {
     ...
     * 设置：版本。
     */
    public PmFarmingProcedures setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmFarmingProcedures setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmFarmingProcedures setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmFarmingProcedures setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmFarmingProcedures setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmFarmingProcedures setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmFarmingProcedures setName(String name) {
     ...
     * 设置：备注。
     */
    public PmFarmingProcedures setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmFarmingProcedures setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmFarmingProcedures setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmFarmingProcedures setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmFarmingProcedures setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmFarmingProcedures setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmFarmingProcedures setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmFarmingProcedures setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmFarmingProcedures setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmFarmingProcedures setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmFarmingProcedures setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmFarmingProcedures setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmFarmingProcedures setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmFarmingProcedures setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmFarmingProcedures setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmFarmingProcedures setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmFarmingProcedures setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmFarmingProcedures setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmFarmingProcedures setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmFarmingProcedures setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmFarmingProcedures setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmFarmingProcedures setPrjSituation(String prjSituation) {
     ...
     * 设置：是否1。
     */
    public PmFarmingProcedures setYesNoOne(String yesNoOne) {
     ...
     * 设置：附件。
     */
    public PmFarmingProcedures setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmFarmingProcedures setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmFarmingProcedures setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmFarmingProcedures setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmFarmingProcedures setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmFarmingProcedures setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmFarmingProcedures setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmFarmingProcedures setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：完成日期。
     */
    public PmFarmingProcedures setComplDate(LocalDate complDate) {
     ...
     * 设置：用户1。
     */
    public PmFarmingProcedures setAdUserOneId(String adUserOneId) {
     ...
     * 设置：主体材料。
     */
    public PmFarmingProcedures setSubjectFile(String subjectFile) {
     ...
     * 设置：有没有。
     */
    public PmFarmingProcedures setYesNoTwo(String yesNoTwo) {
     ...
     * 设置：日期1。
     */
    public PmFarmingProcedures setDateOne(LocalDate dateOne) {
     ...
     * 设置：实际批复日期。
     */
    public PmFarmingProcedures setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmFarmingProcedures setReplyNoWr(String replyNoWr) {
     ...
     * 设置：有效期。
     */
    public PmFarmingProcedures setValidTerm(String validTerm) {
     ...
     * 设置：审批附件1。
     */
    public PmFarmingProcedures setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：是否导入的记录。
     */
    public PmFarmingProcedures setIsImport(Boolean isImport) {
     ...
     * @return
     */
    public static PmFarmingProcedures newData() {
        PmFarmingProcedures obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmFarmingProcedures insertData() {
        PmFarmingProcedures obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmFarmingProcedures selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmFarmingProcedures obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmFarmingProcedures selectById(String id) {
     ...
     */
    public static List<PmFarmingProcedures> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmFarmingProcedures> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmFarmingProcedures> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmFarmingProcedures> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmFarmingProcedures> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmFarmingProcedures> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmFarmingProcedures selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmFarmingProcedures> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmFarmingProcedures.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmFarmingProcedures selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmFarmingProcedures fromModel, PmFarmingProcedures toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmFarmingProcedures fromModel, PmFarmingProcedures toModel) {
