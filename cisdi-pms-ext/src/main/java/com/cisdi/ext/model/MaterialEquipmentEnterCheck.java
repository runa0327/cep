 ...
 * 工程材料设备进场验收。
 */
public class MaterialEquipmentEnterCheck {

    /**
     * 模型助手。
     */
    private static final ModelHelper<MaterialEquipmentEnterCheck> modelHelper = new ModelHelper<>("MATERIAL_EQUIPMENT_ENTER_CHECK", new MaterialEquipmentEnterCheck());
    ...
    public static final String ENT_CODE = "MATERIAL_EQUIPMENT_ENTER_CHECK";
     ...
     * 设置：ID。
     */
    public MaterialEquipmentEnterCheck setId(String id) {
     ...
     * 设置：版本。
     */
    public MaterialEquipmentEnterCheck setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public MaterialEquipmentEnterCheck setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public MaterialEquipmentEnterCheck setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public MaterialEquipmentEnterCheck setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public MaterialEquipmentEnterCheck setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public MaterialEquipmentEnterCheck setCode(String code) {
     ...
     * 设置：名称。
     */
    public MaterialEquipmentEnterCheck setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public MaterialEquipmentEnterCheck setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public MaterialEquipmentEnterCheck setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public MaterialEquipmentEnterCheck setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public MaterialEquipmentEnterCheck setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public MaterialEquipmentEnterCheck setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public MaterialEquipmentEnterCheck setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public MaterialEquipmentEnterCheck setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public MaterialEquipmentEnterCheck setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public MaterialEquipmentEnterCheck setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public MaterialEquipmentEnterCheck setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public MaterialEquipmentEnterCheck setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public MaterialEquipmentEnterCheck setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public MaterialEquipmentEnterCheck setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public MaterialEquipmentEnterCheck setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public MaterialEquipmentEnterCheck setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public MaterialEquipmentEnterCheck setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public MaterialEquipmentEnterCheck setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public MaterialEquipmentEnterCheck setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public MaterialEquipmentEnterCheck setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public MaterialEquipmentEnterCheck setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public MaterialEquipmentEnterCheck setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public MaterialEquipmentEnterCheck setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public MaterialEquipmentEnterCheck setRemark(String remark) {
     ...
     * @return
     */
    public static MaterialEquipmentEnterCheck newData() {
        MaterialEquipmentEnterCheck obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static MaterialEquipmentEnterCheck insertData() {
        MaterialEquipmentEnterCheck obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static MaterialEquipmentEnterCheck selectById(String id, List<String> includeCols, List<String> excludeCols) {
        MaterialEquipmentEnterCheck obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<MaterialEquipmentEnterCheck> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<MaterialEquipmentEnterCheck> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<MaterialEquipmentEnterCheck> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<MaterialEquipmentEnterCheck> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(MaterialEquipmentEnterCheck fromModel, MaterialEquipmentEnterCheck toModel, List<String> includeCols, List<String> excludeCols) {
