 ...
 * 投标明细。
 */
public class PmBidDetail {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmBidDetail> modelHelper = new ModelHelper<>("PM_BID_DETAIL", new PmBidDetail());
    ...
    public static final String ENT_CODE = "PM_BID_DETAIL";
     ...
     * 设置：ID。
     */
    public PmBidDetail setId(String id) {
     ...
     * 设置：版本。
     */
    public PmBidDetail setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmBidDetail setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmBidDetail setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PmBidDetail setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PmBidDetail setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmBidDetail setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmBidDetail setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PmBidDetail setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PmBidDetail setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：招标单位。
     */
    public PmBidDetail setBidUnit(String bidUnit) {
     ...
     * 设置：投标报价。
     */
    public PmBidDetail setTenderOffer(BigDecimal tenderOffer) {
     ...
     * 设置：联系人手机。
     */
    public PmBidDetail setContactMobile(String contactMobile) {
     ...
     * 设置：联系人名称。
     */
    public PmBidDetail setContactName(String contactName) {
     ...
     * 设置：联系人身份证备案。
     */
    public PmBidDetail setContactIdcardRecord(String contactIdcardRecord) {
     ...
     * 设置：招采标流程标题。
     */
    public PmBidDetail setBiddingNameId(String biddingNameId) {
     ...
     * 设置：代码。
     */
    public PmBidDetail setCode(String code) {
     ...
     * 设置：备注。
     */
    public PmBidDetail setRemark(String remark) {
     ...
     * 设置：名称。
     */
    public PmBidDetail setName(String name) {
     ...
     * @return
     */
    public static PmBidDetail newData() {
        PmBidDetail obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmBidDetail insertData() {
        PmBidDetail obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmBidDetail selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmBidDetail obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmBidDetail> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmBidDetail> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBidDetail> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmBidDetail> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmBidDetail fromModel, PmBidDetail toModel, List<String> includeCols, List<String> excludeCols) {
