...
public class AdPublishRecord {
    ...
    public static final String ENT_CODE = "AD_PUBLISH_RECORD";
     ...
     */
    public static void copyCols(AdPublishRecord fromModel, AdPublishRecord toModel, List<String> includeCols, List<String> excludeCols) {
