 ...
 * 竣工预验收。
 */
public class CompletionPreAcceptance {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CompletionPreAcceptance> modelHelper = new ModelHelper<>("COMPLETION_PRE_ACCEPTANCE", new CompletionPreAcceptance());
    ...
    public static final String ENT_CODE = "COMPLETION_PRE_ACCEPTANCE";
    ...
    public static class Cols {
         ...
         * 竣工类型。
         */
        public static final String COMPLETION_TYPE_ID = "COMPLETION_TYPE_ID";
        /**
         * 记录状态。
         */
         ...
         * 预验收时间。
         */
        public static final String PRE_ACCEPTION_DATE = "PRE_ACCEPTION_DATE";
        /**
         * 项目。
         */
     ...
     * 设置：ID。
     */
    public CompletionPreAcceptance setId(String id) {
     ...
     * 设置：版本。
     */
    public CompletionPreAcceptance setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public CompletionPreAcceptance setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public CompletionPreAcceptance setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public CompletionPreAcceptance setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public CompletionPreAcceptance setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public CompletionPreAcceptance setCode(String code) {
     ...
     * 设置：名称。
     */
    public CompletionPreAcceptance setName(String name) {
     ...
     * 设置：备注。
     */
    public CompletionPreAcceptance setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public CompletionPreAcceptance setLkWfInstId(String lkWfInstId) {
    ...
    public String getCompletionTypeId() {
        return this.completionTypeId;
    }

    /**
     * 设置：竣工类型。
     */
    public CompletionPreAcceptance setCompletionTypeId(String completionTypeId) {
        if (this.completionTypeId == null && completionTypeId == null) {
            // 均为null，不做处理。
        } else if (this.completionTypeId != null && completionTypeId != null) {
            // 均非null，判定不等，再做处理：
            if (this.completionTypeId.compareTo(completionTypeId) != 0) {
                this.completionTypeId = completionTypeId;
                if (!this.toUpdateCols.contains("COMPLETION_TYPE_ID")) {
                    this.toUpdateCols.add("COMPLETION_TYPE_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：记录状态。
     */
    public CompletionPreAcceptance setStatus(String status) {
     ...
     * 设置：完成日期。
     */
    public CompletionPreAcceptance setComplDate(LocalDate complDate) {
     ...
     * 预验收时间。
     */
    private LocalDate preAcceptionDate;

    /**
     * 获取：预验收时间。
     */
    public LocalDate getPreAcceptionDate() {
        return this.preAcceptionDate;
    }

    /**
     * 设置：预验收时间。
     */
    public CompletionPreAcceptance setPreAcceptionDate(LocalDate preAcceptionDate) {
        if (this.preAcceptionDate == null && preAcceptionDate == null) {
            // 均为null，不做处理。
        } else if (this.preAcceptionDate != null && preAcceptionDate != null) {
            // 均非null，判定不等，再做处理：
            if (this.preAcceptionDate.compareTo(preAcceptionDate) != 0) {
                this.preAcceptionDate = preAcceptionDate;
                if (!this.toUpdateCols.contains("PRE_ACCEPTION_DATE")) {
                    this.toUpdateCols.add("PRE_ACCEPTION_DATE");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：项目。
     */
    public CompletionPreAcceptance setPmPrjId(String pmPrjId) {
     ...
     * 设置：创建用户。
     */
    public CompletionPreAcceptance setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public CompletionPreAcceptance setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目编号。
     */
    public CompletionPreAcceptance setPrjCode(String prjCode) {
     ...
     * 设置：项目管理模式。
     */
    public CompletionPreAcceptance setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建日期时间。
     */
    public CompletionPreAcceptance setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：立项批复文号。
     */
    public CompletionPreAcceptance setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：投资来源。
     */
    public CompletionPreAcceptance setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public CompletionPreAcceptance setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目类型。
     */
    public CompletionPreAcceptance setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public CompletionPreAcceptance setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public CompletionPreAcceptance setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：工程其他费用（万）。
     */
    public CompletionPreAcceptance setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：预备费（万）。
     */
    public CompletionPreAcceptance setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public CompletionPreAcceptance setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：项目概况。
     */
    public CompletionPreAcceptance setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public CompletionPreAcceptance setAttFileGroupId(String attFileGroupId) {
     ...
     * @return
     */
    public static CompletionPreAcceptance newData() {
        CompletionPreAcceptance obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CompletionPreAcceptance insertData() {
        CompletionPreAcceptance obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CompletionPreAcceptance selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CompletionPreAcceptance obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<CompletionPreAcceptance> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CompletionPreAcceptance> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<CompletionPreAcceptance> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CompletionPreAcceptance> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(CompletionPreAcceptance fromModel, CompletionPreAcceptance toModel, List<String> includeCols, List<String> excludeCols) {
