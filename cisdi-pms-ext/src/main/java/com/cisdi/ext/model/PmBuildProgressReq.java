 ...
 * 施工进度计划。
 */
public class PmBuildProgressReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmBuildProgressReq> modelHelper = new ModelHelper<>("PM_BUILD_PROGRESS_REQ", new PmBuildProgressReq());
    ...
    public static final String ENT_CODE = "PM_BUILD_PROGRESS_REQ";
    ...
    public static class Cols {
         ...
         * 施工进度计划类型。
         */
        public static final String BUILD_TYPE_ID = "BUILD_TYPE_ID";
        /**
         * 记录状态。
         */
     ...
     * 设置：ID。
     */
    public PmBuildProgressReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmBuildProgressReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmBuildProgressReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmBuildProgressReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmBuildProgressReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmBuildProgressReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmBuildProgressReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmBuildProgressReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmBuildProgressReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmBuildProgressReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：施工进度计划类型。
     */
    public PmBuildProgressReq setBuildTypeId(String buildTypeId) {
        if (this.buildTypeId == null && buildTypeId == null) {
            // 均为null，不做处理。
        } else if (this.buildTypeId != null && buildTypeId != null) {
            // 均非null，判定不等，再做处理：
            if (this.buildTypeId.compareTo(buildTypeId) != 0) {
                this.buildTypeId = buildTypeId;
                if (!this.toUpdateCols.contains("BUILD_TYPE_ID")) {
                    this.toUpdateCols.add("BUILD_TYPE_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：记录状态。
     */
    public PmBuildProgressReq setStatus(String status) {
     ...
     * 设置：完整名称。
     */
    public PmBuildProgressReq setFullName(String fullName) {
     ...
     * 设置：项目。
     */
    public PmBuildProgressReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：创建用户。
     */
    public PmBuildProgressReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmBuildProgressReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目编号。
     */
    public PmBuildProgressReq setPrjCode(String prjCode) {
     ...
     * 设置：项目管理模式。
     */
    public PmBuildProgressReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：创建日期时间。
     */
    public PmBuildProgressReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：项目类型。
     */
    public PmBuildProgressReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public PmBuildProgressReq setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmBuildProgressReq setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：项目概况。
     */
    public PmBuildProgressReq setPrjSituation(String prjSituation) {
     ...
     * 设置：预计开始日期。
     */
    public PmBuildProgressReq setPlanStartDate(LocalDate planStartDate) {
     ...
     * 设置：计划完成日期。
     */
    public PmBuildProgressReq setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：合同工期。
     */
    public PmBuildProgressReq setContractDays(Integer contractDays) {
        if (this.contractDays == null && contractDays == null) {
            // 均为null，不做处理。
        } else if (this.contractDays != null && contractDays != null) {
            // 均非null，判定不等，再做处理：
            if (this.contractDays.compareTo(contractDays) != 0) {
                this.contractDays = contractDays;
                if (!this.toUpdateCols.contains("CONTRACT_DAYS")) {
                    this.toUpdateCols.add("CONTRACT_DAYS");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：附件。
     */
    public PmBuildProgressReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public PmBuildProgressReq setRemarkShort(String remarkShort) {
     ...
     * @return
     */
    public static PmBuildProgressReq newData() {
        PmBuildProgressReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmBuildProgressReq insertData() {
        PmBuildProgressReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmBuildProgressReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmBuildProgressReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmBuildProgressReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmBuildProgressReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmBuildProgressReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmBuildProgressReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmBuildProgressReq fromModel, PmBuildProgressReq toModel, List<String> includeCols, List<String> excludeCols) {
