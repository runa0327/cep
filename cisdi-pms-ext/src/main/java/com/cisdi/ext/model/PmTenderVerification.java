 ...
 * 招标核准。
 */
public class PmTenderVerification {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmTenderVerification> modelHelper = new ModelHelper<>("PM_TENDER_VERIFICATION", new PmTenderVerification());
    ...
    public static final String ENT_CODE = "PM_TENDER_VERIFICATION";
     ...
     * 设置：ID。
     */
    public PmTenderVerification setId(String id) {
     ...
     * 设置：版本。
     */
    public PmTenderVerification setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmTenderVerification setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmTenderVerification setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmTenderVerification setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmTenderVerification setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmTenderVerification setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmTenderVerification setName(String name) {
     ...
     * 设置：备注。
     */
    public PmTenderVerification setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmTenderVerification setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmTenderVerification setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmTenderVerification setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmTenderVerification setPrjCode(String prjCode) {
     ...
     * 设置：创建用户。
     */
    public PmTenderVerification setCrtUserId(String crtUserId) {
     ...
     * 设置：立项批复文号。
     */
    public PmTenderVerification setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：创建部门。
     */
    public PmTenderVerification setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目类型。
     */
    public PmTenderVerification setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建日期时间。
     */
    public PmTenderVerification setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：投资来源。
     */
    public PmTenderVerification setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public PmTenderVerification setCustomerUnit(String customerUnit) {
     ...
     * 设置：项目概况。
     */
    public PmTenderVerification setPrjSituation(String prjSituation) {
     ...
     * 设置：EPC类型。
     */
    public PmTenderVerification setBaseEpcId(String baseEpcId) {
     ...
     * 设置：审批附件1。
     */
    public PmTenderVerification setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：实际批复日期。
     */
    public PmTenderVerification setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：审批附件2。
     */
    public PmTenderVerification setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * @return
     */
    public static PmTenderVerification newData() {
        PmTenderVerification obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmTenderVerification insertData() {
        PmTenderVerification obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmTenderVerification selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmTenderVerification obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmTenderVerification> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmTenderVerification> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmTenderVerification> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmTenderVerification> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmTenderVerification fromModel, PmTenderVerification toModel, List<String> includeCols, List<String> excludeCols) {
