...
public class SkillDisclosurePaperRecheckRecord {
     ...
     * 设置：项目。
     */
    public SkillDisclosurePaperRecheckRecord setPmPrjId(String pmPrjId) {
     ...
     * 设置：是否导入的记录。
     */
    public SkillDisclosurePaperRecheckRecord setIsImport(Boolean isImport) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static SkillDisclosurePaperRecheckRecord selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<SkillDisclosurePaperRecheckRecord> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<SkillDisclosurePaperRecheckRecord> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static SkillDisclosurePaperRecheckRecord selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<SkillDisclosurePaperRecheckRecord> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用SkillDisclosurePaperRecheckRecord.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static SkillDisclosurePaperRecheckRecord selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(SkillDisclosurePaperRecheckRecord fromModel, SkillDisclosurePaperRecheckRecord toModel) {
