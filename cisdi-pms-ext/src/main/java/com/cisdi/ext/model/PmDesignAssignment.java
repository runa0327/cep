 ...
 * 方案设计管理。
 */
public class PmDesignAssignment {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmDesignAssignment> modelHelper = new ModelHelper<>("PM_DESIGN_ASSIGNMENT", new PmDesignAssignment());
    ...
    public static final String ENT_CODE = "PM_DESIGN_ASSIGNMENT";
     ...
     * 设置：ID。
     */
    public PmDesignAssignment setId(String id) {
     ...
     * 设置：版本。
     */
    public PmDesignAssignment setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmDesignAssignment setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmDesignAssignment setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmDesignAssignment setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmDesignAssignment setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmDesignAssignment setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmDesignAssignment setName(String name) {
     ...
     * 设置：备注。
     */
    public PmDesignAssignment setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmDesignAssignment setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmDesignAssignment setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmDesignAssignment setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmDesignAssignment setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmDesignAssignment setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmDesignAssignment setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmDesignAssignment setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmDesignAssignment setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmDesignAssignment setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmDesignAssignment setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmDesignAssignment setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmDesignAssignment setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmDesignAssignment setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmDesignAssignment setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmDesignAssignment setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmDesignAssignment setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmDesignAssignment setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmDesignAssignment setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmDesignAssignment setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmDesignAssignment setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmDesignAssignment setPrjSituation(String prjSituation) {
     ...
     * 设置：设计单位1。
     */
    public PmDesignAssignment setDesignUnitOne(String designUnitOne) {
     ...
     * 设置：设计人1。
     */
    public PmDesignAssignment setDesignerOne(String designerOne) {
     ...
     * 设置：效果图1。
     */
    public PmDesignAssignment setDesignSketchFileOne(String designSketchFileOne) {
     ...
     * 设置：设计单位2。
     */
    public PmDesignAssignment setDesignUnitTwo(String designUnitTwo) {
     ...
     * 设置：附件。
     */
    public PmDesignAssignment setAttFileGroupId(String attFileGroupId) {
     ...
     * @return
     */
    public static PmDesignAssignment newData() {
        PmDesignAssignment obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmDesignAssignment insertData() {
        PmDesignAssignment obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmDesignAssignment selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmDesignAssignment obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmDesignAssignment> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmDesignAssignment> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmDesignAssignment> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmDesignAssignment> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmDesignAssignment fromModel, PmDesignAssignment toModel, List<String> includeCols, List<String> excludeCols) {
