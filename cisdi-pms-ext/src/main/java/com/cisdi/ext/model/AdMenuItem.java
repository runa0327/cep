...
public class AdMenuItem {
     ...
     * 设置：序号。
     */
    public AdMenuItem setSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
     ...
     * 菜单项类型。
     */
    public String adMenuItemTypeId;
