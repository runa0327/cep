 ...
 * 工程暂停令。
 */
public class PmPrjStopOrderReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmPrjStopOrderReq> modelHelper = new ModelHelper<>("PM_PRJ_STOP_ORDER_REQ", new PmPrjStopOrderReq());
    ...
    public static final String ENT_CODE = "PM_PRJ_STOP_ORDER_REQ";
     ...
     * 设置：ID。
     */
    public PmPrjStopOrderReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmPrjStopOrderReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmPrjStopOrderReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmPrjStopOrderReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmPrjStopOrderReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmPrjStopOrderReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmPrjStopOrderReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmPrjStopOrderReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmPrjStopOrderReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmPrjStopOrderReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmPrjStopOrderReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmPrjStopOrderReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmPrjStopOrderReq setPrjCode(String prjCode) {
     ...
     * 设置：项目类型。
     */
    public PmPrjStopOrderReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建用户。
     */
    public PmPrjStopOrderReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmPrjStopOrderReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目概况。
     */
    public PmPrjStopOrderReq setPrjSituation(String prjSituation) {
     ...
     * 设置：创建日期时间。
     */
    public PmPrjStopOrderReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：备注。
     */
    public PmPrjStopOrderReq setRemarkShort(String remarkShort) {
     ...
     * 设置：原因说明。
     */
    public PmPrjStopOrderReq setReasonExplain(String reasonExplain) {
     ...
     * 设置：日期1。
     */
    public PmPrjStopOrderReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：部位1。
     */
    public PmPrjStopOrderReq setPositionOne(String positionOne) {
     ...
     * 设置：备注2。
     */
    public PmPrjStopOrderReq setRemarkTwo(String remarkTwo) {
     ...
     * 设置：备注1。
     */
    public PmPrjStopOrderReq setRemarkOne(String remarkOne) {
     ...
     * 设置：附件1。
     */
    public PmPrjStopOrderReq setFileIdOne(String fileIdOne) {
     ...
     * @return
     */
    public static PmPrjStopOrderReq newData() {
        PmPrjStopOrderReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmPrjStopOrderReq insertData() {
        PmPrjStopOrderReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmPrjStopOrderReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmPrjStopOrderReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmPrjStopOrderReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjStopOrderReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjStopOrderReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjStopOrderReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmPrjStopOrderReq fromModel, PmPrjStopOrderReq toModel, List<String> includeCols, List<String> excludeCols) {
