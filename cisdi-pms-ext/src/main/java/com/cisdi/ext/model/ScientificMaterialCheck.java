 ...
 * 科研材料设备进场验收。
 */
public class ScientificMaterialCheck {

    /**
     * 模型助手。
     */
    private static final ModelHelper<ScientificMaterialCheck> modelHelper = new ModelHelper<>("SCIENTIFIC_MATERIAL_CHECK", new ScientificMaterialCheck());
    ...
    public static final String ENT_CODE = "SCIENTIFIC_MATERIAL_CHECK";
     ...
     * 设置：ID。
     */
    public ScientificMaterialCheck setId(String id) {
     ...
     * 设置：版本。
     */
    public ScientificMaterialCheck setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public ScientificMaterialCheck setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public ScientificMaterialCheck setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public ScientificMaterialCheck setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public ScientificMaterialCheck setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public ScientificMaterialCheck setCode(String code) {
     ...
     * 设置：名称。
     */
    public ScientificMaterialCheck setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public ScientificMaterialCheck setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public ScientificMaterialCheck setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public ScientificMaterialCheck setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public ScientificMaterialCheck setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public ScientificMaterialCheck setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public ScientificMaterialCheck setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public ScientificMaterialCheck setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public ScientificMaterialCheck setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public ScientificMaterialCheck setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public ScientificMaterialCheck setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public ScientificMaterialCheck setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public ScientificMaterialCheck setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public ScientificMaterialCheck setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public ScientificMaterialCheck setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public ScientificMaterialCheck setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public ScientificMaterialCheck setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public ScientificMaterialCheck setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public ScientificMaterialCheck setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public ScientificMaterialCheck setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public ScientificMaterialCheck setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public ScientificMaterialCheck setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public ScientificMaterialCheck setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public ScientificMaterialCheck setRemark(String remark) {
     ...
     * @return
     */
    public static ScientificMaterialCheck newData() {
        ScientificMaterialCheck obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static ScientificMaterialCheck insertData() {
        ScientificMaterialCheck obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static ScientificMaterialCheck selectById(String id, List<String> includeCols, List<String> excludeCols) {
        ScientificMaterialCheck obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<ScientificMaterialCheck> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<ScientificMaterialCheck> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<ScientificMaterialCheck> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<ScientificMaterialCheck> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(ScientificMaterialCheck fromModel, ScientificMaterialCheck toModel, List<String> includeCols, List<String> excludeCols) {
