...
public class AdSevAttLink {
    ...
    public static final String ENT_CODE = "AD_SEV_ATT_LINK";
    ...
    public static class Cols {
         ...
         * 被驱动方属性的值逻辑。
         */
        public static final String DRIVEN_ATT_VALUE_LOGIC = "DRIVEN_ATT_VALUE_LOGIC";
        /**
         * 被驱动方属性的可改逻辑。
         */
        public static final String DRIVEN_ATT_EDITABLE_LOGIC = "DRIVEN_ATT_EDITABLE_LOGIC";
        /**
         * 被驱动方属性的必填逻辑。
         */
        public static final String DRIVEN_ATT_MANDATORY_LOGIC = "DRIVEN_ATT_MANDATORY_LOGIC";
        /**
         * 实体视图。
         */
     ...
     * 获取：被驱动方属性的值逻辑。
     */
    public String getDrivenAttValueLogic() {
        return this.drivenAttValueLogic;
    }
     ...
     * 获取：被驱动方属性的可改逻辑。
     */
    public String getDrivenAttEditableLogic() {
        return this.drivenAttEditableLogic;
    }
     ...
     * 获取：被驱动方属性的必填逻辑。
     */
    public String getDrivenAttMandatoryLogic() {
        return this.drivenAttMandatoryLogic;
    }
     ...
     */
    public static void copyCols(AdSevAttLink fromModel, AdSevAttLink toModel, List<String> includeCols, List<String> excludeCols) {
