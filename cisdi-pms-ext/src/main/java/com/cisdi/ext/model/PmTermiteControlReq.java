 ...
 * 白蚁防治。
 */
public class PmTermiteControlReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmTermiteControlReq> modelHelper = new ModelHelper<>("PM_TERMITE_CONTROL_REQ", new PmTermiteControlReq());
    ...
    public static final String ENT_CODE = "PM_TERMITE_CONTROL_REQ";
     ...
     * 设置：ID。
     */
    public PmTermiteControlReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmTermiteControlReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmTermiteControlReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmTermiteControlReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmTermiteControlReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmTermiteControlReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmTermiteControlReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmTermiteControlReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmTermiteControlReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmTermiteControlReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmTermiteControlReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmTermiteControlReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmTermiteControlReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmTermiteControlReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmTermiteControlReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmTermiteControlReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmTermiteControlReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmTermiteControlReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmTermiteControlReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmTermiteControlReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmTermiteControlReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmTermiteControlReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmTermiteControlReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmTermiteControlReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmTermiteControlReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmTermiteControlReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmTermiteControlReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmTermiteControlReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmTermiteControlReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmTermiteControlReq setPrjSituation(String prjSituation) {
     ...
     * 设置：招采项目备案及归档。
     */
    public PmTermiteControlReq setPmBidKeepFileReqId(String pmBidKeepFileReqId) {
     ...
     * 设置：状态1。
     */
    public PmTermiteControlReq setStatusOne(String statusOne) {
     ...
     * 设置：业主单位1。
     */
    public PmTermiteControlReq setCustomerUnitOne(String customerUnitOne) {
     ...
     * 设置：采购经办人。
     */
    public PmTermiteControlReq setProcureUserId(String procureUserId) {
     ...
     * 设置：中标单位1。
     */
    public PmTermiteControlReq setWinBidUnitOne(String winBidUnitOne) {
     ...
     * 设置：联系人1。
     */
    public PmTermiteControlReq setContactsOne(String contactsOne) {
     ...
     * 设置：联系人电话1。
     */
    public PmTermiteControlReq setContactMobileOne(String contactMobileOne) {
     ...
     * 设置：计划完成日期。
     */
    public PmTermiteControlReq setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：申请时间。
     */
    public PmTermiteControlReq setApplyTime(LocalDate applyTime) {
     ...
     * 设置：申请人。
     */
    public PmTermiteControlReq setApplicant(String applicant) {
     ...
     * 设置：附件。
     */
    public PmTermiteControlReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：日期1。
     */
    public PmTermiteControlReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：经办人。
     */
    public PmTermiteControlReq setAgent(String agent) {
     ...
     * 设置：审批附件1。
     */
    public PmTermiteControlReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：日期2。
     */
    public PmTermiteControlReq setDateTwo(LocalDate dateTwo) {
     ...
     * 设置：日期3。
     */
    public PmTermiteControlReq setDateThree(LocalDate dateThree) {
     ...
     * 设置：经办人2。
     */
    public PmTermiteControlReq setAgentTwo(String agentTwo) {
     ...
     * 设置：审批附件2。
     */
    public PmTermiteControlReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：日期4。
     */
    public PmTermiteControlReq setDateFour(LocalDate dateFour) {
     ...
     * 设置：经办人3。
     */
    public PmTermiteControlReq setAgentThree(String agentThree) {
     ...
     * 设置：审批附件3。
     */
    public PmTermiteControlReq setApproveFileIdThree(String approveFileIdThree) {
     ...
     * @return
     */
    public static PmTermiteControlReq newData() {
        PmTermiteControlReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmTermiteControlReq insertData() {
        PmTermiteControlReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmTermiteControlReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmTermiteControlReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmTermiteControlReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmTermiteControlReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmTermiteControlReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmTermiteControlReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmTermiteControlReq fromModel, PmTermiteControlReq toModel, List<String> includeCols, List<String> excludeCols) {
