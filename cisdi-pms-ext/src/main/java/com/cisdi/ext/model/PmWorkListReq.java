 ...
 * 工作联系单。
 */
public class PmWorkListReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmWorkListReq> modelHelper = new ModelHelper<>("PM_WORK_LIST_REQ", new PmWorkListReq());
    ...
    public static final String ENT_CODE = "PM_WORK_LIST_REQ";
     ...
     * 设置：ID。
     */
    public PmWorkListReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmWorkListReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmWorkListReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmWorkListReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmWorkListReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmWorkListReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmWorkListReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmWorkListReq setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public PmWorkListReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmWorkListReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmWorkListReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmWorkListReq setPrjCode(String prjCode) {
     ...
     * 设置：创建用户。
     */
    public PmWorkListReq setCrtUserId(String crtUserId) {
     ...
     * 设置：立项批复文号。
     */
    public PmWorkListReq setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：业主单位。
     */
    public PmWorkListReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建部门。
     */
    public PmWorkListReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：创建日期时间。
     */
    public PmWorkListReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：投资来源。
     */
    public PmWorkListReq setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：项目管理模式。
     */
    public PmWorkListReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：项目类型。
     */
    public PmWorkListReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：总投资（万）。
     */
    public PmWorkListReq setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmWorkListReq setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：工程其他费用(万)。
     */
    public PmWorkListReq setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：预备费(万)。
     */
    public PmWorkListReq setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public PmWorkListReq setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：项目概况。
     */
    public PmWorkListReq setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public PmWorkListReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public PmWorkListReq setRemark(String remark) {
     ...
     * 设置：是否导入的记录。
     */
    public PmWorkListReq setIsImport(Boolean isImport) {
     ...
     * @return
     */
    public static PmWorkListReq newData() {
        PmWorkListReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmWorkListReq insertData() {
        PmWorkListReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmWorkListReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmWorkListReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmWorkListReq selectById(String id) {
     ...
     */
    public static List<PmWorkListReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmWorkListReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmWorkListReq> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmWorkListReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmWorkListReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmWorkListReq> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmWorkListReq selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmWorkListReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmWorkListReq.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmWorkListReq selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmWorkListReq fromModel, PmWorkListReq toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmWorkListReq fromModel, PmWorkListReq toModel) {
