 ...
 * 工程复工报审表。
 */
public class PmPrjRestartTrialReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmPrjRestartTrialReq> modelHelper = new ModelHelper<>("PM_PRJ_RESTART_TRIAL_REQ", new PmPrjRestartTrialReq());
    ...
    public static final String ENT_CODE = "PM_PRJ_RESTART_TRIAL_REQ";
     ...
     * 设置：ID。
     */
    public PmPrjRestartTrialReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmPrjRestartTrialReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmPrjRestartTrialReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmPrjRestartTrialReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmPrjRestartTrialReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmPrjRestartTrialReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmPrjRestartTrialReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmPrjRestartTrialReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmPrjRestartTrialReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmPrjRestartTrialReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmPrjRestartTrialReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：项目管理模式。
     */
    public PmPrjRestartTrialReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：记录状态。
     */
    public PmPrjRestartTrialReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmPrjRestartTrialReq setPrjCode(String prjCode) {
     ...
     * 设置：项目类型。
     */
    public PmPrjRestartTrialReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建用户。
     */
    public PmPrjRestartTrialReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmPrjRestartTrialReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目概况。
     */
    public PmPrjRestartTrialReq setPrjSituation(String prjSituation) {
     ...
     * 设置：创建日期时间。
     */
    public PmPrjRestartTrialReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：备注。
     */
    public PmPrjRestartTrialReq setRemarkShort(String remarkShort) {
     ...
     * 设置：工程暂停令。
     */
    public PmPrjRestartTrialReq setPmPrjStopOrderReqId(String pmPrjStopOrderReqId) {
     ...
     * 设置：日期1。
     */
    public PmPrjRestartTrialReq setDateOne(LocalDate dateOne) {
     ...
     * 设置：部位1。
     */
    public PmPrjRestartTrialReq setPositionOne(String positionOne) {
     ...
     * 设置：备注1。
     */
    public PmPrjRestartTrialReq setRemarkOne(String remarkOne) {
     ...
     * 设置：附件1。
     */
    public PmPrjRestartTrialReq setFileIdOne(String fileIdOne) {
     ...
     * @return
     */
    public static PmPrjRestartTrialReq newData() {
        PmPrjRestartTrialReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmPrjRestartTrialReq insertData() {
        PmPrjRestartTrialReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmPrjRestartTrialReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmPrjRestartTrialReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmPrjRestartTrialReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjRestartTrialReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjRestartTrialReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjRestartTrialReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmPrjRestartTrialReq fromModel, PmPrjRestartTrialReq toModel, List<String> includeCols, List<String> excludeCols) {
