...
public class SlContractAct {
    ...
    public static final String ENT_CODE = "SL_CONTRACT_ACT";
    ...
    public static class Cols {
         ...
         * 承包模式列表。
         */
        public static final String SL_CONTRACT_TYPE02_IDS = "SL_CONTRACT_TYPE02_IDS";
        /**
         * 商业模式。
         */
         ...
         * 项目资质。
         */
        public static final String SL_CONTRACT_TYPE01_ID = "SL_CONTRACT_TYPE01_ID";
        /**
         * 签订金额。
         */
     ...
     * 获取：承包模式列表。
     */
    public String getSlContractType02Ids() {
        return this.slContractType02Ids;
    }
     ...
     * 获取：项目资质。
     */
    public String getSlContractType01Id() {
        return this.slContractType01Id;
    }
     ...
     */
    public static void copyCols(SlContractAct fromModel, SlContractAct toModel, List<String> includeCols, List<String> excludeCols) {
