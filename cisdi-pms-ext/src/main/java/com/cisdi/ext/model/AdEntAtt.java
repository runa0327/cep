...
public class AdEntAtt {
     ...
     * 设置：最小宽度。
     */
    public AdEntAtt setMinWidth(Integer minWidth) {
     ...
     * 设置：最大宽度。
     */
    public AdEntAtt setMaxWidth(Integer maxWidth) {
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static AdEntAtt selectById(String id) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<AdEntAtt> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<AdEntAtt> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static AdEntAtt selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<AdEntAtt> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用AdEntAtt.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static AdEntAtt selectOneByWhere(Where where) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(AdEntAtt fromModel, AdEntAtt toModel) {
