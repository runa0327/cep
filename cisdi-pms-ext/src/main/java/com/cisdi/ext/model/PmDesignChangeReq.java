 ...
 * 设计变更。
 */
public class PmDesignChangeReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmDesignChangeReq> modelHelper = new ModelHelper<>("PM_DESIGN_CHANGE_REQ", new PmDesignChangeReq());
    ...
    public static final String ENT_CODE = "PM_DESIGN_CHANGE_REQ";
     ...
     * 设置：ID。
     */
    public PmDesignChangeReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmDesignChangeReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmDesignChangeReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmDesignChangeReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmDesignChangeReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmDesignChangeReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmDesignChangeReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmDesignChangeReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmDesignChangeReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmDesignChangeReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmDesignChangeReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmDesignChangeReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmDesignChangeReq setPrjCode(String prjCode) {
     ...
     * 设置：创建用户。
     */
    public PmDesignChangeReq setCrtUserId(String crtUserId) {
     ...
     * 设置：立项批复文号。
     */
    public PmDesignChangeReq setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：业主单位。
     */
    public PmDesignChangeReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建部门。
     */
    public PmDesignChangeReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：创建日期时间。
     */
    public PmDesignChangeReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：项目概况。
     */
    public PmDesignChangeReq setPrjSituation(String prjSituation) {
     ...
     * 设置：投资来源。
     */
    public PmDesignChangeReq setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：金额（万）。
     */
    public PmDesignChangeReq setAmt(BigDecimal amt) {
     ...
     * 设置：变更类型。
     */
    public PmDesignChangeReq setChangeTypeId(String changeTypeId) {
        if (this.changeTypeId == null && changeTypeId == null) {
            // 均为null，不做处理。
        } else if (this.changeTypeId != null && changeTypeId != null) {
            // 均非null，判定不等，再做处理：
            if (this.changeTypeId.compareTo(changeTypeId) != 0) {
                this.changeTypeId = changeTypeId;
                if (!this.toUpdateCols.contains("CHANGE_TYPE_ID")) {
                    this.toUpdateCols.add("CHANGE_TYPE_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * 设置：日期2。
     */
    public PmDesignChangeReq setDateTwo(LocalDate dateTwo) {
     ...
     * 设置：备注1。
     */
    public PmDesignChangeReq setRemarkOne(String remarkOne) {
     ...
     * 设置：备注2。
     */
    public PmDesignChangeReq setRemarkTwo(String remarkTwo) {
     ...
     * 设置：附件。
     */
    public PmDesignChangeReq setAttFileGroupId(String attFileGroupId) {
     ...
     * @return
     */
    public static PmDesignChangeReq newData() {
        PmDesignChangeReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmDesignChangeReq insertData() {
        PmDesignChangeReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmDesignChangeReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmDesignChangeReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmDesignChangeReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmDesignChangeReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmDesignChangeReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmDesignChangeReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmDesignChangeReq fromModel, PmDesignChangeReq toModel, List<String> includeCols, List<String> excludeCols) {
