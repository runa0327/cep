...
public class ProjectQualityInspection {
     ...
     * 模型助手。
     */
    private static final ModelHelper<ProjectQualityInspection> modelHelper = new ModelHelper<>("PROJECT_QUALITY_INSPECTION", new ProjectQualityInspection());
    ...
    public static final String ENT_CODE = "PROJECT_QUALITY_INSPECTION";
     ...
     * 设置：ID。
     */
    public ProjectQualityInspection setId(String id) {
     ...
     * 设置：版本。
     */
    public ProjectQualityInspection setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public ProjectQualityInspection setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public ProjectQualityInspection setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public ProjectQualityInspection setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public ProjectQualityInspection setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public ProjectQualityInspection setCode(String code) {
     ...
     * 设置：名称。
     */
    public ProjectQualityInspection setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public ProjectQualityInspection setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public ProjectQualityInspection setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public ProjectQualityInspection setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public ProjectQualityInspection setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public ProjectQualityInspection setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public ProjectQualityInspection setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public ProjectQualityInspection setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public ProjectQualityInspection setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public ProjectQualityInspection setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public ProjectQualityInspection setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public ProjectQualityInspection setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public ProjectQualityInspection setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public ProjectQualityInspection setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public ProjectQualityInspection setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public ProjectQualityInspection setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public ProjectQualityInspection setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public ProjectQualityInspection setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public ProjectQualityInspection setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public ProjectQualityInspection setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public ProjectQualityInspection setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public ProjectQualityInspection setPrjSituation(String prjSituation) {
     ...
     * 设置：计划完成日期。
     */
    public ProjectQualityInspection setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：附件。
     */
    public ProjectQualityInspection setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public ProjectQualityInspection setRemark(String remark) {
     ...
     * 设置：附件1。
     */
    public ProjectQualityInspection setFileIdOne(String fileIdOne) {
     ...
     * @return
     */
    public static ProjectQualityInspection newData() {
        ProjectQualityInspection obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static ProjectQualityInspection insertData() {
        ProjectQualityInspection obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static ProjectQualityInspection selectById(String id, List<String> includeCols, List<String> excludeCols) {
        ProjectQualityInspection obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<ProjectQualityInspection> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<ProjectQualityInspection> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<ProjectQualityInspection> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<ProjectQualityInspection> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(ProjectQualityInspection fromModel, ProjectQualityInspection toModel, List<String> includeCols, List<String> excludeCols) {
