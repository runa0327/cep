 ...
 * 五方责任主体及终身质量承诺书。
 */
public class PmPartyQualityPromiseReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmPartyQualityPromiseReq> modelHelper = new ModelHelper<>("PM_PARTY_QUALITY_PROMISE_REQ", new PmPartyQualityPromiseReq());
    ...
    public static final String ENT_CODE = "PM_PARTY_QUALITY_PROMISE_REQ";
     ...
     * 设置：ID。
     */
    public PmPartyQualityPromiseReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmPartyQualityPromiseReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmPartyQualityPromiseReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmPartyQualityPromiseReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmPartyQualityPromiseReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmPartyQualityPromiseReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmPartyQualityPromiseReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmPartyQualityPromiseReq setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public PmPartyQualityPromiseReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmPartyQualityPromiseReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmPartyQualityPromiseReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmPartyQualityPromiseReq setPrjCode(String prjCode) {
     ...
     * 设置：项目类型。
     */
    public PmPartyQualityPromiseReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建用户。
     */
    public PmPartyQualityPromiseReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmPartyQualityPromiseReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：总投资（万）。
     */
    public PmPartyQualityPromiseReq setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmPartyQualityPromiseReq setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：创建日期时间。
     */
    public PmPartyQualityPromiseReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：项目概况。
     */
    public PmPartyQualityPromiseReq setPrjSituation(String prjSituation) {
     ...
     * 设置：备注。
     */
    public PmPartyQualityPromiseReq setRemark(String remark) {
     ...
     * 设置：建设单位名称。
     */
    public PmPartyQualityPromiseReq setBuildUnitName(String buildUnitName) {
     ...
     * 设置：建设单位资质和等级。
     */
    public PmPartyQualityPromiseReq setBuildUnitLevel(String buildUnitLevel) {
     ...
     * 设置：建设单位地址。
     */
    public PmPartyQualityPromiseReq setBuildUnitAddress(String buildUnitAddress) {
     ...
     * 设置：建设单位电话。
     */
    public PmPartyQualityPromiseReq setBuildUnitPhone(String buildUnitPhone) {
     ...
     * 设置：法定代表人。
     */
    public PmPartyQualityPromiseReq setLegalUser(String legalUser) {
     ...
     * 设置：联系人手机。
     */
    public PmPartyQualityPromiseReq setContactMobile(String contactMobile) {
     ...
     * 设置：建设单位项目负责人。
     */
    public PmPartyQualityPromiseReq setBuildUnitResponse(String buildUnitResponse) {
     ...
     * 设置：对方联系方式。
     */
    public PmPartyQualityPromiseReq setOtherContactPhone(String otherContactPhone) {
     ...
     * 设置：附件。
     */
    public PmPartyQualityPromiseReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public PmPartyQualityPromiseReq setRemarkShort(String remarkShort) {
     ...
     * 设置：代建单位名称。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitName(String agentBuildUnitName) {
     ...
     * 设置：代建单位资质和等级。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitLevel(String agentBuildUnitLevel) {
     ...
     * 设置：代建单位地址。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitAddress(String agentBuildUnitAddress) {
     ...
     * 设置：代建单位电话。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitPhone(String agentBuildUnitPhone) {
     ...
     * 设置：代建单位项目负责人。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitResponse(String agentBuildUnitResponse) {
     ...
     * 设置：代建单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setAgentBuildUnitResponsePhone(String agentBuildUnitResponsePhone) {
     ...
     * 设置：审批附件1。
     */
    public PmPartyQualityPromiseReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：勘察单位名称。
     */
    public PmPartyQualityPromiseReq setSurveyUnitName(String surveyUnitName) {
     ...
     * 设置：勘察单位资质和等级。
     */
    public PmPartyQualityPromiseReq setSurveyUnitLevel(String surveyUnitLevel) {
     ...
     * 设置：勘察单位项目负责人。
     */
    public PmPartyQualityPromiseReq setSurveyUnitResponse(String surveyUnitResponse) {
     ...
     * 设置：勘察单位项目负责人注册职业资格。
     */
    public PmPartyQualityPromiseReq setSurveyUnitProfessional(String surveyUnitProfessional) {
     ...
     * 设置：勘察单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setSurveyUnitResponsePhone(String surveyUnitResponsePhone) {
     ...
     * 设置：审批附件2。
     */
    public PmPartyQualityPromiseReq setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：设计单位名称。
     */
    public PmPartyQualityPromiseReq setDesignUnitName(String designUnitName) {
     ...
     * 设置：设计单位资质和等级。
     */
    public PmPartyQualityPromiseReq setDesignUnitLevel(String designUnitLevel) {
     ...
     * 设置：设计单位项目负责人。
     */
    public PmPartyQualityPromiseReq setDesignUnitResponse(String designUnitResponse) {
     ...
     * 设置：设计单位项目负责人注册职业资格。
     */
    public PmPartyQualityPromiseReq setDesignUnitProfessional(String designUnitProfessional) {
     ...
     * 设置：设计单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setDesignUnitResponsePhone(String designUnitResponsePhone) {
     ...
     * 设置：审批附件3。
     */
    public PmPartyQualityPromiseReq setApproveFileIdThree(String approveFileIdThree) {
     ...
     * 设置：工程总承包单位名称。
     */
    public PmPartyQualityPromiseReq setEpcUnitName(String epcUnitName) {
     ...
     * 设置：工程总承包单位资质和等级。
     */
    public PmPartyQualityPromiseReq setEpcUnitLevel(String epcUnitLevel) {
     ...
     * 设置：工程总承包单位项目负责人。
     */
    public PmPartyQualityPromiseReq setEpcUnitResponse(String epcUnitResponse) {
     ...
     */
    public PmPartyQualityPromiseReq setEpcUnitProfessional(String epcUnitProfessional) {
     ...
     * 设置：工程总承包单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setEpcUnitResponsePhone(String epcUnitResponsePhone) {
     ...
     * 设置：审批附件4。
     */
    public PmPartyQualityPromiseReq setApproveFileIdFour(String approveFileIdFour) {
     ...
     * 设置：施工总承包单位名称。
     */
    public PmPartyQualityPromiseReq setCgcUnitName(String cgcUnitName) {
     ...
     * 设置：施工总承包单位资质和等级。
     */
    public PmPartyQualityPromiseReq setCgcUnitLevel(String cgcUnitLevel) {
     ...
     * 设置：施工总承包安全生产许可证有效期。
     */
    public PmPartyQualityPromiseReq setCgcUnitLevelPeriod(String cgcUnitLevelPeriod) {
     ...
     * 设置：施工总承包单位项目负责人。
     */
    public PmPartyQualityPromiseReq setCgcUnitResponse(String cgcUnitResponse) {
     ...
     */
    public PmPartyQualityPromiseReq setCgcUnitProfessional(String cgcUnitProfessional) {
     ...
     * 设置：施工总承包单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setCgcUnitResponsePhone(String cgcUnitResponsePhone) {
     ...
     * 设置：审批附件5。
     */
    public PmPartyQualityPromiseReq setApproveFileIdFive(String approveFileIdFive) {
     ...
     * 设置：监理单位名称。
     */
    public PmPartyQualityPromiseReq setManageUnitName(String manageUnitName) {
     ...
     * 设置：监理单位资质和等级。
     */
    public PmPartyQualityPromiseReq setManageUnitLevel(String manageUnitLevel) {
     ...
     * 设置：监理单位项目负责人。
     */
    public PmPartyQualityPromiseReq setManageUnitResponse(String manageUnitResponse) {
     ...
     * 设置：监理单位项目负责人注册职业资格。
     */
    public PmPartyQualityPromiseReq setManageUnitProfessional(String manageUnitProfessional) {
     ...
     * 设置：监理单位项目负责人电话。
     */
    public PmPartyQualityPromiseReq setManageUnitResponsePhone(String manageUnitResponsePhone) {
     ...
     * 设置：审批附件6。
     */
    public PmPartyQualityPromiseReq setApproveFileIdSix(String approveFileIdSix) {
     ...
     * @return
     */
    public static PmPartyQualityPromiseReq newData() {
        PmPartyQualityPromiseReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmPartyQualityPromiseReq insertData() {
        PmPartyQualityPromiseReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmPartyQualityPromiseReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmPartyQualityPromiseReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmPartyQualityPromiseReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmPartyQualityPromiseReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPartyQualityPromiseReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPartyQualityPromiseReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmPartyQualityPromiseReq fromModel, PmPartyQualityPromiseReq toModel, List<String> includeCols, List<String> excludeCols) {
