 ...
 * 材料退场。
 */
public class PmMaterialExit {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmMaterialExit> modelHelper = new ModelHelper<>("PM_MATERIAL_EXIT", new PmMaterialExit());
    ...
    public static final String ENT_CODE = "PM_MATERIAL_EXIT";
     ...
     * 设置：ID。
     */
    public PmMaterialExit setId(String id) {
     ...
     * 设置：版本。
     */
    public PmMaterialExit setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmMaterialExit setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmMaterialExit setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmMaterialExit setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmMaterialExit setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmMaterialExit setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmMaterialExit setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public PmMaterialExit setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmMaterialExit setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmMaterialExit setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmMaterialExit setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmMaterialExit setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmMaterialExit setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmMaterialExit setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmMaterialExit setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmMaterialExit setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmMaterialExit setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmMaterialExit setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmMaterialExit setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmMaterialExit setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmMaterialExit setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmMaterialExit setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmMaterialExit setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmMaterialExit setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmMaterialExit setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmMaterialExit setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmMaterialExit setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmMaterialExit setPrjSituation(String prjSituation) {
     ...
     * 设置：附件。
     */
    public PmMaterialExit setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public PmMaterialExit setRemark(String remark) {
     ...
     * @return
     */
    public static PmMaterialExit newData() {
        PmMaterialExit obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmMaterialExit insertData() {
        PmMaterialExit obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmMaterialExit selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmMaterialExit obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmMaterialExit> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmMaterialExit> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmMaterialExit> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmMaterialExit> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmMaterialExit fromModel, PmMaterialExit toModel, List<String> includeCols, List<String> excludeCols) {
