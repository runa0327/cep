...
public class WfFlow {
     ...
     * 操作生效数量逻辑。
     */
    public String actEffectiveCountLogic;
     ...
     * 设置：序号。
     */
    public WfFlow setSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
     ...
     * 超时计算方法。
     */
    public String wfTimeoutCalcMethodId;
     ...
     * 设置：超时分钟数。
     */
    public WfFlow setTimeoutMinutes(Double timeoutMinutes) {
