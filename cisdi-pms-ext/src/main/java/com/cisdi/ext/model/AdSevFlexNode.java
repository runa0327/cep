...
public class AdSevFlexNode {
    ...
    public static final String ENT_CODE = "AD_SEV_FLEX_NODE";
    ...
    public static class Cols {
         ...
         * 实体视图FLEX元素。
         */
        public static final String AD_SEV_FLEX_ELEM_ID = "AD_SEV_FLEX_ELEM_ID";
        /**
         * 属性。
         */
         ...
         * 实体视图FLEX父节点。
         */
        public static final String AD_SEV_FLEX_NODE_PID = "AD_SEV_FLEX_NODE_PID";
    }
     ...
     * 获取：实体视图FLEX元素。
     */
    public String getAdSevFlexElemId() {
        return this.adSevFlexElemId;
    }
     ...
     * 获取：实体视图FLEX父节点。
     */
    public String getAdSevFlexNodePid() {
        return this.adSevFlexNodePid;
    }
     ...
     */
    public static void copyCols(AdSevFlexNode fromModel, AdSevFlexNode toModel, List<String> includeCols, List<String> excludeCols) {
