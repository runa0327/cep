...
public class AdExtCacheLog {
    ...
    public static final String ENT_CODE = "AD_EXT_CACHE_LOG";
     ...
     */
    public static void copyCols(AdExtCacheLog fromModel, AdExtCacheLog toModel, List<String> includeCols, List<String> excludeCols) {
