...
public class GrDataTranferCol {
    ...
    public static final String ENT_CODE = "GR_DATA_TRANFER_COL";
    ...
    public static class Cols {
         ...
         * CPMS列。
         */
        public static final String CPMS_COL = "CPMS_COL";
        /**
         * 企业云列。
         */
        public static final String QYGLY_COL = "QYGLY_COL";
        /**
         * CPMS字典类型。
         */
        public static final String CPMS_DICT_TYPE = "CPMS_DICT_TYPE";
        /**
         * 引用的企业云表。
         */
        public static final String REFED_QYGLY_TABLE = "REFED_QYGLY_TABLE";
        /**
         * 数据传输表。
         */
        public static final String GR_DATA_TRANFER_TABLE_ID = "GR_DATA_TRANFER_TABLE_ID";
    }
     ...
     * 获取：企业云列。
     */
    public String getQyglyCol() {
        return this.qyglyCol;
    }
     ...
     * 获取：CPMS字典类型。
     */
    public String getCpmsDictType() {
        return this.cpmsDictType;
    }
     ...
     * 获取：引用的企业云表。
     */
    public String getRefedQyglyTable() {
        return this.refedQyglyTable;
    }
     ...
     * 获取：数据传输表。
     */
    public String getGrDataTranferTableId() {
        return this.grDataTranferTableId;
    }
     ...
     */
    public static void copyCols(GrDataTranferCol fromModel, GrDataTranferCol toModel, List<String> includeCols, List<String> excludeCols) {
