 ...
 * 土地证办理。
 */
public class PmLandCertificate {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmLandCertificate> modelHelper = new ModelHelper<>("PM_LAND_CERTIFICATE", new PmLandCertificate());
    ...
    public static final String ENT_CODE = "PM_LAND_CERTIFICATE";
     ...
     * 设置：ID。
     */
    public PmLandCertificate setId(String id) {
     ...
     * 设置：版本。
     */
    public PmLandCertificate setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmLandCertificate setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmLandCertificate setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmLandCertificate setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmLandCertificate setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmLandCertificate setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmLandCertificate setName(String name) {
     ...
     * 设置：锁定流程实例。
     */
    public PmLandCertificate setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmLandCertificate setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmLandCertificate setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmLandCertificate setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmLandCertificate setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmLandCertificate setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmLandCertificate setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmLandCertificate setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmLandCertificate setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmLandCertificate setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmLandCertificate setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmLandCertificate setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmLandCertificate setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmLandCertificate setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmLandCertificate setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmLandCertificate setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmLandCertificate setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmLandCertificate setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmLandCertificate setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmLandCertificate setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmLandCertificate setPrjSituation(String prjSituation) {
     ...
     * 设置：申请时间。
     */
    public PmLandCertificate setApplyTime(LocalDate applyTime) {
     ...
     * 设置：计划完成日期。
     */
    public PmLandCertificate setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：申请人。
     */
    public PmLandCertificate setApplicant(String applicant) {
     ...
     * 设置：附件。
     */
    public PmLandCertificate setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：备注。
     */
    public PmLandCertificate setRemark(String remark) {
     ...
     * 设置：下发时间。
     */
    public PmLandCertificate setIssueDate(LocalDate issueDate) {
     ...
     * 设置：保函编号。
     */
    public PmLandCertificate setGuaranteeCode(String guaranteeCode) {
     ...
     * 设置：有效期。
     */
    public PmLandCertificate setValidTerm(String validTerm) {
     ...
     * 设置：审批附件1。
     */
    public PmLandCertificate setApproveFileIdOne(String approveFileIdOne) {
     ...
     * @return
     */
    public static PmLandCertificate newData() {
        PmLandCertificate obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmLandCertificate insertData() {
        PmLandCertificate obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmLandCertificate selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmLandCertificate obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmLandCertificate> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmLandCertificate> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmLandCertificate> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmLandCertificate> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmLandCertificate fromModel, PmLandCertificate toModel, List<String> includeCols, List<String> excludeCols) {
