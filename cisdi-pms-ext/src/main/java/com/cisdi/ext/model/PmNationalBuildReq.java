 ...
 * 国安报建。
 */
public class PmNationalBuildReq {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmNationalBuildReq> modelHelper = new ModelHelper<>("PM_NATIONAL_BUILD_REQ", new PmNationalBuildReq());
    ...
    public static final String ENT_CODE = "PM_NATIONAL_BUILD_REQ";
     ...
     * 设置：ID。
     */
    public PmNationalBuildReq setId(String id) {
     ...
     * 设置：版本。
     */
    public PmNationalBuildReq setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmNationalBuildReq setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmNationalBuildReq setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmNationalBuildReq setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmNationalBuildReq setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public PmNationalBuildReq setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmNationalBuildReq setName(String name) {
     ...
     * 设置：备注。
     */
    public PmNationalBuildReq setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public PmNationalBuildReq setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public PmNationalBuildReq setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public PmNationalBuildReq setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public PmNationalBuildReq setPrjCode(String prjCode) {
     ...
     * 设置：业主单位。
     */
    public PmNationalBuildReq setCustomerUnit(String customerUnit) {
     ...
     * 设置：创建用户。
     */
    public PmNationalBuildReq setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public PmNationalBuildReq setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目管理模式。
     */
    public PmNationalBuildReq setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：建设地点。
     */
    public PmNationalBuildReq setBaseLocationId(String baseLocationId) {
     ...
     * 设置：创建日期时间。
     */
    public PmNationalBuildReq setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：占地面积(平方米)。
     */
    public PmNationalBuildReq setFloorArea(BigDecimal floorArea) {
     ...
     * 设置：项目类型。
     */
    public PmNationalBuildReq setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设规模类型。
     */
    public PmNationalBuildReq setConScaleTypeId(String conScaleTypeId) {
     ...
     * 设置：建设规模数量。
     */
    public PmNationalBuildReq setConScaleQty(BigDecimal conScaleQty) {
     ...
     * 设置：数量1。
     */
    public PmNationalBuildReq setQtyOne(BigDecimal qtyOne) {
     ...
     * 设置：数量2。
     */
    public PmNationalBuildReq setQtyTwo(Integer qtyTwo) {
     ...
     * 设置：数量3。
     */
    public PmNationalBuildReq setQtyThree(Integer qtyThree) {
     ...
     * 设置：建设规模数量2。
     */
    public PmNationalBuildReq setConScaleQty2(BigDecimal conScaleQty2) {
     ...
     * 设置：建设规模单位。
     */
    public PmNationalBuildReq setConScaleUomId(String conScaleUomId) {
     ...
     * 设置：建设年限。
     */
    public PmNationalBuildReq setBuildYears(BigDecimal buildYears) {
     ...
     * 设置：项目概况。
     */
    public PmNationalBuildReq setPrjSituation(String prjSituation) {
     ...
     * 设置：计划完成日期。
     */
    public PmNationalBuildReq setComplPlanDate(LocalDate complPlanDate) {
     ...
     * 设置：申请时间。
     */
    public PmNationalBuildReq setApplyTime(LocalDate applyTime) {
     ...
     * 设置：申请人。
     */
    public PmNationalBuildReq setApplicant(String applicant) {
     ...
     * 设置：附件。
     */
    public PmNationalBuildReq setAttFileGroupId(String attFileGroupId) {
     ...
     * 设置：实际批复日期。
     */
    public PmNationalBuildReq setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmNationalBuildReq setReplyNoWr(String replyNoWr) {
     ...
     * 设置：有效期。
     */
    public PmNationalBuildReq setValidTerm(String validTerm) {
     ...
     * 设置：审批附件1。
     */
    public PmNationalBuildReq setApproveFileIdOne(String approveFileIdOne) {
     ...
     * @return
     */
    public static PmNationalBuildReq newData() {
        PmNationalBuildReq obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmNationalBuildReq insertData() {
        PmNationalBuildReq obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmNationalBuildReq selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmNationalBuildReq obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PmNationalBuildReq> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmNationalBuildReq> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmNationalBuildReq> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmNationalBuildReq> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PmNationalBuildReq fromModel, PmNationalBuildReq toModel, List<String> includeCols, List<String> excludeCols) {
