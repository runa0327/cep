 ...
 * 远程平台组织。
 */
public class AdRemotePlatformOrg {
    ...
    public static final String ENT_CODE = "AD_REMOTE_PLATFORM_ORG";
    ...
    public static class Cols {
         ...
         * 远程平台。
         */
        public static final String AD_REMOTE_PLATFORM_ID = "AD_REMOTE_PLATFORM_ID";
    }
     ...
     * 获取：远程平台。
     */
    public String getAdRemotePlatformId() {
        return this.adRemotePlatformId;
    }
     ...
     */
    public static void copyCols(AdRemotePlatformOrg fromModel, AdRemotePlatformOrg toModel, List<String> includeCols, List<String> excludeCols) {
