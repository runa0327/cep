 ...
 * 竣工联合验收意见。
 */
public class CompletionAcceptanceComments {

    /**
     * 模型助手。
     */
    private static final ModelHelper<CompletionAcceptanceComments> modelHelper = new ModelHelper<>("COMPLETION_ACCEPTANCE_COMMENTS", new CompletionAcceptanceComments());
    ...
    public static final String ENT_CODE = "COMPLETION_ACCEPTANCE_COMMENTS";
     ...
     * 设置：ID。
     */
    public CompletionAcceptanceComments setId(String id) {
     ...
     * 设置：版本。
     */
    public CompletionAcceptanceComments setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public CompletionAcceptanceComments setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public CompletionAcceptanceComments setIsPreset(Boolean isPreset) {
     ...
     * 设置：最后修改日期时间。
     */
    public CompletionAcceptanceComments setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public CompletionAcceptanceComments setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：代码。
     */
    public CompletionAcceptanceComments setCode(String code) {
     ...
     * 设置：名称。
     */
    public CompletionAcceptanceComments setName(String name) {
     ...
     * 设置：备注。
     */
    public CompletionAcceptanceComments setRemark(String remark) {
     ...
     * 设置：锁定流程实例。
     */
    public CompletionAcceptanceComments setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：项目。
     */
    public CompletionAcceptanceComments setPmPrjId(String pmPrjId) {
     ...
     * 设置：记录状态。
     */
    public CompletionAcceptanceComments setStatus(String status) {
     ...
     * 设置：项目编号。
     */
    public CompletionAcceptanceComments setPrjCode(String prjCode) {
     ...
     * 设置：项目类型。
     */
    public CompletionAcceptanceComments setProjectTypeId(String projectTypeId) {
     ...
     * 设置：创建用户。
     */
    public CompletionAcceptanceComments setCrtUserId(String crtUserId) {
     ...
     * 设置：创建部门。
     */
    public CompletionAcceptanceComments setCrtDeptId(String crtDeptId) {
     ...
     * 设置：项目概况。
     */
    public CompletionAcceptanceComments setPrjSituation(String prjSituation) {
     ...
     * 设置：创建日期时间。
     */
    public CompletionAcceptanceComments setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：补充说明。
     */
    public CompletionAcceptanceComments setAdditionalRemark(String additionalRemark) {
     ...
     * 设置：审批附件1。
     */
    public CompletionAcceptanceComments setApproveFileIdOne(String approveFileIdOne) {
     ...
     * 设置：审批附件2。
     */
    public CompletionAcceptanceComments setApproveFileIdTwo(String approveFileIdTwo) {
     ...
     * 设置：审批附件3。
     */
    public CompletionAcceptanceComments setApproveFileIdThree(String approveFileIdThree) {
     ...
     * 设置：审批附件4。
     */
    public CompletionAcceptanceComments setApproveFileIdFour(String approveFileIdFour) {
     ...
     * 设置：审批附件5。
     */
    public CompletionAcceptanceComments setApproveFileIdFive(String approveFileIdFive) {
     ...
     * 设置：审批附件6。
     */
    public CompletionAcceptanceComments setApproveFileIdSix(String approveFileIdSix) {
     ...
     * @return
     */
    public static CompletionAcceptanceComments newData() {
        CompletionAcceptanceComments obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static CompletionAcceptanceComments insertData() {
        CompletionAcceptanceComments obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static CompletionAcceptanceComments selectById(String id, List<String> includeCols, List<String> excludeCols) {
        CompletionAcceptanceComments obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<CompletionAcceptanceComments> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<CompletionAcceptanceComments> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<CompletionAcceptanceComments> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<CompletionAcceptanceComments> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(CompletionAcceptanceComments fromModel, CompletionAcceptanceComments toModel, List<String> includeCols, List<String> excludeCols) {
