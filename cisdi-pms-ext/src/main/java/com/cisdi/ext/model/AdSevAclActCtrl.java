...
public class AdSevAclActCtrl {
    ...
    public static final String ENT_CODE = "AD_SEV_ACL_ACT_CTRL";
    ...
    public static class Cols {
         ...
         * 实体视图ACL操作。
         */
        public static final String AD_SEV_ACL_ACT_ID = "AD_SEV_ACL_ACT_ID";
    }
     ...
     * 获取：实体视图ACL操作。
     */
    public String getAdSevAclActId() {
        return this.adSevAclActId;
    }
     ...
     */
    public static void copyCols(AdSevAclActCtrl fromModel, AdSevAclActCtrl toModel, List<String> includeCols, List<String> excludeCols) {
