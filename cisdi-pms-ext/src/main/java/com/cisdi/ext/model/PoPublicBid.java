...
public class PoPublicBid {
     ...
     * 模型助手。
     */
    private static final ModelHelper<PoPublicBid> modelHelper = new ModelHelper<>("PO_PUBLIC_BID", new PoPublicBid());
    ...
    public static final String ENT_CODE = "PO_PUBLIC_BID";
     ...
     * 设置：ID。
     */
    public PoPublicBid setId(String id) {
     ...
     * 设置：版本。
     */
    public PoPublicBid setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PoPublicBid setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PoPublicBid setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PoPublicBid setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PoPublicBid setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PoPublicBid setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PoPublicBid setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PoPublicBid setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PoPublicBid setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public PoPublicBid setCode(String code) {
     ...
     * 设置：名称。
     */
    public PoPublicBid setName(String name) {
     ...
     * 设置：项目。
     */
    public PoPublicBid setPmPrjId(String pmPrjId) {
     ...
     * 设置：项目编号。
     */
    public PoPublicBid setPrjCode(String prjCode) {
     ...
     * 设置：立项批复文号。
     */
    public PoPublicBid setPrjReplyNo(String prjReplyNo) {
     ...
     * 设置：项目概况。
     */
    public PoPublicBid setPrjSituation(String prjSituation) {
     ...
     * 设置：投资来源。
     */
    public PoPublicBid setInvestmentSourceId(String investmentSourceId) {
     ...
     * 设置：业主单位。
     */
    public PoPublicBid setCustomerUnit(String customerUnit) {
     ...
     * 设置：采购方式。
     */
    public PoPublicBid setBuyTypeId(String buyTypeId) {
     ...
     * 设置：可研批复资金（万）。
     */
    public PoPublicBid setFeasibilityApproveFund(BigDecimal feasibilityApproveFund) {
     ...
     * 设置：初概批复资金（万）。
     */
    public PoPublicBid setEstimateApproveFund(BigDecimal estimateApproveFund) {
     ...
     * 设置：财评批复资金（万）。
     */
    public PoPublicBid setEvaluationApproveFund(BigDecimal evaluationApproveFund) {
     ...
     * 设置：招标单位。
     */
    public PoPublicBid setBidUnit(String bidUnit) {
     ...
     * 设置：招标依据。
     */
    public PoPublicBid setBidBasis(String bidBasis) {
     ...
     * 设置：招标控制价发起。
     */
    public PoPublicBid setBidCtlPriceLaunch(BigDecimal bidCtlPriceLaunch) {
     ...
     * 设置：服务周期。
     */
    public PoPublicBid setServiceDays(Integer serviceDays) {
     ...
     * 设置：招标需求附件。
     */
    public PoPublicBid setBidDemandFileGroupId(String bidDemandFileGroupId) {
     ...
     * 设置：备注。
     */
    public PoPublicBid setRemark(String remark) {
     ...
     * 设置：核定招标类别。
     */
    public PoPublicBid setApprovePmsReleaseWayId(String approvePmsReleaseWayId) {
     ...
     * 设置：招标方式。
     */
    public PoPublicBid setApprovePurchaseType(String approvePurchaseType) {
     ...
     * 设置：核定招标控制价。
     */
    public PoPublicBid setApproveBidCtlPrice(BigDecimal approveBidCtlPrice) {
     ...
     * 设置：领导审批意见。
     */
    public PoPublicBid setLeaderApproveComment(String leaderApproveComment) {
     ...
     * 设置：领导审批附件。
     */
    public PoPublicBid setLeaderApproveFileGroupId(String leaderApproveFileGroupId) {
     ...
     * 设置：招标方式回显。
     */
    public PoPublicBid setApprovePurchaseTypeEcho(String approvePurchaseTypeEcho) {
     ...
     * 设置：招标控制价回显。
     */
    public PoPublicBid setBidCtlPriceLaunchEcho(BigDecimal bidCtlPriceLaunchEcho) {
     ...
     * 设置：招标经办人。
     */
    public PoPublicBid setBidUserId(String bidUserId) {
     ...
     * 设置：招标代理单位。
     */
    public PoPublicBid setBidAgency(String bidAgency) {
     ...
     * 设置：需求发起人。
     */
    public PoPublicBid setDemandPromoter(String demandPromoter) {
     ...
     * 设置：招标文件。
     */
    public PoPublicBid setBidFileGroupId(String bidFileGroupId) {
     ...
     * 设置：报名时间。
     */
    public PoPublicBid setRegistrationDate(LocalDate registrationDate) {
     ...
     * 设置：开标时间。
     */
    public PoPublicBid setBidOpenDate(LocalDate bidOpenDate) {
     ...
     * 设置：招标平台。
     */
    public PoPublicBid setBidPlatform(String bidPlatform) {
     ...
     * 设置：发标信息。
     */
    public PoPublicBid setBidIssueInfo(String bidIssueInfo) {
     ...
     * 设置：用章经办人审批意见。
     */
    public PoPublicBid setSealAgentApproveComment(String sealAgentApproveComment) {
     ...
     * 设置：发标招标文件。
     */
    public PoPublicBid setBidIssueFileGroupId(String bidIssueFileGroupId) {
     ...
     * 设置：用章领导审批意见。
     */
    public PoPublicBid setSealApproveComment(String sealApproveComment) {
     ...
     * 设置：中标单位文本。
     */
    public PoPublicBid setWinBidUnitTxt(String winBidUnitTxt) {
     ...
     * 设置：投标报价。
     */
    public PoPublicBid setTenderOffer(BigDecimal tenderOffer) {
     ...
     * 设置：联系人名称。
     */
    public PoPublicBid setContactName(String contactName) {
     ...
     * 设置：中标联系人手机。
     */
    public PoPublicBid setContactMobileWin(String contactMobileWin) {
     ...
     * 设置：中标联系人身份证。
     */
    public PoPublicBid setContactIdcardWin(String contactIdcardWin) {
     ...
     * 设置：标后附件。
     */
    public PoPublicBid setBidAfterFileGroupId(String bidAfterFileGroupId) {
     ...
     * 设置：标后领导人审批意见。
     */
    public PoPublicBid setBidAfterApproveComment(String bidAfterApproveComment) {
     ...
     * 设置：中标单位备案。
     */
    public PoPublicBid setWinBidUnitRecord(String winBidUnitRecord) {
     ...
     * 设置：投标报价备案。
     */
    public PoPublicBid setTenderOfferRecord(String tenderOfferRecord) {
     ...
     * 设置：是否备案。
     */
    public PoPublicBid setIsRecord(Boolean isRecord) {
     ...
     * 设置：联系人名称备案。
     */
    public PoPublicBid setContactNameRecord(String contactNameRecord) {
     ...
     * 设置：联系人手机备案。
     */
    public PoPublicBid setContactMobileRecord(String contactMobileRecord) {
     ...
     * 设置：联系人身份证备案。
     */
    public PoPublicBid setContactIdcardRecord(String contactIdcardRecord) {
     ...
     * 设置：中标通知书。
     */
    public PoPublicBid setBidWinNoticeFileGroupId(String bidWinNoticeFileGroupId) {
     ...
     * 设置：CPMS的UUID。
     */
    public PoPublicBid setCpmsUuid(String cpmsUuid) {
     ...
     * 设置：CPMS的ID。
     */
    public PoPublicBid setCpmsId(String cpmsId) {
     ...
     * @return
     */
    public static PoPublicBid newData() {
        PoPublicBid obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PoPublicBid insertData() {
        PoPublicBid obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PoPublicBid selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PoPublicBid obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     */
    public static List<PoPublicBid> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PoPublicBid> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PoPublicBid> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PoPublicBid> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     */
    public static void copyCols(PoPublicBid fromModel, PoPublicBid toModel, List<String> includeCols, List<String> excludeCols) {
