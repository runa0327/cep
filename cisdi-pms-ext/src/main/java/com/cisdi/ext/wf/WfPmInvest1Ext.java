...
public class WfPmInvest1Ext {
    public void setComments() {
        ...
        Map<String, Object> map = myJdbcTemplate.queryForMap("select p.PRJ_EARLY_USER_ID,p.PRJ_DESIGN_USER_ID,p.PRJ_COST_USER_ID from pm_prj p where p.id=?", pm_prj_id);
