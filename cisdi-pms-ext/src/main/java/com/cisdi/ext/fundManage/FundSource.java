...
public class FundSource {
    ...
    public void getSourceTypeDrop() {
        ...
        log.info(baseSql.toString());
        List<Map<String, Object>> sourceTypes = myJdbcTemplate.queryForList(baseSql.toString());
    ...
    public void getFundSourceDetail() {
        ...
        MyJdbcTemplate myJdbcTemplate = ExtJarHelper.myJdbcTemplate.get();
        Map<String, Object> infoMap = myJdbcTemplate.queryForMap("select s.id, s.NAME name,s.IMPL_AMT implAmt,v" +
        ...
        List<Map<String, Object>> sourceList = myJdbcTemplate.queryForList("SELECT s.id,p.id prjId,p.NAME prjName,sum( a" +
