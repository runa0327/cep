 ...
 * 预算财评导入。
 */
public class PmPrjInvest3Import {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PmPrjInvest3Import> modelHelper = new ModelHelper<>("PM_PRJ_INVEST3_IMPORT", new PmPrjInvest3Import());
    ...
    public static final String ENT_CODE = "PM_PRJ_INVEST3_IMPORT";
     ...
     * 设置：导入批次。
     */
    public PmPrjInvest3Import setImportBatchId(String importBatchId) {
     ...
     * 设置：导入状态。
     */
    public PmPrjInvest3Import setImportStatusId(String importStatusId) {
     ...
     * 设置：导入时间。
     */
    public PmPrjInvest3Import setImportTime(LocalDateTime importTime) {
     ...
     * 设置：是否成功。
     */
    public PmPrjInvest3Import setIsSuccess(Boolean isSuccess) {
     ...
     * 设置：错误信息。
     */
    public PmPrjInvest3Import setErrInfo(String errInfo) {
     ...
     * 设置：ID。
     */
    public PmPrjInvest3Import setId(String id) {
     ...
     * 设置：版本。
     */
    public PmPrjInvest3Import setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PmPrjInvest3Import setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PmPrjInvest3Import setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PmPrjInvest3Import setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PmPrjInvest3Import setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PmPrjInvest3Import setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PmPrjInvest3Import setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PmPrjInvest3Import setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PmPrjInvest3Import setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public PmPrjInvest3Import setCode(String code) {
     ...
     * 设置：名称。
     */
    public PmPrjInvest3Import setName(String name) {
     ...
     * 设置：备注。
     */
    public PmPrjInvest3Import setRemark(String remark) {
     ...
     * 设置：项目。
     */
    public PmPrjInvest3Import setPmPrjId(String pmPrjId) {
     ...
     * 设置：施工图预算送审稿。
     */
    public PmPrjInvest3Import setWorkDrawingToReviewFile(String workDrawingToReviewFile) {
     ...
     * 设置：施工图预算送审备注。
     */
    public PmPrjInvest3Import setWorkDrawingBudgetToReviewRemark(String workDrawingBudgetToReviewRemark) {
     ...
     * 设置：财评批复实际时间。
     */
    public PmPrjInvest3Import setFinancialActualDate(LocalDate financialActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public PmPrjInvest3Import setReplyNoWr(String replyNoWr) {
     ...
     * 设置：财评批复材料。
     */
    public PmPrjInvest3Import setFinancialReviewFile(String financialReviewFile) {
     ...
     * 设置：预算审核结论材料。
     */
    public PmPrjInvest3Import setBudgetReviewConclusionFile(String budgetReviewConclusionFile) {
     ...
     * 设置：总投资（万）。
     */
    public PmPrjInvest3Import setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public PmPrjInvest3Import setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：建安费（万）。
     */
    public PmPrjInvest3Import setConstructAmt(BigDecimal constructAmt) {
     ...
     * 设置：设备费（万）。
     */
    public PmPrjInvest3Import setEquipAmt(BigDecimal equipAmt) {
     ...
     * 设置：工程其他费用(万)。
     */
    public PmPrjInvest3Import setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：科研设备费(万)。
     */
    public PmPrjInvest3Import setEquipmentCost(BigDecimal equipmentCost) {
     ...
     * 设置：土地拆迁费（万）。
     */
    public PmPrjInvest3Import setLandAmt(BigDecimal landAmt) {
     ...
     * 设置：预备费(万)。
     */
    public PmPrjInvest3Import setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public PmPrjInvest3Import setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * @return
     */
    public static PmPrjInvest3Import newData() {
        PmPrjInvest3Import obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PmPrjInvest3Import insertData() {
        PmPrjInvest3Import obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PmPrjInvest3Import selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PmPrjInvest3Import obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PmPrjInvest3Import selectById(String id) {
     ...
     */
    public static List<PmPrjInvest3Import> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest3Import> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest3Import> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest3Import> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest3Import> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PmPrjInvest3Import> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PmPrjInvest3Import selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PmPrjInvest3Import> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PmPrjInvest3Import.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PmPrjInvest3Import selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PmPrjInvest3Import fromModel, PmPrjInvest3Import toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PmPrjInvest3Import fromModel, PmPrjInvest3Import toModel) {
