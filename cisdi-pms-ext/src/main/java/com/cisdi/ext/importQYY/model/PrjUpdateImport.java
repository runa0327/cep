 ...
 * 项目更新导入。
 */
public class PrjUpdateImport {

    /**
     * 模型助手。
     */
    private static final ModelHelper<PrjUpdateImport> modelHelper = new ModelHelper<>("PRJ_UPDATE_IMPORT", new PrjUpdateImport());
    ...
    public static final String ENT_CODE = "PRJ_UPDATE_IMPORT";
     ...
     * 设置：导入批次。
     */
    public PrjUpdateImport setImportBatchId(String importBatchId) {
     ...
     * 设置：导入状态。
     */
    public PrjUpdateImport setImportStatusId(String importStatusId) {
     ...
     * 设置：导入时间。
     */
    public PrjUpdateImport setImportTime(LocalDateTime importTime) {
     ...
     * 设置：是否成功。
     */
    public PrjUpdateImport setIsSuccess(Boolean isSuccess) {
     ...
     * 设置：错误信息。
     */
    public PrjUpdateImport setErrInfo(String errInfo) {
     ...
     * 设置：ID。
     */
    public PrjUpdateImport setId(String id) {
     ...
     * 设置：版本。
     */
    public PrjUpdateImport setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public PrjUpdateImport setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public PrjUpdateImport setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public PrjUpdateImport setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public PrjUpdateImport setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public PrjUpdateImport setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public PrjUpdateImport setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public PrjUpdateImport setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public PrjUpdateImport setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public PrjUpdateImport setCode(String code) {
     ...
     * 设置：名称。
     */
    public PrjUpdateImport setName(String name) {
     ...
     * 设置：备注。
     */
    public PrjUpdateImport setRemark(String remark) {
     ...
     * 设置：项目。
     */
    public PrjUpdateImport setPmPrjId(String pmPrjId) {
     ...
     * 设置：项目类型。
     */
    public PrjUpdateImport setProjectTypeId(String projectTypeId) {
     ...
     * 设置：建设地点。
     */
    public PrjUpdateImport setBaseLocationId(String baseLocationId) {
     ...
     * 设置：项目管理模式。
     */
    public PrjUpdateImport setPrjManageModeId(String prjManageModeId) {
     ...
     * 设置：项目状态。
     */
    public PrjUpdateImport setProjectPhaseId(String projectPhaseId) {
     ...
     * @return
     */
    public static PrjUpdateImport newData() {
        PrjUpdateImport obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static PrjUpdateImport insertData() {
        PrjUpdateImport obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static PrjUpdateImport selectById(String id, List<String> includeCols, List<String> excludeCols) {
        PrjUpdateImport obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static PrjUpdateImport selectById(String id) {
     ...
     */
    public static List<PrjUpdateImport> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<PrjUpdateImport> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PrjUpdateImport> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PrjUpdateImport> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PrjUpdateImport> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<PrjUpdateImport> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static PrjUpdateImport selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<PrjUpdateImport> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用PrjUpdateImport.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static PrjUpdateImport selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(PrjUpdateImport fromModel, PrjUpdateImport toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(PrjUpdateImport fromModel, PrjUpdateImport toModel) {
