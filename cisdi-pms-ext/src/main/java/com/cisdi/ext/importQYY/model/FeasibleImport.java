 ...
 * 可研导入。
 */
public class FeasibleImport {

    /**
     * 模型助手。
     */
    private static final ModelHelper<FeasibleImport> modelHelper = new ModelHelper<>("FEASIBLE_IMPORT", new FeasibleImport());
    ...
    public static final String ENT_CODE = "FEASIBLE_IMPORT";
    ...
    public static class Cols {
         ...
         * 可研导入批次。
         */
        public static final String FEASIBLE_IMPORT_BATCH_ID = "FEASIBLE_IMPORT_BATCH_ID";
    }
     ...
     * 设置：导入状态。
     */
    public FeasibleImport setImportStatusId(String importStatusId) {
     ...
     * 设置：导入时间。
     */
    public FeasibleImport setImportTime(LocalDateTime importTime) {
     ...
     * 设置：是否成功。
     */
    public FeasibleImport setIsSuccess(Boolean isSuccess) {
     ...
     * 设置：错误信息。
     */
    public FeasibleImport setErrInfo(String errInfo) {
     ...
     * 设置：ID。
     */
    public FeasibleImport setId(String id) {
     ...
     * 设置：版本。
     */
    public FeasibleImport setVer(Integer ver) {
     ...
     * 设置：时间戳。
     */
    public FeasibleImport setTs(LocalDateTime ts) {
     ...
     * 设置：是否预设。
     */
    public FeasibleImport setIsPreset(Boolean isPreset) {
     ...
     * 设置：创建日期时间。
     */
    public FeasibleImport setCrtDt(LocalDateTime crtDt) {
     ...
     * 设置：创建用户。
     */
    public FeasibleImport setCrtUserId(String crtUserId) {
     ...
     * 设置：最后修改日期时间。
     */
    public FeasibleImport setLastModiDt(LocalDateTime lastModiDt) {
     ...
     * 设置：最后修改用户。
     */
    public FeasibleImport setLastModiUserId(String lastModiUserId) {
     ...
     * 设置：记录状态。
     */
    public FeasibleImport setStatus(String status) {
     ...
     * 设置：锁定流程实例。
     */
    public FeasibleImport setLkWfInstId(String lkWfInstId) {
     ...
     * 设置：代码。
     */
    public FeasibleImport setCode(String code) {
     ...
     * 设置：名称。
     */
    public FeasibleImport setName(String name) {
     ...
     * 设置：备注。
     */
    public FeasibleImport setRemark(String remark) {
     ...
     * 设置：项目。
     */
    public FeasibleImport setPmPrjId(String pmPrjId) {
     ...
     * 设置：专家评审实际完成日期。
     */
    public FeasibleImport setExpertComplActualDate(LocalDate expertComplActualDate) {
     ...
     * 设置：评审单位负责人。
     */
    public FeasibleImport setReviewUnitChief(String reviewUnitChief) {
     ...
     * 设置：评审组织单位。
     */
    public FeasibleImport setReviewOrganizationUnit(String reviewOrganizationUnit) {
     ...
     * 设置：评审单位联系方式。
     */
    public FeasibleImport setReviewUnitPhone(String reviewUnitPhone) {
     ...
     * 设置：专家意见文件。
     */
    public FeasibleImport setExpertFile(String expertFile) {
     ...
     * 设置：评审稿文件。
     */
    public FeasibleImport setReviewReportFile(String reviewReportFile) {
     ...
     * 设置：修编稿文件。
     */
    public FeasibleImport setRevisionFile(String revisionFile) {
     ...
     * 设置：评审报告文件。
     */
    public FeasibleImport setReviewDraftFile(String reviewDraftFile) {
     ...
     * 设置：总投资（万）。
     */
    public FeasibleImport setPrjTotalInvest(BigDecimal prjTotalInvest) {
     ...
     * 设置：工程费用（万）。
     */
    public FeasibleImport setProjectAmt(BigDecimal projectAmt) {
     ...
     * 设置：建安费（万）。
     */
    public FeasibleImport setConstructAmt(BigDecimal constructAmt) {
     ...
     * 设置：设备费（万）。
     */
    public FeasibleImport setEquipAmt(BigDecimal equipAmt) {
     ...
     * 设置：科研设备费(万)。
     */
    public FeasibleImport setEquipmentCost(BigDecimal equipmentCost) {
     ...
     * 设置：工程其他费用(万)。
     */
    public FeasibleImport setProjectOtherAmt(BigDecimal projectOtherAmt) {
     ...
     * 设置：土地拆迁费（万）。
     */
    public FeasibleImport setLandAmt(BigDecimal landAmt) {
     ...
     * 设置：预备费(万)。
     */
    public FeasibleImport setPrepareAmt(BigDecimal prepareAmt) {
     ...
     * 设置：建设期利息（万）。
     */
    public FeasibleImport setConstructPeriodInterest(BigDecimal constructPeriodInterest) {
     ...
     * 设置：实际批复日期。
     */
    public FeasibleImport setReplyActualDate(LocalDate replyActualDate) {
     ...
     * 设置：批复文号(填）。
     */
    public FeasibleImport setReplyNoWr(String replyNoWr) {
     ...
     * 设置：批复文件。
     */
    public FeasibleImport setReplyFile(String replyFile) {
     ...
     * 可研导入批次。
     */
    private String feasibleImportBatchId;

    /**
     * 获取：可研导入批次。
     */
    public String getFeasibleImportBatchId() {
        return this.feasibleImportBatchId;
    }

    /**
     * 设置：可研导入批次。
     */
    public FeasibleImport setFeasibleImportBatchId(String feasibleImportBatchId) {
        if (this.feasibleImportBatchId == null && feasibleImportBatchId == null) {
            // 均为null，不做处理。
        } else if (this.feasibleImportBatchId != null && feasibleImportBatchId != null) {
            // 均非null，判定不等，再做处理：
            if (this.feasibleImportBatchId.compareTo(feasibleImportBatchId) != 0) {
                this.feasibleImportBatchId = feasibleImportBatchId;
                if (!this.toUpdateCols.contains("FEASIBLE_IMPORT_BATCH_ID")) {
                    this.toUpdateCols.add("FEASIBLE_IMPORT_BATCH_ID");
                }
            }
        } else {
            // 一者为null、一者非null，直接处理：
     ...
     * @return
     */
    public static FeasibleImport newData() {
        FeasibleImport obj = modelHelper.newData();
        return obj;
    }
     ...
     * @return
     */
    public static FeasibleImport insertData() {
        FeasibleImport obj = modelHelper.insertData();
        return obj;
    }
     ...
     */
    public static FeasibleImport selectById(String id, List<String> includeCols, List<String> excludeCols) {
        FeasibleImport obj = modelHelper.selectById(id, includeCols, excludeCols);
        return obj;
    }
     ...
     * @return 获取到的对象，若无则为null。
     */
    public static FeasibleImport selectById(String id) {
     ...
     */
    public static List<FeasibleImport> selectByIds(List<String> ids, List<String> includeCols, List<String> excludeCols) {
        List<FeasibleImport> objList = modelHelper.selectByIds(ids, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<FeasibleImport> selectByIds(List<String> ids) {
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<FeasibleImport> selectByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<FeasibleImport> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        return objList;
    }
     ...
     * @return 获取到的对象列表，若无则为null。建议使用SharedUtil.isEmptyList(list)方法判断有无。
     */
    public static List<FeasibleImport> selectByWhere(Where where) {
     ...
     * @return 获取到的对象。
     */
    public static FeasibleImport selectOneByWhere(Where where, List<String> includeCols, List<String> excludeCols) {
        List<FeasibleImport> objList = modelHelper.selectByWhere(where, includeCols, excludeCols);
        if (objList != null && objList.size() > 1) {
            throw new BaseException("调用FeasibleImport.selectOneByWhere方法不能返回" + objList.size() + "条记录（只能返回0条或1条）！");
        }
     ...
     * @return 获取到的对象。
     */
    public static FeasibleImport selectOneByWhere(Where where) {
     ...
     */
    public static void copyCols(FeasibleImport fromModel, FeasibleImport toModel, List<String> includeCols, List<String> excludeCols) {
     ...
     * @param toModel   到模型。
     */
    public static void copyCols(FeasibleImport fromModel, FeasibleImport toModel) {
