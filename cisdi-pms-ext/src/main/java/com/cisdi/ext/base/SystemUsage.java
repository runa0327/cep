...
public class SystemUsage {
    ...
    public void querySystemUsage(){
        ...
        // zaiJianJianAnAmt = 在建项目建安总额   zaiJianPrjNum = 在建项目数量
        ...
        // 查询项目数量 prjAllNums = 项目总数； zfPrjNums = 政府投资项目数； sbPrjNums = 设备项目数； lxPrjNums = 零星项目数; shPrjNums = 社会投资项目数
        List<Map<String,Object>> list7 = myJdbcTemplate.queryForList("select a.prjAllNums,b.zfPrjNums,c.shPrjNums,d.sbPrjNums,e.lxPrjNums from (select count(*) as prjAllNums,'1' as id from pm_prj where status = 'ap' and PROJECT_SOURCE_TYPE_ID = '0099952822476441374') a left join(select count(*) as zfPrjNums,'1' as id from pm_prj where status = 'ap' and PROJECT_SOURCE_TYPE_ID = '0099952822476441374' and PROJECT_CLASSIFICATION_ID = '1704686664114929664') b on a.id = b.id left join(select count(*) as shPrjNums,'1' as id from pm_prj where status = 'ap' and PROJECT_SOURCE_TYPE_ID = '0099952822476441374' and PROJECT_CLASSIFICATION_ID = '1704686699527438336') c on a.id = c.id left join(select count(*) as sbPrjNums,'1' as id from pm_prj where status = 'ap' and PROJECT_SOURCE_TYPE_ID = '0099952822476441374' and PROJECT_CLASSIFICATION_ID = '1704686735267102720') d on a.id = d.id left join(select count(*) as lxPrjNums,'1' as id from pm_prj where status = 'ap' and PROJECT_SOURCE_TYPE_ID = '0099952822476441374' and PROJECT_CLASSIFICATION_ID = '1704686841101975552') e on a.id = e.id");
        ...
        resMap.put("prjNums",list7); // prjAllNums = 项目总数； zfPrjNums = 政府投资项目数； sbPrjNums = 设备项目数； lxPrjNums = 零星项目数; shPrjNums = 社会投资项目数
