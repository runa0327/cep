...
public class PoOrderPaymentExt {
    ...
    public void CreateProcess(){
        ...
        List<Map<String,Object>> list1 = jdbcTemplate.queryForList(sql1,userId);
        ...
        int num = jdbcTemplate.update(updateSql,deptName,lastAmount,maxAmount,contractPre,ESTIMATE_PERCENT,FINANCIAL_PERCENT,SETTLEMENT_PERCENT,csCommId);
    }
