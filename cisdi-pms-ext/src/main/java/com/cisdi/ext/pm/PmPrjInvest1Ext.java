...
public class PmPrjInvest1Ext {
    ...
    public void invest1ProcessStartCheck(){
        ...
        if (SharedUtil.isEmptyString(projectId)){
            ...
            errorMsg = ProcessCommon.prjRepeatStartByName(entityCode,projectName,myJdbcTemplate);
        } else {
            errorMsg = ProcessCommon.prjRepeatStartById(entityCode,projectId,myJdbcTemplate);
        }
