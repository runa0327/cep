...
public class PmProUpdateLogExt {
     ...
     * @param msg 操作说明
     */
    public static void createData(String entCode, String sourceId, String prjId, String proInstanceId, String userId, String now, String msg) {
        ...
        Crud.from(PmProUpdateLog.ENT_CODE).where().eq(PmProUpdateLog.Cols.ID,id).update()
                ...
                .set(PmProUpdateLog.Cols.OPERATION_TYPE_ID,"1688359200281030656")
