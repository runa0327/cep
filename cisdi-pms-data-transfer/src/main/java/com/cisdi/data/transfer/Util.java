...
public class Util {
    public static String insertData(MyJdbcTemplate myJdbcTemplate, String entCode) {
        Map<String, Object> map = getEntSql(myJdbcTemplate, entCode);
        if (SharedUtil.isEmptyObject(map.get("NEW_ID_SQL"))) {
            ...
            if (SharedUtil.isEmptyObject(map.get("INSERT_DATA_SQL"))) {
                ...
                Map<String, Object> newIdMap = myJdbcTemplate.queryForMap(new_id_sql, new Object[0]);
                ...
                if (SharedUtil.isEmptyString(newIdStr)) {
                    ...
                    myJdbcTemplate.update(insert_data_sql, new Object[]{newIdStr});
                    return newIdStr;
                }
            }
        }
    ...
    private static Map<String, Object> getEntSql(MyJdbcTemplate myJdbcTemplate, String entCode) {
        List<Map<String, Object>> list = myJdbcTemplate.queryForList("select t.NEW_ID_SQL,t.INSERT_DATA_SQL,t.NEW_DATA_SQL from ad_ent_sql t where t.code=?", new Object[]{entCode});
        if (list.size() > 1) {
